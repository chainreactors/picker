---
title: citrix-netscaler-triage
url: https://kitploit.com/en/tools/github/fox-it/citrix-netscaler-triage
source: Kitploit
date: 2026-09-05
fetch_date: 2026-09-06T06:39:15.637133
---
...
citrix-netscaler-triage — Forensic triage toolkit for Citrix NetScaler devices, featuring a Dissect-based IOC scanner for webshells, timestomping, and suspicious binaries, plus a remote version scanner that identifies CVE vulnerabilities. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/fox-it/citrix-netscaler-triage

![](https://assets.kitploit.com/production/public/tools/54201/e35ef91829990bd8d240791efaf5c52ffb98f18d9ab5122cffe29a9403a2fa9f-display-v1.webp)

[Indicator of Compromise (IOC) Management](/en/categories/ioc-management)[Vulnerability Scanners](/en/categories/vulnerability-scanners)[Web Security](/en/categories/web-security)[Network Security](/en/categories/network-security)[Digital Forensics](/en/categories/digital-forensics)[Incident Response](/en/categories/incident-response)

![GitHub](/providers/github.png)fox-it/citrix-netscaler-triage

# citrix-netscaler-triage

Forensic triage toolkit for Citrix NetScaler devices, featuring a Dissect-based IOC scanner for webshells, timestomping, and suspicious binaries, plus a remote version scanner that identifies CVE vulnerabilities.
...
[View Repository](https://github.com/fox-it/citrix-netscaler-triage)[Website](https://blog.fox-it.com/2023/08/15/approximately-2000-citrix-netscalers-backdoored-in-mass-exploitation-campaign/)

7418339 months ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
The following commands can be used on a local linux ma...