---
title: 快普M6 GetCustomerList SQL注入漏洞
url: https://mp.weixin.qq.com/s/Jhi_SVgXR-DQKyCqUjBwyw
source: Doonsec's feed
date: 2026-02-07
fetch_date: 2026-02-08T04:31:11.210372
---

# 快普M6 GetCustomerList SQL注入漏洞

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/8o9dnzNIF1iauuJdEdNYWDebmKH1MU7aZDicVAmiayGM4fK1ibUFzVoeMczibDgcMt8pfaO9xVyoVj7sqicUaNYB1qzwJ0rdKicBngaib4AvqiaEKCSU/0?wx_fmt=jpeg)
...
快普M6 GetCustomerList 接口存在SQL注入漏洞,未经身份验证的远程攻击者除了可以利用 SQL 注入漏洞获取数据库中的信息（例如，管理员后台密码、站点的用户个人信息）之外，甚至在高权限的情况可向服务器中写入木马，进一步获取服务器系统权限。
