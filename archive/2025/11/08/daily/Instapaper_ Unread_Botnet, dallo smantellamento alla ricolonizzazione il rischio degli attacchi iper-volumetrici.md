---
title: Botnet, dallo smantellamento alla ricolonizzazione il rischio degli attacchi iper-volumetrici
url: https://www.cybersecurity360.it/nuove-minacce/botnet-dallo-smantellamento-alla-ricolonizzazione-il-rischio-degli-attacchi-iper-volumetrici/
source: Instapaper: Unread
date: 2025-11-08
fetch_date: 2025-11-09T03:14:48.386028
---
...
Lo smantellamen to delle botnet non dura per sempre. Operatori criminali stanno già ricolonizzando i dispositivi liberati dalla rete, in un contesto di crescente minaccia per i siti internet, ma anche per la connettività di interi Paesi. Ecco come si preparano le strategie nazionali contro i rischi di degrado della connettività
...
![Botnet, dallo smantellamento alla ricolonizzazione](data:image/png;base64...)![Botnet, dallo smantellamento alla ricolonizzazione](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2023/10/Backdoor-cinese-nei-router-Cisco.jpg)

---

Il 6 agosto un’operazione del Defense Criminal Investigative Service statunitense ha smantellato **Rapper Bot**, una **[botnet](https://www.cybersecurity360.it/nuove-minacce/botnet-cosa-sono-come-funzionano-e-come-proteggere-la-rete-aziendale-dagli-zombie-del-web/)** composta da migliaia di dispositivi infetti usati per **[attacchi DDoS](https://www.cybersecurity360.it/nuove-minacce/attacchi-dos-e-ddos-modalita-di-difesa-e-contromisure/)** in tutto il mondo almeno dal 2021.
...
> [Endgame, la mega operazione contro le botnet che ha rovinato i piani dei criminali](https://www.cybersecurity360.it/news/endgame-blitz-botnet/)

Indice degli argomenti

* [Botnet: dopo lo smantellamento, la ricolonizzazione](#Botnet_dopo_lo_smantellamento_la_ricolonizzazione)
  + [Il caso Cloudflare](#Il_caso_Cloudflare)
* [La capacità delle botnet di degradare la connettività](#La_capacita_delle_botnet_di_degradare_la_connettivita)
  + [Il quadro che emerge](#Il_quadro_che_emerge)
  + [Gli attacchi iper-volumetrici](#Gli_attacchi_iper-volumetrici)
  + [Il caso RapperBot di smantellamento botnet e ricolonizzazione](#Il_caso_RapperBot_di_smantellamento_botnet_e_ricolonizzazione)
  + [La sfida è per ISP regionali](#La_sfida_e_per_ISP_regionali)
* [Le strategie nazionali contro il rischio botnet e ricolonizzazione](#Le_strategie_nazionali_contro_il_rischio_botnet_e_ricolonizzazione)
...
Pur non essendo nata per fare DDoS, una botnet di queste dimensioni, ha avvertito Google, potrebbe essere riconvertita a fini più distruttivi, inclusi **[ransomware](https://www.cybersecurity360.it/nuove-minacce/ransomware/)** e **attacchi di saturazione**.
...
Cloudflare ha registrato nelle stesse settimane centinaia di attacchi iper-volumetrici, interpretati come colpi dimostrativi per pubblicizzare la forza della **botnet Aisuru** che ha preso il controllo di oltre un quarto dei...