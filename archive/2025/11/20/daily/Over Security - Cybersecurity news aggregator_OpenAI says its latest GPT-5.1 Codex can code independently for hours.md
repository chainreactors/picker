---
title: OpenAI says its latest GPT-5.1 Codex can code independently for hours
url: https://www.bleepingcomputer.com/news/artificial-intelligence/openai-says-its-latest-gpt-51-codex-can-code-independently-for-hours/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-20
fetch_date: 2025-11-21T03:14:00.775073
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Salesforce investigates customer data theft via Gainsight breach](data:image/gif;base64...)
  ...
  + [![TV streaming piracy service with 26M yearly visits shut down](data:image/gif;base64...)
  ...
  + [![CISA gives govt agencies 7 days to patch new Fortinet flaw](data:image/gif;base64...)
  ...
  + [![New SonicWall SonicOS flaw allows hackers to crash firewalls](data:image/gif;base64...)
  ...
  + [![Google exposes BadAudio malware used in APT24 espionage campaigns](data:image/gif;base64...)
  ...
  + [![Train AI to handle tasks for you with this $39.99 course bundle](data:image/gif;base64...)

    Train AI to handle tasks for you with this $39.99 course bundle](https://www.bleepingcomputer.com/offer/deals/train-ai-to-handle-tasks-for-you-with-this-3999-course-bundle/)
  + [![Hacker claims to steal 2.3TB data from Italian rail group, Almavia](data:image/gif;base64...)
  ...
  + [![GlobalProtect VPN portals probed with 2.3 million scan sessions](data:image/gif;base64...)
