---
title: Preparing your Ansible environment
url: https://www.adainese.it/blog/2024/07/31/preparing-your-ansible-environment/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-21
fetch_date: 2025-10-02T20:29:06.006914
---
...
[PIP](https://pypi.org/)
. The functionalities of Ansible available obviously depend on its version, which is closely tied to the version of Python in use. The examples we will see later presume having Ansible core 2.15.9, and Python 3.10.

In this regard, reference should be made to the
[EVE-NG for DevNetOps](https://www.patreon.com/posts/108910463)
, which describes in detail how to obtain your own development laboratory. In particular, we will refer to the
[GitHub repository for DevNetOps courses](https://github.com/dainok/courses)
 available in **/opt**.

Let’s prepare a dedicated Python environment and install Ansible:

Continue reading
[the post on Patreon](https://www.patreon.com/posts/preparing-your-108960424)
.
