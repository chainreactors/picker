---
title: The NBA tells fans about data breach
url: https://www.malwarebytes.com/blog/news/2023/03/the-nba-notifies-fans-about-a-data-breach
source: Over Security - Cybersecurity news aggregator
date: 2023-03-23
fetch_date: 2025-10-04T10:24:24.479549
---
...
![NBA logo](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/03/asset_upload_file90553_262484.png?w=736)
...
The National Basketball Association (NBA) has notified its fans they may be affected by a [data breach](https://www.malwarebytes.com/cybersecurity/basics/data-breach) in a third-party service the organization uses.
...
The NBA sent out emails to a number of its followers noting that while names and email addresses have been compromised, no other [personally identifiable information](https://www.malwarebytes.com/cybersecurity/basics/pii) was breached.

According to [BleepingComputer](https://www.bleepingcomputer.com/news/security/nba-alerts-fans-of-a-data-breach-exposing-personal-information/) the email read:
...
The email also warned about possible [phishing](https://www.malwarebytes.com/phishing) attempts appearing to come from organizations associated with the NBA or basketball in general. It urges fans to treat any links and attachments, even if they appear to come from a legitimate @nba.com email address, with extra caution.

We know that newsletter services are high on the target list of cybercriminals. In January of 2023, [Mailchimp fell victim for the second time in a year](https://grahamcluley.com/mailchimp-slips-up-again-suffers-security-breach-after-falling-on-social-engineering-banana-skin/) to a [social engineering attack](https://www.malwarebytes.com/social-engineering). Getting your hands on a list of email addresses that share a common interest is a golden opportunity for scammers.
...
* Change your password. You can make a stolen password useless to thieves by changing it. Choose a [strong password](https://www.malwarebytes.com/computer/how-to-create-a-strong-password) that you don’t use for anything else. Better yet, let a [password manager](https://www.malwarebytes.com/what-is-password-manager) choose one for you.
* Enable two-factor [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication). Where possible, use a FIDO2 [2FA](https://www.malwarebytes.com/cybersecurity/basics/2fa) device. Some forms of [two-factor authentication (2FA)](https://www.malwarebytes.com/blog/news/2023/10/multi-factor-authentication-has-proven-it-works-so-what-are-we-waiting-for) can be phished just as easily as a password. 2FA that relies on a FIDO2 device can’t be phished.
* Watch out for fake vendors. The thieves may contact you posing as the vendor. Check the vendor website to see if they are contacting victims, and verify...