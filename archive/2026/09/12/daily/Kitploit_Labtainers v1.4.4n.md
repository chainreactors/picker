---
title: Labtainers v1.4.4n
url: https://kitploit.com/en/posts/github-mfthomps-labtainers-v144n
source: Kitploit
date: 2026-09-12
fetch_date: 2026-09-13T07:01:27.061908
---
...
![](https://assets.kitploit.com/production/public/tools/5363/c92cf16d2b2734b2733ef5064a04b4a3192f1e9434daefce6b7d9adc113ffee4.png)
...
Labtainers include more than 50 cyber lab exercises and tools to build your own. Import a single [VM appliance](https://nps.edu/web/c3o/virtual-machine-images) or install on a Linux system and your students are done with provisioning and administrative setup, for these and future lab exercises.
...
with Dockers installed. And Labtainers is available as cloud-based VMs, e.g., on Azure as described in the [Student Guide](https://raw.githubusercontent.com/mfthomps/labtainers/master/docs/student/labtainer-student.pdf).

See the [Student Guide](https://raw.githubusercontent.com/mfthomps/labtainers/master/docs/student/labtainer-student.pdf) for installation and use, and the [Instructor Guide](https://raw.githubusercontent.com/mfthomps/labtainers/master/docs/instructor/labtainer-instructor.pdf) for student assessment. Developing and customizing
lab exercises is described in the [Designer Guide](https://raw.githubusercontent.com/mfthomps/labtainers/master/docs/labdesigner/labdesigner.pdf).
See the [Papers](https://nps.edu/web/c3o/labtainers#papers) for additional information about the framework.
...
in the [docs/license.md file](https://github.com/mfthomps/labtainers/blob/master/docs/license.md).
...
Use the GitHub issue reports, or email me at [[email protected]](/cdn-cgi/l/email-protection#dab7bcaeb2b5b7aaa99ab4aaa9f4bfbeaf)
