---
title: Hackers steal Discord accounts with RedTiger-based infostealer
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![X: Re-enroll 2FA security keys by November 10 or get locked out](data:image/gif;base64...)
  ...
  + [![CISA orders feds to patch Windows Server WSUS flaw used in attacks](data:image/gif;base64...)
  ...
  + [![New CoPhish attack steals OAuth tokens via Copilot Studio agents](data:image/gif;base64...)
  ...
  + [![X: Re-enroll 2FA security keys by November 10 or get locked out](data:image/gif;base64...)
    ...
    X: Re-enroll 2FA security keys by November 10 or get locked out](https://www.bleepingcomputer.com/news/security/x-re-enroll-2fa-security-keys-by-november-10-or-get-locked-out/)
  + [![Ransomware profits drop as victims stop paying hackers](data:image/gif;base64...)
  ...
  + [![Windows will soon prompt for memory scans after BSOD crashes](data:image/gif;base64...)
