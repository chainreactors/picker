---
title: Supply chain: più sicurezza oggi, meno scuse per domani
url: https://www.cybersecurity360.it/nuove-minacce/supply-chain-piu-sicurezza-oggi-meno-scuse-per-domani/
source: Over Security - Cybersecurity news aggregator
date: 2025-07-12
fetch_date: 2025-10-06T23:50:59.646496
---
...
![ransomware_supplychain](data:image/png;base64...)![ransomware_supplychain](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/07/ransomware_supplychain.jpg)
...
Scenari di rischio che devono essere valutati puntualmente, come peraltro espressamente previsto dalla NIS 2 che introduce l’[obbligo di gestire la sicurezza della catena di approvvigionamento](https://www.cybersecurity360.it/cybersecurity-nazionale/direttiva-nis-2-la-sicurezza-delle-infrastrutture-critiche-tra-normativa-e-buone-prassi/).
...
## Sicurezza della supply chain: n**on c’è scusa che tenga**

La minaccia è attuale, come dimostra l’attacco di filiera [in cui è stata coinvolta Radix](https://www.cybersecurity360.it/nuove-minacce/ransomware/attacchi-ransomware-nis2-ed-effetto-filiera-il-caso-di-radix-in-svizzera/).

La fondazione è stata infatti vittima di un [attacco ransomware](https://www.cybersecurity360.it/nuove-minacce/ransomware-cose-come-rimuoverlo-e-come-difendersi/) probabilmente **in quanto** fornitore e questo ha coinvolto i dati personali dei dati degli altri soggetti che risiedevano all’interno dei suoi sistemi consentendo ai cyber criminali di ottenere un cospicuo bottino e una leva estorsiva molto forte.

Gli attacchi di questo tipo non possono in alcun modo essere considerati un evento assolutamente imprevedibile e richiedono anzi una particolare attenzione nel predisporre tutte le misure adeguate ai rischi e [rispondenti allo stato dell’arte](https://www.cybersecurity360.it/news/i-costi-del-ransomware-la-lezione-della-sanzione-privacy-allordine-degli-psicologi-lombardi/). Senza la possibilità di alcuna scusa a riguardo, [men che meno un budget limitato](https://www.cybersecurity360.it/legal/privacy-dati-personali/privacy-e-sostenibilita-la-protezione-dei-dati-non-si-sospende-per-mancanza-di-budget/).
...
* [C
  ...
  cyber resilience](https://www.cybersecurity360...