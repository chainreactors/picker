---
title: Google reveals 18 chip vulnerabilities threatening mobile, wearables, vehicles
url: https://www.malwarebytes.com/blog/news/2023/03/google-reveals-18-chip-vulnerabilities-threatening-mobile-wearables-vehicles
source: Over Security - Cybersecurity news aggregator
date: 2023-03-22
fetch_date: 2025-10-04T10:17:19.642403
---
...
![Stack of phones](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/03/asset_upload_file85564_262456.jpg?w=736)
...
Google’s Project Zero is [warning of multiple significant vulnerabilities](https://googleprojectzero.blogspot.com/2023/03/multiple-internet-to-baseband-remote-rce.html) found across many models of mobile devices including Samsung Galaxy, Google Pixel, Vivo, and several forms of wearable and vehicles using certain types of components.

Between late 2022 and early 2023, Project Zero reported 18 vulnerabilities in a [chip](https://semiconductor.samsung.com/processor/modem/exynos-modem-5100/%23%3A~%3Atext%3Dsingle%2520chip.%2CTDD%2520in%2520a%2520single%2520chip.) powering those devices. Of those 18, a total of four vulnerabilities are tagged as “top-severity” which could allow for silent compromise over the network.
...
Meanwhile, the Google Security research team believes that the most severe vulnerabilities would allow skilled attackers to create an operational [exploit](https://www.malwarebytes.com/exploits) in a short space of time.

## Patching and scope of threat

While Google mentions that patching will be dependent on manufacturer, PIxel phones (for example) have already been patched against [CVE-2023-24033](https://nvd.nist.gov/vuln/detail/CVE-2023-24033) in the [March security update](https://source.android.com/docs/security/bulletin/pixel/2023-03-01). If a patch isn’t forthcoming for your own device yet, Google has some suggestions to help keep your technology safe from harm. If your device allows you to, [switch off](https://www.makeuseof.com/what-is-volte/) two settings called:

* Wi-Fi calling
* Voice-over-LTE (VoLTE)

This will prevent the risk of exploitation. One potential ramification of disabling VoLTE is that in recent years it has become [something of a necessity](https://ting.blog/turn-on-volte/%23%3A~%3Atext%3DAs%2520carriers%2520shut%2520down%2520their%2Cto%2520make%2520and%2520receive%2520calls.) for [some mobile networks](https://www.xda-developers.com/t-mobile-att-require-volte-phone-calls-shut-down-3g/). If you’re able to turn it off, then based on the information available you may experience poor call quality and lack of certain features and functionality. On the other hand, VoLTE is “[not available everywhere on every network, or on every handset](https://www.4g.co.uk/what-is-volte/)” so it may not matter too much anyway depending on your make and model.

As for scope, depending on where your device is from you may not be running the vulnerable type of chip needed for the exploit to be successful. T...