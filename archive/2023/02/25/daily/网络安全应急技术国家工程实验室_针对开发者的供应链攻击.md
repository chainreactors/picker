---
title: 针对开发者的供应链攻击
url: https://mp.weixin.qq.com/s?__biz=MzUzNDYxOTA1NA==&mid=2247534906&idx=4&sn=b0f89a89afb4c9b976240a5730e20bdc&chksm=fa93fffbcde476ed4f0891a5b5e6124f26a04790174489fbd52d9a6fb2795aff922b360f2eea&scene=58&subscene=0#rd
source: 网络安全应急技术国家工程实验室
date: 2023-02-25
fetch_date: 2025-10-04T08:04:56.614893
---

# 针对开发者的供应链攻击

![cover_image](https://mmbiz.qpic.cn/mmbiz_jpg/GoUrACT176moltN6pDACpaVffQkr6gEBxYzkvCGJkqDOW15PsQ9vUvVmyzV55wYtjfCNDA3E7CIhvz3dDeGkog/0?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/iaz5iaQYxGogvZSrdFUBtAic9icDclMDYibcRO1YYINWKRNcbzk1szR21TxdT4XRuOEcV4qRDDwTg2aRCwibFkmAqoKw/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDaWoKNXjvdGOUWk3bGvcHdy4fhnZldCf5SsKT2Csrb2H22V5TMKjsOw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

Visual Studio代码工作区信任对话框开发者应该寻找和考虑哪些代码不应该被信任的可疑迹象？在其他示例中，应该引起开发者警惕的迹象包括：
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDM5BDLpkXmqA9qqFdsicSNJib0aMfkYqslibT1vibelL2ZVDAvfBQNv4kuQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDHVXjFXnibTGEqZU423Ue1JZ9ialxybLsHTfyXn1qGxvRYeBeVRYfQ7OA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

Visual Studio项目文件预生成任务命令示例

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFD9Qx9O0Ity8ibenO936qiapLnuCGua4SCVuAyozr3cqVUibJHoHphQQofg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDFeoTr6URPzTuepJ6NicmrcsY9Hv2v1X8lBe6Aw8de78PSKfxbIMAPWg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

.project文件节链接生成执行规范的示例

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDzjCOee7IXPLRxgqjEs8KHuE2J3Zfuptj1URQWgwFQzVpIXUsP9wfCw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDd8ZuLZP9g01SB4YSFryEhphVD5RwE1CMz6LcejgBllA7xm6FKAUmEQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

Ant的注入点和触发生成时的命令执行示例

当开发者使用Maven作为生成工具时，可以通过更改项目文件夹中的pom.xml来实现相同的目标。这一次，在生成标记中使用了org.codehaus.mojo插件。所使用的语法类似于Ant所使用的语法。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDicx1h8TdZQIQS6LriaSD7Ec7nEJ75ZibbicjI4IlKha0gyxMcF6MliamyLg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

Maven第三方执行示例

对于Gradle，Groovy语言脚本用于位于app/build.gradle内部的生成定义，并且对所选任务内的字符串调用execute()函数将触发代码执行。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDkhelKfzufRI2x56sFL8xVNqkrHO4ibxL2ic0fqibC1Nb2odibOXsFNdicVA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFD66FdfDvJVtLKNjlJGXGnZgF6QKNP2RibG9oPkfOuJKwuCfldujjryfQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDqmgmt9jSibYJyyz0kYWrgvLictCMsH5bHxE4MhKC1max5a0boHvU4ibZQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

IntelliJ IDEA显示潜在恶意生成脚本的警告

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDzWI9zcGUibicPdictzEVU6tx4U5ugdE2PBTdicBEiausPYe1Xzr31ymJuqw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDGCWh2sdicOc5gh4michmpXbWFVchr1DRWvlhCogcmfTYXib1DqiaEFuIQA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDJlLMkib9Enbr1VrKp9aEqeb8FOFiaGdRZZOqYrSib2bk9d4aXytqTBxzA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

运行前任务参考

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ib4WLCmODCia9KibLXBPw9nFDaiaPQoMYUE9cI8ZEjDT7eDvhlX0d4qakiagZWP7P4uCiaWf5QNxpRMY1Q/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
https://www.trendmicro.com/en\_us/research/23/a/attacking-the-supply-chain-developer.html
...
![](http://mmbiz.qpic.cn/mmbiz_png/GoUrACT176mrRug7icLIhX4EvNQjNgGRibia7K9qOLTR5PDfQiaUesU9xge7pnF8iciaxVC3J...