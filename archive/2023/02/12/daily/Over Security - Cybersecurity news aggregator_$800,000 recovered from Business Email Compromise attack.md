---
title: $800,000 recovered from Business Email Compromise attack
url: https://www.malwarebytes.com/blog/news/2023/02/800k-recovered-from-business-email-compromise-attack
source: Over Security - Cybersecurity news aggregator
date: 2023-02-12
fetch_date: 2025-10-04T06:26:29.908647
---
...
![A computer mouse and a fishing hook](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/02/asset_upload_file87074_258901.jpg?w=736)
...
We continue to see the damaging repercussions of business email compromise (BEC) impacting organisations across the US and elsewhere. The Houston Chronicle reports that [law enforcement seized $800,000 from a bank account](https://www.houstonchronicle.com/business/retail/article/houston-business-us-attorney-email-phishing-17766409.php) used for pillaging funds from a construction management company.
...
As per the [civil complaint](https://storage.courtlistener.com/recap/gov.uscourts.txsd.1903215/gov.uscourts.txsd.1903215.1.0.pdf), [phishing](https://www.malwarebytes.com/phishing) attacks and / or [malware](https://www.malwarebytes.com/malware) were allegedly used to break into the business. The scammers then worked their way to the accounts department:
...
There are multiple ways to try and steer clear of BEC attacks. Multiple tips are [listed on the Justice.Gov release](https://www.justice.gov/usao-sdtx/pr/civil-complaint-filed-seeking-over-800k-business-email-compromise-scheme), many of which we’ve been advising for some time now. Here they are, along with some of our own:

* **Enable two-factor [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication) ([2FA](https://www.malwarebytes.com/cybersecurity/basics/2fa)) on email accounts**. 2FA that uses hardware keys or FIDO2 devices is resistant to phishing, and all forms of 2FA are resistant to password guessing, [brute force](https://www.malwarebytes.com/cybersecurity/basics/brute-force-attack) attacks, and pas...