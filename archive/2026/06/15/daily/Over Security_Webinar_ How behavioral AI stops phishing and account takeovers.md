...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Over 400 Arch Linux packages compromised to push rootkit, infostealer](data:image/gif;base64...)
  ...
  + [![Microsoft fixes Windows update failures linked to WUSA installer](data:image/gif;base64...)
  ...
  + [![Maine disables data breach notification portal after fake disclosures](data:image/gif;base64...)
  ...
  + [![iRhythm discloses data breach, says hackers stole patient info](data:image/gif;base64...)
  ...
  + [![DOJ seizes CFAKE, SOCFAKE deepfake nude sites under TAKE IT DOWN Act](data:image/gif;base64...)
  ...
  + [![SimpleHelp bug lets hackers create rogue remote support accounts](data:image/gif;base64...)
  ...
  + [![OptinMonster WordPress plugin hacked in CDN supply-chain attack](data:image/gif;base64...)
...
![Phishing hook](https://www.bleepstatic.com/content/hl-images/2022/08/23/phishing-hook.jpg)

Email attacks have become increasingly difficult to detect as attackers use AI-generated phishing campaigns, trusted business identities, and authentication workflows that appear legitimate to both users and security tools.

On July 8, 2026, BleepingComputer will host a live webinar titled "**[Stop chasing alerts: Automating email security with behavi...