---
title: Mark Wielaard: New services for sourceware, SFC & FSF
url: https://gnu.wildebeest.org/blog/mjw/2022/11/20/new-services-for-sourceware-sfc-fsf/
source: Planet Classpath
date: 2022-11-21
fetch_date: 2025-10-03T23:18:42.100226
---

# Mark Wielaard: New services for sourceware, SFC & FSF
...
The FSF was nice enough to host a video chat on [Sourceware infrastructure – A presentation and community Q&A](https://www.fsf.org/events/sourceware-infrastructure-a-presentation-and-community-q-a). Which was basically the BoF we had wanted to give about [Sourceware Infrastructure](https://gnu.wildebeest.org/blog/mjw/2022/09/18/sourceware-infrastructure-conservancy-gnu-toolchain-at-cauldron/) at the Cauldron. Extended with some discussion on recent developments, [Sourceware as Conservancy member project](https://gnu.wildebeest.org/blog/mjw/2022/09/12/sourceware-as-conservancy-member-project/) and collaboration with the FSF tech-team. It was less interactive than the in person BoF would have been, but there was some nice feedback afterwards.

Slides [New services for sourceware projects](https://gnu.wildebeest.org/~mark/fsf-sourceware/presentation.html). Markdown source plus [presenter notes](https://gnu.wildebeest.org/~mark/fsf-sourceware/sourceware-infra.md).

« [Valgrind 3.20.0](https://gnu.wildebeest.org/blog/mjw/2022/10/24/valgrind-3-20-0/)
