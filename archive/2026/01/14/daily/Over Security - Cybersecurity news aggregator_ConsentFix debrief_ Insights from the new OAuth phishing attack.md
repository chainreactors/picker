...
url: https://www.bleepingcomputer.com/news/security/consentfix-debrief-insights-from-the-new-oauth-phishing-attack/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-14
fetch_date: 2026-01-15T03:31:54.017987
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft January 2026 Patch Tuesday fixes 3 zero-days, 114 flaws](data:image/gif;base64...)
  ...
  + [![Belgian hospital AZ Monica shuts down servers after cyberattack](data:image/gif;base64...)
  ...
  + [![Target employees confirm leaked source code is authentic](data:image/gif;base64...)
  ...
  + [![Betterment confirms data breach after wave of crypto scam emails](data:image/gif;base64...)
  ...
  + [![ChatGPT's upcoming cross-platform feature is codenamed ](data:image/gif;base64...)
  ...
  + [![Google plans to make Chrome for Android an agentic browser with Gemini](data:image/gif;base64...)
  ...
  + [![Google's Personal Intelligence links Gmail, Photos and Search to Gemini](data:image/gif;base64...)
  ...
  + [![OpenAI's hidden ChatGPT Translate tool takes on Google Translate](data:image/gif;base64...)
...
###### [Push Security](https://pushsecurity.com/demo?utm_source=bleeping-computer&utm_medium=sponsored-content&utm_term=sidebar)
...
In December, the Push Security research team discovered and blocked a brand new attack technique that we coined [ConsentFix](https://pushsecurity.com/blog/consentfix?utm_source=bleeping-computer&utm_medium=sponsored-content&utm_term=article). This technique me...