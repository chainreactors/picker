---
title: 集权攻击系列：如何利用PAC新特性对抗黄金票据？
url: https://blog.csdn.net/ZAWX_NETSTARSEC/article/details/130988266
source: ZAWX_NETSTARSEC的博客
date: 2023-06-02
fetch_date: 2025-10-04T11:45:10.114166
---
...
本文链接：<https://blog.csdn.net/ZAWX_NETSTARSEC/article/details/130988266>

![](https://i-operation.csdnimg.cn/images/a7311a21245d4888a669ca3155f1f4e5.png)本文介绍了微软针对CVE-2021-42287的安全更新，该更新在PAC中添加了PAC\_REQUESTOR属性以增强Kerberos权限校验。通过解析PAC结构，阐述了PAC的关键作用，以及在更新后的验证规则变化。同时，提到了更新后的兼容性和阶段部署计划，以及如何通过日志事件37和38检测黄金票据攻击。
...
![](https://i-blog.csdnimg.cn/blog_migrate/b02a82c286baec19f449db9b0d5a58fb.png)

整个结构详解可以参考daiker师傅的这篇文章，由于TGT是krbtgt用户的hash加密的，我们在wireshark抓包是看不到TGT的结构的，不过我们可以写了一个工具来解密TGT和PAC。

PAC解析后内容如下：

![](https://i-blog.csdnimg.cn/blog_migrate/8ce02d8e74848d38269a7990339c4561.png)

![](https://i-blog.csdnimg.cn/blog_migrate/fd606db76b2da8ebb08d9d05a154e583.png)

 可以看到在没有更新之前PAC中一共由5种类型的INFO\_BUFFER:

·KERB\_VALIDATION\_INFO（0x1）

·PAC\_CLIENT\_INFO(0x0A)

·UPN\_DNS\_INFO(0x0C)

·PAC\_SERVER\_CHECKSUM (0x06)
