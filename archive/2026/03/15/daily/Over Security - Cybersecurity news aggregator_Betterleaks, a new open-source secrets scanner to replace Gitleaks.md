...
date: 2026-03-15
fetch_date: 2026-03-16T04:33:56.752126
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![FBI seeks victims of Steam games used to spread malware](data:image/gif;base64...)
  ...
  + [![Poland's nuclear research centre targeted by cyberattack](data:image/gif;base64...)
  ...
  + [![Microsoft: Windows 11 users can't access C: drive on some Samsung PCs](data:image/gif;base64...)
  ...
  + [![Police sinkholes 45,000 IP addresses in cybercrime crackdown](data:image/gif;base64...)
  ...
  + [![OpenAI says ChatGPT ads are not rolling out globally for now](data:image/gif;base64...)
  ...
  + [![Betterleaks, a new open-source secrets scanner to replace Gitleaks](data:image/gif;base64...)
  ...
  + [![This $20 EDU Unlimited deal unlocks 1,000+ online courses](data:image/gif;base64...)

    This $20 EDU Unlimited deal unlocks 1,000+ online courses](https://www.bleepingcomputer.com/offer/deals/this-20-edu-unlimited-deal-unlocks-1-000-plus-online-courses/)
  + [![Microsoft releases Windows 11 OOB hotpatch to fix RRAS RCE flaw](data:image/gif;base64...)
...
![Betterleaks, a new open-source secrets scanner to replace Gitleaks](https://www.bleepstatic.com/content/hl-images/2024/04/02/scanner.jpg)

A new open-source tool called Betterleaks can scan directories, files, and git repositories and identify...