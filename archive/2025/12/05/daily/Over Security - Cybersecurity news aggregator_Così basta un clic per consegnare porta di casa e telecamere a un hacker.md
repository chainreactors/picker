---
title: Così basta un clic per consegnare porta di casa e telecamere a un hacker
url: https://www.cybersecurity360.it/news/cosi-basta-un-clic-per-consegnare-porta-di-casa-e-telecamere-a-un-hacker/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-05
fetch_date: 2025-12-06T03:11:35.876654
---
...
[Rosita Rijtano](https://www.cybersecurity360.it/giornalista/rosita-rijitano/)
...
![vulnerabilità device smart](data:image/png;base64...)![vulnerabilità device smart](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/12/vulnerabilita-device-smart.jpg)
...
Non è immaginazione, né un film di fantascienza, ma ciò che sarebbe potuto accadere a chiunque avesse associato i propri oggetti smart a [Tuya](https://hotel.tuya.com/), una delle piattaforme di domotica più diffuse al mondo.
...
Per anni questa [vulnerabilità](https://www.cybersecurity360.it/nuove-minacce/sicurezza-software-e-vulnerabilita-informatiche-che-ce-da-sapere/) ha esposto un numero enorme di dispositivi a possibili abusi, senza che gli utenti se ne accorgessero. Il problema non riguardava solo Tuya Smart e Smartlife ― le due app Tuya che solo su Android superano i 10 milioni di download a testa ― ma anche la libreria Tuya: un componente standard utilizzato in decine di applicazioni che controllano milioni di videocamere, serrature e sensori nelle nostre case.
...
* [Come funziona la vulnerabilità](#Come_funziona_la_vulnerabilita)
* [Cross-Site Request Forgery, un rischio per gli oggetti smart](#Cross-Site_Request_Forgery_un_rischio_per_gli_oggetti_smart)
...
Il trucco era possibile perché Tuya non verificava un passaggio cruciale: non controllava che l’app con cui veniva chiuso il processo di associazione era la stessa che lo aveva iniziato.
