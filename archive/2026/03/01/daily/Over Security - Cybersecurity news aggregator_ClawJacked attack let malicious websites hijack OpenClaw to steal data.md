...
date: 2026-03-01
fetch_date: 2026-03-02T04:07:01.236890
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft testing Windows 11 batch file security improvements](data:image/gif;base64...)
  ...
  + [![CISA warns that RESURGE malware can be dormant on Ivanti devices](data:image/gif;base64...)
  ...
  + [![APT37 hackers use new malware to breach air-gapped networks](data:image/gif;base64...)
  ...
  + [![Critical Cisco SD-WAN bug exploited in zero-day attacks since 2023](data:image/gif;base64...)
  ...
  + [![ClawJacked attack let malicious websites hijack OpenClaw to steal data](data:image/gif;base64...)
  ...
  + [![Samsung TVs to stop collecting Texans’ data without express consent](data:image/gif;base64...)
  ...
  + [![1TB lifetime of Koffr cloud storage is just $160 for a limited time](data:image/gif;base64...)

    1TB lifetime of Koffr cloud storage is just $160 for a limited time](https://www.bleepingcomputer.com/offer/deals/1tb-lifetime-of-koffr-cloud-storage-is-just-160-for-a-limited-time/)
  + [![QuickLens Chrome extension steals crypto, shows ClickFix attack](data:image/gif;base64...)
...
![OpenClaw](https://www.bleepstatic.com/content/hl-images/2026/02/16/openclaw-header-image.jpg)

Security researchers have disclosed a high-severity vulne...