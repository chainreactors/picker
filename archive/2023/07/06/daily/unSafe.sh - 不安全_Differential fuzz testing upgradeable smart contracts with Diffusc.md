...
url: https://buaq.net/go-171293.html
source: unSafe.sh - 不安全
date: 2023-07-06
fetch_date: 2025-10-04T11:51:30.825253
---
...
![](https://8aqnet.cdn.bcebos.com/060c07501a452bba406431f5df75e045.jpg)

Differential fuzz testing upgradeable smart contracts with Diffusc

By William E Bodell III (@WEBthe3rd)On March 28, 2023, SafeMoon, a self-styled “
*2023-7-5 19:0:33
Author: [blog.trailofbits.com(查看原文)](/jump-171293.htm)
阅读量:48
收藏*
...
[![](https://i0.wp.com/blog.trailofbits.com/wp-content/uploads/2023/06/image1-1.png?resize=690%2C281&ssl=1)](https://i0.wp.com/blog.trailofbits.com/wp-content/uploads/2023/06/image1-1.png?ssl=1)*Figure 1. Diffusc architecture at a high level*
...
One of the new functions, `_upgradeSplitCompRewards()`, initialized any existing markets that had not accrued any rewards with a new `index` value in the market’s corresponding `supplyState` struct. This new function was called by the modified `_become()` function, which is called as part of the upgrade...