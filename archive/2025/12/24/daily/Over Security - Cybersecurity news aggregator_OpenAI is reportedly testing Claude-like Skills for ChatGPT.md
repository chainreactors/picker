---
title: OpenAI is reportedly testing Claude-like Skills for ChatGPT
url: https://www.bleepingcomputer.com/news/artificial-intelligence/openai-is-reportedly-testing-claude-like-skills-for-chatgpt/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-24
fetch_date: 2025-12-25T03:26:51.568046
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Interpol-led action decrypts 6 ransomware strains, arrests hundreds](data:image/gif;base64...)
  ...
  + [![CISA flags ASUS Live Update CVE, but the attack is years old](data:image/gif;base64...)
  ...
  + [![Malicious npm package steals WhatsApp accounts and messages](data:image/gif;base64...)
  ...
  + [![New MacSync malware dropper evades macOS Gatekeeper checks](data:image/gif;base64...)
  ...
  + [![OpenAI is reportedly testing Claude-like Skills for ChatGPT](data:image/gif;base64...)
  ...
  + [![Turn ideas into content with this all-in-one AI tool for $75](data:image/gif;base64...)

    Turn ideas into content with this all-in-one AI tool for $75](https://www.bleepingcomputer.com/offer/deals/turn-ideas-into-content-with-this-all-in-one-ai-tool-for-75/)
  + [![Fake MAS Windows activation domain used to spread PowerShell malware](data:image/gif;base64...)
  ...
  + [![Microsoft Teams to let admins block external users via Defender portal](data:image/gif;base64...)
...
![ChatGPT](https://www.bleepstatic.com/content/hl-images/2023/03/24/ChatGPT-logo.jpg)

OpenAI is testing a new ChatGPT feature called "Skills," which will be similar to Claude's feat...