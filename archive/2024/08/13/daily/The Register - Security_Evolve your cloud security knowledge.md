...
url: https://go.theregister.com/feed/www.theregister.com/2024/08/12/evolve_your_cloud_security_knowledge/
source: The Register - Security
date: 2024-08-13
fetch_date: 2025-10-06T18:12:18.961038
---
...
The unfortunate corollary of this increasing dependence is that cybercrooks are more attracted to cracking open cloud platforms so they can help themselves to our data.

Maybe not surprising then that cloud security often tops the CISO agenda but it's a complex topic to keep on top of. Anybody wanting to get better acquainted with this ever-changing landscape should ringfence Tuesday 27 August in their diary, the date of the [SANS Cloud Security Exchange 2024 event](https://www.sans.org/mlp/cloud-security-exchange-2024/?utm_medium=Sponsored_Content&utm_source=The_Register&utm_campaign=Cloud_Security_Exchange_2024).

[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg_security/front&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aOOWASmmO30Za7LWiAxAGAAAAMc&t=ct%3Dns%26unitnum%3D2%26raptor%3Dcondor%26pos%3Dtop%26test%3D0)](https://pubads.g.doubleclick.net/gampad/jump?co=1&iu=/6978/reg_security/front&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aOOWASmmO30Za7LWiAxAGAAAAMc&t=ct%3Dns%26unitnum%3D2%26raptor%3Dcondor%26pos%3Dtop%26test%3D0)

Entirely free of charge, this annual meeting of top security minds is an opportunity for security professionals everywhere to learn from, and network with, experts and peers to build on their existing cloud security knowledge. This virtual event features insights from some big names in the cloud industry - Amazon Web Services (AWS), Google Cloud and Microsoft Azure – for example as well as experienced thought leaders and instructors from the SANS Institute itself.
