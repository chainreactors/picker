---
title: Incidenti informatici, ecco i nuovi obblighi di notifica che rafforzano il Perimetro cyber
url: https://www.cybersecurity360.it/cybersecurity-nazionale/incidenti-informatici-ecco-i-nuovi-obblighi-di-notifica-che-rafforzano-il-perimetro-cyber/
source: Over Security - Cybersecurity news aggregator
date: 2023-01-13
fetch_date: 2025-10-04T03:48:56.324549
---
...
[Danilo Dell'Aria](https://www.cybersecurity360.it/giornalista/danilo-dellaria/)

Analyst, Hermes Bay

[Marco Vettore](https://www.cybersecurity360.it/giornalista/marco-vettore/)

Analyst, Hermes Bay

![La corretta gestione degli incidenti cyber: tra adempimenti pratici e approccio multi-compliance](data:image/png;base64...)![La corretta gestione degli incidenti cyber: tra adempimenti pratici e approccio multi-compliance](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2023/01/Tassonomia-incidenti-informatici.jpg)

tassonomia incidenti informatici

Prosegue l’iter per rafforzare il **Perimetro Nazionale di Sicurezza Cibernetica (PNSC)**: tramite la **Determina 3 gennaio 2023** a firma del Direttore Roberto Baldoni (pubblicata in [**Gazzetta Ufficiale del 10 gennaio 2023**](https://www.gazzettaufficiale.it/do/gazzetta/downloadPdf?dataPubblicazioneGazzetta=20230110&numeroGazzetta=7&tipoSerie=SG&tipoSupplemento=GU&numeroSupplemento=0&progressivo=0&estensione=pdf&edizione=0)) l’Agenzia per la Cybersicurezza Nazionale (ACN) ha pubblicato la **nuova tassonomia riguardante gli incidenti che debbono essere oggetto di notifica** ed estende gli [**obblighi di notifica**](https://www.cybersecurity360.it/cybersecurity-nazionale/nuovi-obblighi-di-notifica-degli-incidenti-quali-conseguenze-per-i-soggetti-inclusi-nel-psnc/) dei soggetti facenti parte del perimetro di sicurezza.

> [Perimetro cyber, operativo il processo di certificazione: quali implicazioni](https://www.cybersecurity360.it/outlook/perimetro-cyber-operativo-il-processo-di-certificazione-quali-implicazioni/)

Indice degli argomenti

* [La nuova tassonomia: ecco di cosa si tratta](#La_nuova_tassonomia_ecco_di_cosa_si_tratta)
* [Com’è organizzata la nuova tassonomia degli incidenti cyber](#Come_organizzata_la_nuova_tassonomia_degli_incidenti_cyber)
  + [Le differenti categorie di incidenti nella nuova tassonomia](#Le_differenti_categorie_di_incidenti_nella_nuova_tassonomia)
* [Gli interventi dell’Agenzia sul tema cyber](#Gli_interventi_dellAgenzia_sul_tema_cyber)
...
Come spiegato all’interno del comunicato, ogni tentativo di accesso a beni informatici che non ricadono sotto la protezione del Pe...