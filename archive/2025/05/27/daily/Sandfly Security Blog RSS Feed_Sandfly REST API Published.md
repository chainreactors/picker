---
title: Sandfly REST API Published
url: https://sandflysecurity.com/blog/sandfly-rest-api-published
source: Sandfly Security Blog RSS Feed
date: 2025-05-27
fetch_date: 2025-10-06T22:27:52.904261
---
...
Sandfly rides on top a full featured REST API. Users can now access the REST API documentation below:

[Sandfly REST API](https://docs.sandflysecurity.com/v1.2/reference)

Every aspect of Sandfly can be controlled through the API and integrated into your favorite security automation platform.
