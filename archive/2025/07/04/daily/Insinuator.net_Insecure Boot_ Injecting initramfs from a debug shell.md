---
title: Insecure Boot: Injecting initramfs from a debug shell
url: https://insinuator.net/2025/07/insecure-boot-injecting-initramfs-from-a-debug-shell/
source: Insinuator.net
date: 2025-07-04
fetch_date: 2025-10-06T23:50:44.685261
---
...
[Back](https://insinuator.net/#post-15346)

[Building](https://insinuator.net/category/building/)

[July 3, 2025](https://insinuator.net/2025/07/insecure-boot-injecting-initramfs-from-a-debug-shell/) by [Alexander Moch](https://insinuator.net/author/amoch/)
...
[CVE-2016-4484](https://nvd.nist.gov/vuln/detail/CVE-2016-4484) describes a similar method of gaining a root shell. Modifying the initramfs is also not new as *EvilAbigail*[1](#fn1) from 2015 and *de-LUKS*[2](#fn2) from 2018 show. This attack represents an *evil maid* scenario in which the attacker has physical access to the system. Many similar attacks assume the attacker modifies the storage device directly (i.e., the solid-state drive). In contrast, this attack follows a regular boot sequence, triggers a debug...