...
url: https://seclists.org/fulldisclosure/2022/Nov/14
source: Full Disclosure
date: 2022-11-21
fetch_date: 2025-10-03T23:20:39.028193
---
...
*Date*: Fri, 18 Nov 2022 22:22:24 -0500
...
code, control and terminate the malware. Once loaded the exploit dll will
check if the current directory is "C:\Windows\System32", if not we grab our
process ID and terminate. All basic tests were conducted successfully in a
...
//Purpose: PWN Platinum Group malware strain MD5:
71a76adeadc7b51218d265771fc2b0d1
...
BOOL APIENTRY DllMain(HINSTANCE hInst, DWORD reason, LPVOID reserved){
  ...
  case DLL_PROCESS_ATTACH:
   MessageBox(NULL, "Platinum Group\nPWNED!!! by Malvuln", "Code Exec PoC",
MB_OK);
   TCHAR buf[MAX_PATH];
