---
title: Incident Response in GCP: Out of Scope – Ouf of Mind
url: https://insinuator.net/2026/01/incident-response-in-gcp-out-of-scope-ouf-of-mind/
source: Insinuator.net
date: 2026-01-27
fetch_date: 2026-01-28T03:33:54.099828
---
...
![Security configuration tab of the GCE instance creation dialog in GCP](https://insinuator.net/wp-content/uploads/2026/01/gce-security.png)

Security configuration tab of the GCE instance creation dialog in GCP.

As we can see in the screenshot, the [*Compute Engine default service account*](https://docs.cloud.google.com/compute/docs/access/service-accounts#default_service_account) is preselected in the web interface (but we can change it to some other Service Account or even *no* Service Account). This Service Account is automatically generated when creating a GCP project. If GCP orga...