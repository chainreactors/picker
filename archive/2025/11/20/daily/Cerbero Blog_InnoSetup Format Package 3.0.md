---
title: InnoSetup Format Package 3.0
url: https://blog.cerbero.io/innosetup-format-package-3-0/
source: Cerbero Blog
date: 2025-11-20
fetch_date: 2025-11-21T03:12:20.777336
---
...
Version 3 of our state-of-the-art [InnoSetup Format package](https://cerbero.io/packages/innosetupformat/) is now available and includes support for the latest releases of InnoSetup and the recently introduced full encryption mode.

![](/wp-content/uploads/2025/11/inno.png)

In addition to the format itself and file extraction, make sure to install the [IFPS Format package](https://cerbero.io/packages/ifpsformat/) to inspect the code of setup scripts.

![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [November 20, 2025](https://blog.cerbero.io/innosetup-format-package-3-0/)Categories [Package](https://blog.cerbero.io/category/package/)Tags [Installer](https://blog.cerbero.io/tag/installer/), [Setup](https://blog.cerbero.io/tag/setup/)

## Leave a Reply [Cancel reply](/innosetup-format-package-3-0/#respond)
...
[Previous Previous post: Memory Challenge 8: MemLabs Lab 4 – Obsession](https://blog.cerbero.io/memory-challenge-8-memlabs-lab-4-obsession/)
