---
title: tcpreplay v4.6.1
url: https://kitploit.com/en/posts/github-appneta-tcpreplay-v461
source: Kitploit
date: 2026-08-31
fetch_date: 2026-09-01T06:59:46.086851
---
...
![](https://assets.kitploit.com/production/public/tools/2295/1dba614d622788e680d255c62d90350e052a08a516542cf647aca3d281afb8be.png)
...
![](https://raw.githubusercontent.com/appneta/tcpreplay/HEAD/docs/guide/assets/images/logo.svg)
...
Tcpreplay is a suite of [GPLv3](http://www.gnu.org/licenses/gpl-3.0.html) licensed utilities for UNIX (and Windows under
[Cygwin](http://www.cygwin.com/)) for editing and replaying network traffic previously captured by
tools like [tcpdump](http://www.tcpdump.org) and [Wireshark](https://www.wireshark.org). It classifies traffic as client or
...
Since 4.0, Tcpreplay also specifically targets [IP Flow](https://en.wikipedia.org/wiki/Traffic_flow_%28computer_networking%29)/[NetFlow](http://www.cisco.com/go/netflow)
...
* **tcpliveplay** — replay a captured TCP session on a live network in a
  ...
  Siam, sponsored by [Cisco](http://www.cisco.com), for testing the full network stack up into the
...
* [io\_uring](#performance-netmap-af_xdp-io_uring) and
  [AF\_XDP](#performance-netmap-af_xdp-io_uring) fast-path packet injection,
...
See the [CHANGELOG](https://github.com/appneta/tcpreplay/blob/HEAD/docs/CHANGELOG) for the full release history.
...
from a git checkout, or want CMake, netmap, AF\_XDP or io\_uring support.

More detailed platform-specific instructions are in the `INSTALL` file
included in the tarball (same content as [`docs/INSTALL`](https://github.com/appneta/tcpreplay/blob/HEAD/docs/INSTALL) here).
...
[`scripts/autoopts/README.md`](https://github.com/appneta/tcpreplay/blob/HEAD/scripts/autoopts/README.md). None of this is
...
of [`CMakeLists.txt`](https://github.com/appneta/tcpreplay/blob/HEAD/CMakeLists.txt). A few examples:
