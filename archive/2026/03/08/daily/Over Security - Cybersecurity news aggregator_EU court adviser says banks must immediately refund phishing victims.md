...
date: 2026-03-08
fetch_date: 2026-03-09T04:08:47.138323
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Hackers abuse .arpa DNS and ipv6 to evade phishing defenses](data:image/gif;base64...)
  ...
  + [![Fake Claude Code install guides push infostealers in InstallFix attacks](data:image/gif;base64...)
  ...
  + [![Microsoft 365 Backup to add file-level restore for faster recovery](data:image/gif;base64...)
  ...
  + [![EU court adviser says banks must immediately refund phishing victims](data:image/gif;base64...)
  ...
  + [![Hackers abuse .arpa DNS and ipv6 to evade phishing defenses](data:image/gif;base64...)
    ...
    Hackers abuse .arpa DNS and ipv6 to evade phishing defenses](https://www.bleepingcomputer.com/news/security/hackers-abuse-arpa-dns-and-ipv6-to-evade-phishing-defenses/)
  + [![Today only—AdGuard Family Plan lifetime access is just $11 in this deal](data:image/gif;base64...)

    Today only—AdGuard Family Plan lifetime access is just $11 in this deal](https://www.bleepingcomputer.com/offer/deals/today-only-adguard-family-plan-lifetime-access-is-just-11-in-this-deal/)
...
![EU court adviser says banks must immediately refund phishing victims](https://www.bleepstatic.com/content/hl-images/2026/03/06/Europe.jpg)

Athanasios Rantos, the Advocate...