...
url: https://www.adainese.it/blog/2024/08/05/ansible-configuration/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-21
fetch_date: 2025-10-02T20:29:09.520140
---
...
For example, the **DEFAULT\_HOST\_LIST** parameter defines the inventory file. The
[official documentation](https://docs.ansible.com/ansible/latest/reference_appendices/config.html#default-host-list)
 specifies:
...
* **Environment:** The environment variable name to specify this parameter (**ANSIBLE\_INVENTORY**).
...
* Use the file defined by the **ANSIBLE\_CONFIG** environment variable

The **DEFAULT\_HOST\_LIST** parameter can also be specified on the command line with **-i**. Additionally, some parameters can be defined within a playbook.

Ansible uses a
[precedence](https://docs.ansible.com/ansible/latest/reference_appendices/general_precedence.html#general-precedence-rules)
 to determine which parameter value to use if it is specified multiple times. The order is:
...
Continue reading
[the post on Patreon](https://www.patreon.com/posts/ansible-109398567)
.
