...
![Alcon Logo](https://logos.haveibeenpwned.com/Alcon.png)

# Alcon Data Breach

## What Happened

In August 2026, [the Alcon eye care company was named in a ShinyHunters "pay or leak" extortion campaign](https://x.com/h4ckmanac/status/2084157760933949852). The group subsequently published data allegedly sourced from Alcon containing 218k unique email addresses along with other largely corporate B2B contact fields, including name, phone number and physical address.
