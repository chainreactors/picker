...
date: 2024-10-31
fetch_date: 2025-10-06T18:56:11.347159
---
...
[52 Comments](https://krebsonsecurity.com/2024/10/change-healthcare-breach-hits-100m-americans/#comments)
...
![](https://krebsonsecurity.com/wp-content/uploads/2024/10/cardio-epi.png)
...
The *HIPAA Journal* [reports](https://www.hipaajournal.com/change-healthcare-responding-to-cyberattack/) that in the nine months ending on September 30, 2024, Change’s parent firm **United Health Group** had incurred $1.521 billion in direct breach response costs, and $2.457 billion in total cyberattack impacts.
...
That ransom payment [went sideways](https://krebsonsecurity.com/2024/03/blackcat-ransomware-group-implodes-after-apparent-22m-ransom-payment-by-change-healthcare/) when the affiliate who gave BlackCat access to Change’s network said the crime gang had cheated them out of their share of the ransom. The entire BlackCat ransomware operation shut down after that, absconding with all of the money still owed to affiliates who were hired to install their ransomware.

[![](https://krebsonsecurity.com/wp-content/uploads/2024/10/changeletterr.png)](https://krebsonsecurity.com/wp-content/uploads/2024/10/changeletterr.png)
...
But in June 2024 testimony to the Senate Finance Committee, [it emerged](https://www.hipaajournal.com/change-healthcare-responding-to-cyberattack/#:~:text=As%20covered%20by%20The%20HIPAA,exposed%20to%20the%20public%20Internet.) that the intruders had stolen or purchased credentials for a Citrix portal used for remote access, and that no multi-factor authentication was required for that account.

Last month, **Sens. Mark Warner** (D-Va.) and **Ron Wyden** (D-Ore.) [introduced a bill](https://www.finance.senate.gov/chairmans-news/wyden-and-warner-introduce-bill-to-set-strong-cybersecurity-standards-for-american-health-care-system) that would require HHS to develop and enforce a set of tough minimum cybersecurity standards for healthcare providers, health plans, clearinghouses and businesses associates. The measure also would remove the existing cap on fines under the Health Insurance Portability and Accountability Act, which severely limits the financial penalties HHS can issue against providers.
...
![](https://krebsonsecurity.com/wp-content/uploads/2024/10/ransomhub-change.png)
...
The best mechanism for preventing identity thieves from creating new accounts in your name is to freeze your credit file with **[Equifax](https://www.equifax.com), [Experian](https://www.experian.com),** and [**TransUnion**](https://www.transunion.com). This process is now free for all Americans, and simply blocks potential creditors from viewing your credit file. Parents and guardians can now also freeze the credit files for their children or dependents.
...
All three bureaus allow users to place a freeze electronically after creating an account, but all of them try to steer consumers away from enacting a freeze. Instead, the bureaus are hoping consumers will opt for their confusingly named “credit lock” services, which accomplish the sa...