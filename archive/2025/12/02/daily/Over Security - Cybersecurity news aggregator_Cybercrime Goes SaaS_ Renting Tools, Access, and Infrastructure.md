---
title: Cybercrime Goes SaaS: Renting Tools, Access, and Infrastructure
url: https://www.bleepingcomputer.com/news/security/cybercrime-goes-saas-renting-tools-access-and-infrastructure/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-02
fetch_date: 2025-12-03T03:16:55.718803
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Fake Calendly invites spoof top brands to hijack ad manager accounts](data:image/gif;base64...)
  ...
  + [![University of Pennsylvania confirms new data breach after Oracle hack](data:image/gif;base64...)
  ...
  + [![Google fixes two Android zero days exploited in attacks, 107 flaws](data:image/gif;base64...)
  ...
  + [![ShadyPanda browser extensions amass 4.3M installs in malicious campaign](data:image/gif;base64...)
  ...
  + [![Korea arrests suspects selling intimate videos from hacked IP cameras](data:image/gif;base64...)
  ...
  + [![FTC settlement requires Illuminate to delete unnecessary student data](data:image/gif;base64...)
  ...
  + [![ChatGPT is down worldwide, conversations dissapeared for users](data:image/gif;base64...)
  ...
  + [![Your new command center for AI is $80 for lifetime access](data:image/gif;base64...)

    Your new command center for AI is $80 for lifetime access](https://www.bleepingcomputer.com/offer/deals/your-new-command-center-for-ai-is-80-for-lifetime-access/)
...
###### [Varonis](https://info.varonis.com/en/interceptor-demo?hsLang=en&utm_source=bleepingcomputer&utm_medium=referral&utm_campaign=bleepingcomputer_referral&utm_content=article)
...
These days, the cybercrime ecosystem functions more and more like a subscription-based technology sector. Similar to the "as-a-service" mo...