...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft June 2026 Patch Tuesday fixes 3 zero-day, 200 flaws](data:image/gif;base64...)
  ...
  + [![GitHub disables Microsoft repos pushing password-stealing malware](data:image/gif;base64...)
  ...
  + [![French govt messaging service breached in account hijacking attack](data:image/gif;base64...)
  ...
  + [![Google patches new Chrome zero-day flaw exploited in the wild](data:image/gif;base64...)
  ...
  + [![Anthropic rolls out Claude Fable 5, but it's available for a limited time](data:image/gif;base64...)
  ...
  + [![Microsoft Defender 'RoguePlanet' zero-day grants SYSTEM privileges](data:image/gif;base64...)
  ...
  + [![ServiceNow discloses security incident exposing customer data](data:image/gif;base64...)
  ...
  + [![OpenClaw AI agent found falling for phishing attacks, spills user data](data:image/gif;base64...)
...
###### [XBOW](https://xbow.com/contact?utm_source=post&utm_medium=MythosArticle&utm_campaign=BleepingComp)

* June 9, 2026
* 12:16 PM
* [0](#comment_form)

![XBOW](https://www.bleepstatic.com/content/posts/2026/06/09/xbow-centered.jpg)

*We received early access to Mythos Preview for early capability testing a few weeks back. In this article, we can finally share what we found.*

About three months ago, Anthropic invited us to help them assess the capability of a new model they thought represented a significant shift in capability. S...