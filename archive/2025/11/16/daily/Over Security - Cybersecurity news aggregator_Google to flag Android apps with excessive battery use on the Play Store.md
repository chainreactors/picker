---
title: Google to flag Android apps with excessive battery use on the Play Store
url: https://www.bleepingcomputer.com/news/security/google-to-flag-android-apps-with-excessive-battery-use-on-the-play-store/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-16
fetch_date: 2025-11-17T03:12:45.603672
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Logitech confirms data breach after Clop extortion attack](data:image/gif;base64...)
  ...
  + [![Fortinet confirms silent patch for FortiWeb zero-day exploited in attacks](data:image/gif;base64...)
  ...
  + [![Jaguar Land Rover cyberattack cost the company over $220 million](data:image/gif;base64...)
  ...
  + [![Decades-old ‘Finger’ protocol abused in ClickFix malware attacks](data:image/gif;base64...)
  ...
  + [![Google to flag Android apps with excessive battery use on the Play Store](data:image/gif;base64...)
  ...
  + [![Get started learning the CISSP security domains for just $30 through 11/20](data:image/gif;base64...)

    Get started learning the CISSP security domains for just $30 through 11/20](https://www.bleepingcomputer.com/offer/deals/get-started-learning-the-cissp-security-domains-for-just-30-through-11-20/)
  + [![Microsoft: Windows 10 KB5068781 ESU update may fail with 0x800f0922 errors](data:image/gif;base64...)
...
* [Deals](https://deals.bleepingcomputer.com/)
  ...
  + [![eLearning](data:image/gif;base64...)
    ...
    eLearning](https://deals.bleepingcomputer.com/deals/elearning?utm_source=b...