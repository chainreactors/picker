...
url: https://www.bleepingcomputer.com/news/security/spains-ministry-of-science-shuts-down-systems-after-breach-claims/
source: Over Security - Cybersecurity news aggregator
date: 2026-02-05
fetch_date: 2026-02-06T04:09:56.316744
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft rolls out native Sysmon monitoring in Windows 11](data:image/gif;base64...)
  ...
  + [![EDR killer tool uses signed kernel driver from forensic software](data:image/gif;base64...)
  ...
  + [![Coinbase confirms insider breach linked to leaked support tool screenshots](data:image/gif;base64...)
  ...
  + [![Spain's Ministry of Science shuts down systems after breach claims](data:image/gif;base64...)
  ...
  + [![Ransomware gang uses ISPsystem VMs for stealthy payload delivery](data:image/gif;base64...)
  ...
  + [![These open-box Sony noise-cancelling headphones are 33% off](data:image/gif;base64...)

    These open-box Sony noise-cancelling headphones are 33% off](https://www.bleepingcomputer.com/offer/deals/these-open-box-sony-noise-cancelling-headphones-are-33-percent-off/)
  + [![Microsoft to shut down Exchange Online EWS in April 2027](data:image/gif;base64...)
...
![Spain's Ministry of Science shuts down systems after breach claims](https://www.bleepstatic.com/content/hl-images/2026/02/05/Spain.jpg)

Spain's Ministry of Science (Ministerio de Ciencia) announced a partial shutdown of its IT systems, affecting several citizen- and company...