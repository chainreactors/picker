---
title: Feature Highlight: DLL Hollowing
url: https://www.vmray.com/feature-highlight-dll-hollowing/
source: VMRay
date: 2025-07-25
fetch_date: 2025-10-06T23:28:46.340156
---
...
As announced in a recent [blog post](https://www.vmray.com/release-highlights-vmray-platform-2025-2-0/), VMRay Platform has received a major upgrade to the dynamic analysis engine in our 2025.2 release. This aims to improve visibility and detection for code injection techniques like DLL Hollowing. With this adjustment, our Platform provides more granular monitoring and insights into relevant processes, injections, and memory regions when abused by malware.

In this blog post, we will have a closer look at this feature, using HijackLoader as an example as it heavily abuses DLL Hollowing. HijackLoader, also referred to as IDATLoader, GHOSTPULSE, or SHADOWLADDER, is a modular and evasive loader and often used to drop and execute different infostealers or remote access trojans (RAT) on the victim’s device (for example Lumma, Rhadamanthys, SectopRAT, AsyncRAT, Amadey, QuasarRAT, Tofsee, ...