---
title: Full spectrum Event Tracing for Windows detection in the kernel against rootkits
...
the attack hypotheses (based on a rootkit written by Lazarus), and my [Sanctum EDR](https://github.com/0xflux/Sanctum) project to supp...