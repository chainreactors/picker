---
title: Interesting project, not sure why the AI part is required on the task as normal pattern matching can do the trick but I need to check more
url: https://twitter.com/Dinosn/status/1589903716181647360
source: Twitter @Nicolas Krassas
date: 2022-11-09
fetch_date: 2025-10-03T22:03:55.598566
---

# Interesting project, not sure why the AI part is required on the task as normal pattern matching can do the trick but I need to check more
