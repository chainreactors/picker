---
title: Capture Bumble Bluetooth Traffic with Wireshark
url: https://insinuator.net/2026/02/capture-bumble-bluetooth-traffic-with-wireshark/
source: Insinuator.net
date: 2026-02-04
fetch_date: 2026-02-05T04:08:20.419495
---
...
[Back](https://insinuator.net/#post-15721)

[Misc](https://insinuator.net/category/misc/)

[February 4, 2026](https://insinuator.net/2026/02/capture-bumble-bluetooth-traffic-with-wireshark/) by [Frieder Steinmetz](https://insinuator.net/author/fsteinmetz/)

# Capture Bumble Bluetooth Traffic with Wireshark

[Frieder Steinmetz](https://insinuator.net/author/fsteinmetz/ "Frieder Steinmetz")

When conducting pentests of Bluetooth devices or whilst working on Bluetooth related research, we often use [Bumble](https://github.com/google/bumble). In this Blogpost I will present a solution to capture a live stream of Bumble Bluetooth traffic in Wireshark.
...
The logical move to improve this situation was to implement an HCI snoop clas...