---
title: Microsoft Teams to let users report messages wrongly flagged as threats
url: https://www.bleepingcomputer.com/news/microsoft/microsoft-teams-to-let-users-report-messages-wrongly-flagged-as-threats/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-18
fetch_date: 2025-11-19T03:14:22.502466
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft to integrate Sysmon directly into Windows 11, Server 2025](data:image/gif;base64...)
  ...
  + [![Cloudflare hit by outage affecting global network services](data:image/gif;base64...)
  ...
  + [![Fortinet warns of new FortiWeb zero-day exploited in attacks](data:image/gif;base64...)
  ...
  + [![Windows 11 gets new Cloud Rebuild, Point-in-Time Restore tools](data:image/gif;base64...)
  ...
  + [![Thunderbird adds native support for Microsoft Exchange accounts](data:image/gif;base64...)
  ...
  + [![New ShadowRay attacks convert Ray clusters into crypto miners](data:image/gif;base64...)
  ...
  + [![Windows 11 gets new Cloud Rebuild, Point-in-Time Restore tools](data:image/gif;base64...)
    ...
    Windows 11 gets new Cloud Rebuild, Point-in-Time Restore tools](https://www.bleepingcomputer.com/news/microsoft/windows-11-gets-new-cloud-rebuild-point-in-time-restore-tools/)
  + [![All your PDF tasks handled in this $42 lifetime app deal](data:image/gif;base64...)

    All your PDF tasks handled in this $42 lifetime app deal](https://www.bleepingcomputer.com/offer/deals/all-your-pdf-tasks-handled-in-this-42-lifetime-app-deal/)
...
* [Deals](https://deals.bleepingcomputer.com/)
  ...
  + [![IT Certification Courses](data:image/gif;base64...)
    ...
    IT Certification Courses](https://deals.bleepingc...