---
title: Memory Decompression & Pagefiles
url: https://blog.cerbero.io/memory-decompression-pagefiles/
source: Cerbero Blog
date: 2025-04-29
fetch_date: 2025-10-06T22:04:45.022504
---
...
We are excited to announce the release of version 0.2 of our [Memory Analysis package](https://cerbero.io/packages/memoryanalysis/), currently in beta, which adds support for memory decompression and reading paged-out memory from pagefiles.
...
![](/wp-content/uploads/2025/04/paging/1.png)
...
![](/wp-content/uploads/2025/04/paging/0.png)

Credit for the [original research](https://i.blackhat.com/USA-19/Thursday/us-19-Sardar-Paging-All-Windows-Geeks-Finding-Evil-In-Windows-10-Compressed-Memory-wp.pdf) on the undocumented Windows 10 memory compression mechanism goes to the team at FireEye (now Mandiant).
...
![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [April 28, 2025](https://blog.cerbero.io/memory-decompression-pagefiles/)Categories [Forensics](https://blog.cerbero.io/category/forensics/), [Package](https://blog.cerbero.io/category/package/), [Security](https://blog.cerbero.io/category/security/)Tags [Dump](https://blog.cerbero.io/tag/dump/), [Forensics](https://blog.cerbero.io/tag/forensics/), [Memory](https://blog.cerbero.io/tag/memory/), [Snapshot](https://blog.cerbero.io/tag/snapshot/), [windows](https://blog.cerbero.io/tag/windows/)

## Leave a Reply [Cancel reply](/memory-decompression-pagefiles/#respond)
...
[Previous Previous post: Cerbero Suite 8.3](https://blog.cerbero.io/cerbero-suite-8-3/)

[Next Next post: ISO Format 2.0 Package](https://blog.cerbero.io/iso-format-2-0-package/)
