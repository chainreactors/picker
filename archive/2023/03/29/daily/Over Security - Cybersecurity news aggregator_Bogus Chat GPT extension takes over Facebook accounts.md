---
title: Bogus Chat GPT extension takes over Facebook accounts
url: https://www.malwarebytes.com/blog/news/2023/03/bogus-chat-gpt-extension-takes-over-facebook-accounts
source: Over Security - Cybersecurity news aggregator
date: 2023-03-29
fetch_date: 2025-10-04T11:03:02.798970
---
...
![People wearing stuff toy heads](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/03/asset_upload_file8671_262570.png?w=736)
...
If you’re particularly intrigued by the current wave of interest in [AI](https://www.malwarebytes.com/what-was-the-mirai-botnet), take care. There’s some bad things lurking in search engine results [waiting to compromise your Facebook account](https://labs.guard.io/fakegpt-2-open-source-turned-malicious-in-another-variant-of-the-facebook-account-stealer-d00ef9883d61).

A rogue Chrome extension deployed in a campaign targeting Facebook users is “hitting thousands a day” according to researchers who made this discovery. The scam is based around Chat GPT-4. This is the latest iteration of what is essentially a [supposedly very smart AI chatbot](https://www.makeuseof.com/how-to-use-gpt4/). As per the link, in addition to holding conversations with a user, it can also in theory “create” forms of content like works of fiction.
...
However, the *real* aim of the game here is to compromise Facebook accounts. When the extension fires up, it tries to engage in a spot of cookie theft. If a [malware](https://www.malwarebytes.com/malware) author is able to steal your [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication) cookie from your browser during a session, they can try and log in to the website they stole the cookie for.

Here, the extension filters for Facebook [cookies](https://www.malwarebytes.com/cybersecurity/computer/what-are-tracking-cookies) specifically before sending the stolen cookie(s) on to the extension author’s server. Before sending the stolen cookies, they are encrypted as a way to try and discreetly get them off the target system. The act of encryption tries to ensure certain types of security tools fail to notice that something is amiss.

Once the extension authors have control of the Facebook account, they change the login details, profile image and name before posting whatever they need to in order to make their campaign a success. Examples given by the researchers include ISIS propaganda photographs and more generic allusions to [spam](https://www.malwarebytes.com/spam) and bogus services.

At time of writing, both the adverts and ...