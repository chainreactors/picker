---
title: Identity thieves bypass security questions to access Experian credit reports
url: https://www.malwarebytes.com/blog/news/2023/01/identity-thieves-bypass-security-questions-to-access-experian-credit-reports
source: Over Security - Cybersecurity news aggregator
date: 2023-01-13
fetch_date: 2025-10-04T03:49:23.171615
---
...
![credit score form](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/01/asset_upload_file32428_253981.png?w=736)
...
After a tip from a Telegram user who frequented [identity theft](https://www.malwarebytes.com/identity-theft) channels, [Brian Krebs tested and confirmed](https://krebsonsecurity.com/2023/01/identity-thieves-bypassed-experian-security-to-view-credit-reports/) that anyone who knew your name, address, social security number ([SSN](https://www.malwarebytes.com/cybersecurity/basics/ssn-on-dark-web)), and birthday could view your full credit report at Experian.

## Skipping security questions

The method to get access did not require any [hacking](https://www.malwarebytes.com/cybersecurity/basics/hacker) talents at all. It was a simple matter of replacing a part of the URL, which then allowed anyone with bad intentions to skip security questions.
...
This is not the first time Experian has shown that its methods of keeping your information secure are below all reasonable expectations. Only half a year ago, Brian Krebs also [reported](https://krebsonsecurity.com/2022/07/experian-you-have-some-explaining-to-do/) how identity thieves were able to hijack accounts. They did this by signing up for new accounts at Experian, while using the victim’s [personal information](https://www.malwarebytes.com/cybersecurity/basics/pii) but with a different email address.

[Data breaches](https://www.malwarebytes.com/cybersecurity/basics/data-breach) happen, but that doesn’t mean that credit bureaus shouldn’t be held to a higher standard when it comes to protecting such personal information.

## Fixed now

Even though this method of accessing credit reports no longer works, it is unclear how long it did work and how often it’s been used. It’s also been pointed out at length that the “security questions” themselves are not a substantial obstacle in the way of a determined identity thief that wants to [exploit](https://www.malwarebytes.com/exploits) your credit score. Most answers can be found in public records or on social media.
