---
title: ICS-TestBed-Framework
url: https://kitploit.com/en/tools/github/pmaynard/ics-testbed-framework
source: Kitploit
date: 2026-08-24
fetch_date: 2026-08-25T02:59:20.059993
---
...
ICS-TestBed-Framework — Deploys realistic virtual SCADA/ICS testbeds with IEC 60870-5-104 and OPC-UA nodes, enabling attack simulations, legitimate packet generation, and red-team security exercises. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/pmaynard/ics-testbed-framework

![](https://assets.kitploit.com/production/public/tools/50865/cdba70a8c074bec1cc5e0f888b84b28f8066f97e312af5646d796710d9fcafbc-display-v1.webp)

[Packet Sniffing & Analysis](/en/categories/packet-sniffing-analysis)[SCADA/ICS Security](/en/categories/scada-ics-security)[Network Security](/en/categories/network-security)[Penetration Testing](/en/categories/penetration-testing)[Red Teaming](/en/categories/red-teaming)[Labs & Practice](/en/categories/labs-practice)[Top in SCADA/ICS Security #7](/en/categories/scada-ics-security)

![GitHub](/providers/github.png)pmaynard/ics-testbed-framework

# ICS-TestBed-Framework

Deploys realistic virtual SCADA/ICS testbeds with IEC 60870-5-104 and OPC-UA nodes, enabling attack simulations, legitimate packet generation, and red-team security exercises.

[View Repository](https://github.com/pmaynard/ics-testbed-framework)

70267 years ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
[![asciicast](https://assets.kitploit.com/production/public/readmes/50865/9ea9eabfa4f0e3775a4a2bdb6fc9e12f007a88579c2b6a7a3a2815e54502a8b1/a801a89cbe24fb2e22989029ba224067ff7aae79c64420982860fac74eb42dba-display-v1.webp)](https://asciinema.org/a/clpPltx8oGGQBxCKsz0FzIfqg)
...
This is an optional development step. It builds a virtual machine image, pre-configured to run the testbed nodes. If you don't want to create the latest version, ...