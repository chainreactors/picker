---
title: Riot Games compromised, new releases and patches halted
url: https://www.malwarebytes.com/blog/news/2023/01/riot-games-reveals-compromise-of-development-environment
source: Over Security - Cybersecurity news aggregator
date: 2023-01-26
fetch_date: 2025-10-04T04:54:37.452471
---
...
![gamer at an event](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/01/asset_upload_file62418_255736.jpg?w=736)
...
Popular game developer Riot Games brings word of a [system compromise which may cause issues for updates to well known titles](https://www.bleepingcomputer.com/news/security/riot-games-hacked-delays-game-patches-after-security-breach/), although for the time being it seems as though customer data isn’t affected.

## A social engineering development

Making the [notification via Twitter late last week](https://twitter.com/riotgames/status/1616548651823935488), we’re still waiting on the full story as an investigation takes place. For now Riot, stewards of titles such as Valorant and League of Legends, made the following statement in relation to the attack:
...
League of Legends, for example, has a [regular patching cycle](https://www.leagueoflegends.com/en-us/news/tags/patch-notes/) and some of those patches are very large indeed, as you’d expect for an online game. The League of Legends Twitter account has [already warned of potential impact](https://twitter.com/LeagueOfLegends/status/1616548964861612033). Valorant operates in [much the same way](https://playvalorant.com/en-us/news/game-updates/). We can expect similar across all titles as resources are used up to ensure the compromise has been fully contained and addressed.

## The game developer jackpot

Games companies have been major targets for compromise for years, which is only to be expected considering the huge amount of data these organisations have access to. There are so many areas for exploitation, from game platform logins to publisher-centric accounts. You can target a PC running a game with remote code execution, go [phishing](https://www.malwarebytes.com/phishing) for two-factor [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication) codes, steal an account and sell digital items from its inventory…the list is endless.

The only good thing here is the low probability of customer data having been grabbed, with the attack instead focusing on the development environment for reasons known only to the attacker. There have been many incidents where attackers poking around behind the scenes have been in an effort to [upload or release rogue files via game titles themselves](https://www.malwarebytes.com/blog/news/2016/02/dayz-in-a-daze-forum-breach-confirmed).
...
### Update, January 24, 9:03AM (GMT-8)

Riot Games updated its Twitter followers regarding the compromise. It confirmed attackers were able to steal code for some its flagship games, League of Legends and Teamfight Tactics (TFT), a...