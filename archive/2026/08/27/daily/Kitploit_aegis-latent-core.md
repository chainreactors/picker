...
url: https://kitploit.com/en/tools/github/juanlunaia/aegis-latent-core
source: Kitploit
date: 2026-08-27
fetch_date: 2026-08-28T13:36:45.525619
---
...
[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/juanlunaia/aegis-latent-core

![](https://assets.kitploit.com/production/public/tools/52859/2ffcf8e7740fcdd9e14b5dc1727a1adcdd1b2879a683a119952e7cc750ffff6f-display-v1.webp)

[Cryptography](/en/categories/cryptography)[Cloud Security](/en/categories/cloud-security)[Threat Intelligence](/en/categories/threat-intelligence)[API Security](/en/categories/api-security)[AI Security](/en/categories/ai-security)[Log Analysis](/en/categories/log-analysis)

![GitHub](/providers/github.png)juanlunaia/aegis-latent-core
...
[View Repository](https://github.com/juanlunaia/aegis-latent-core)[Website](https://github.com/JuanLunaIA/aegis-latent-core#readme)

144263 days ago![Not yet reviewed](/_next/image?url=%2Fbadges%2Fkitploit_badge_not_reviewed_full.png&w=48&q=75)
...
[![GitHub Release](https://img.shields.io/github/v/release/JuanLunaIA/aegis-latent-core?sort=semver&color=2563eb&label=Release&logo=github)](https://github.com/JuanLunaIA/aegis-latent-core/releases)
[![PyPI Package](https://img.shields.io/pypi/v/aegis-latent-sdk?color=3b82f6&label=PyPI%20SDK&logo=pypi&logoColor=white)](https://pypi.org/project/aegis-latent-sdk/)
[![npm Package](https://img.shields.io/npm/v/aegis-latent-sdk?color=ef4444&label=npm%20SDK&logo=npm&logoColor=white)](https://www.npmjs.com/package/aegis-latent-sdk)
[![License](https://img.shields.io/badge/License-AGPLv3%20+%20Commercial-blue.svg)](LICENSE)

![CI Status](https://img.shields.io/github/actions/workflow/status/JuanLunaIA/aegis-latent-core/ci.yml?branch=main&label=CI&logo=githubactions&logoColor=white)

[![Security Status](https://img.shields.io/github/actions/workflow/status/JuanLunaIA/aegis-latent-core/security.yml?branch=main&label=Security&logo=githubactions&logoColor=white)](https://github.com/JuanLunaIA/aegis-latent-core/actions/workflows/security.yml)

![Tests Passed](https://img.shields.io/badge/Tests-5,700+%20Passed-10b981?logo=pytest&logoColor=white)

![Code Coverage](https://img.shields.io/badge/Coverage-89.7%25-10b981?logo=codecov&logoColor=white)

![Python Versions](https://img.shields.io/badge/Python-3.11%20%7C%203.12%20%7C%203.13-3776ab?logo=python&logoColor=white)
![TypeScript](https://img.shields.io/badge/TypeScript-%3E=5.0-3178c6?logo=typescript&logoColor=white)
![Rust Native Engine](https://img.shields.io/badge/Rust-Native%20Engine-black?logo=rust&logoColor=white)
![Formal Verification](https://img.shields.io/badge/Formal%20Methods-Z3%20%7C%20Lean%204%20%7C%20TLA+-7c3aed)
![Supply Chain Security](https://img.shields.io/badge/Supply%20Chain-Cosign%20%7C%20SPDX%202.3-0ea5e9?logo=sigstore&logoColor=white)
...
sequenceDiagram
    ...
    A-->>C: Non-stream response + portable MMR proof header...