...
url: https://go.theregister.com/feed/www.theregister.com/2022/12/06/cobalt_strike_memory_unit_42/
source: The Register - Security
date: 2022-12-07
fetch_date: 2025-10-04T00:49:29.996211
---
...
Cobalt Strike is possibly the best-known example of legitimate commercial security software – it was designed to help red teams test their organizations' cyber defenses – that has been co-opted by threat groups that use it to get around those defenses. The Nighthawk command-and-control framework [could become](https://www.theregister.com/2022/11/25/infosec_roundup/) another example of abused legit infosec software.

The commercial Cobalt Strike toolkit is only sold to vetted customers who use it to run security tests, but source code leaks led to threat groups – from ransomware gangs to nation-state attackers – using it to gain initial entrance into targeted networks. Unit 42's researchers note it was used in the high-profile attack on [SolarWinds](https://www.theregister.com/2022/11/04/solarwinds_settlement_sec_enforcement/) in 2020.
...