---
title: geiger
url: https://kitploit.com/en/tools/github/atomburstofficial/geiger
source: Kitploit
date: 2026-09-10
fetch_date: 2026-09-11T06:51:41.657381
---
...
geiger — Read-only CLI that inventories AI agents, MCP servers, plugins, and extensions on a machine, reporting their capabilities and exposure with plain-language remediation. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/atomburstofficial/geiger

![](https://assets.kitploit.com/production/public/tools/54675/b8481b721f4ce79fbb0212ed8d9f48a5f4e1853224b05da500d09173e849279a-display-v1.webp)

[Configuration Auditing](/en/categories/configuration-auditing)[Cloud Security](/en/categories/cloud-security)[DevSecOps](/en/categories/devsecops)[Threat Intelligence](/en/categories/threat-intelligence)[AI Security](/en/categories/ai-security)

![GitHub](/providers/github.png)atomburstofficial/geiger
...
[View Repository](https://github.com/atomburstofficial/geiger)

191411 day ago![Not yet reviewed](/_next/image?url=%2Fbadges%2Fkitploit_badge_not_reviewed_full.png&w=48&q=75)
...
![A geiger scan: findings grouped by ecosystem with exposure labels, a redacted credential, and plain-language fixes](https://raw.githubusercontent.com/atomburstofficial/geiger/main/docs/scan-terminal.svg)
...
[sample HTML report](https://github.com/atomburstofficial/geiger/blob/main/docs/sample-report.html) and a
[sample JSON output](https://github.com/atomburstofficial/geiger/blob/main/docs/sample-report.json) live in this repo, generated
from the test fixture — synthetic data, generic paths, credentials shown by
shape only (as always). The HTML report:

![The HTML report: summary tiles, exposure chips, credential shapes, and "What to do" remediation blocks](https://assets.kitploit.com/production/public/readmes/54675/b8481b721f4ce79fbb0212ed8d9f48a5f4e1853224b05da500d09173e849279a/abb48c021200c7d0ba68bcf5f157aabff5086...