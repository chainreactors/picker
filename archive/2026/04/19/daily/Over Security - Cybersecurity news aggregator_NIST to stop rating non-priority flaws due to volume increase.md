...
date: 2026-04-19
fetch_date: 2026-04-20T04:56:14.628196
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Payouts King ransomware uses QEMU VMs to bypass endpoint security](data:image/gif;base64...)
  ...
  + [![Apple account change alerts abused to send phishing emails](data:image/gif;base64...)
  ...
  + [![NIST to stop rating non-priority flaws due to volume increase](data:image/gif;base64...)
  ...
  + [![Vercel confirms breach as hackers claim to be selling stolen data](data:image/gif;base64...)
  ...
  + [![NIST to stop rating non-priority flaws due to volume increase](data:image/gif;base64...)
    ...
    NIST to stop rating non-priority flaws due to volume increase](https://www.bleepingcomputer.com/news/security/nist-to-stop-rating-non-priority-flaws-due-to-volume-increase/)
  + [![Edit, convert, and sign PDFs fast with this $40 lifetime tool](data:image/gif;base64...)

    Edit, convert, and sign PDFs fast with this $40 lifetime tool](https://www.bleepingcomputer.com/offer/deals/edit-convert-and-sign-pdfs-fast-with-this-40-lifetime-tool/)
...
![NIST to stop rating non-priority flaws due to volume increase](https://www.bleepstatic.com/content/hl-images/2026/04/17/NIST.jpg)

The National Institute of Standards and Technology will stop assigning severity scores to lower-priority vulne...