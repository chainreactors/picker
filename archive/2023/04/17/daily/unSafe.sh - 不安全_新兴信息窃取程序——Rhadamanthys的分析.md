...
url: https://buaq.net/go-158865.html
source: unSafe.sh - 不安全
date: 2023-04-17
fetch_date: 2025-10-04T11:31:42.706705
---
...
![](https://8aqnet.cdn.bcebos.com/c4e5f1e97982bf60a71d68dfc7983845.jpg)

新兴信息窃取程序——Rhadamanthys的分析

Rhadamanthys是一款很高级的信息窃取程序，于去年9月在暗网上首次亮相，亮相之初即受到了攻击者的热捧。2022年9月24日，
*2023-4-16 12:0:0
Author: [www.4hou.com(查看原文)](/jump-158865.htm)
阅读量:37
收藏*
...
即使解决了API调用，数据库仍然非常大，包含超过2500个函数。其中许多是来自第三方库的库函数，如sqlite3和lua\_cjson，这带来了另一个麻烦，因为解析这些函数需要我们编译这些库的注释版本，然后执行bindiff（或类似的操作）来标记Rhadamanthys使用的函数。这是一个出了名的挑选过程，许多标签在手动验证之前并没有太大用处。
...
![16.1.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20230407/1680840206522210.png "1680840206522210.png")

![16.2.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20230407/1680840224164356.png "1680840224164356.png")
...
![17.1.png](https://img.4hou.com/uploads/ueditor/php/upload/image/2023...