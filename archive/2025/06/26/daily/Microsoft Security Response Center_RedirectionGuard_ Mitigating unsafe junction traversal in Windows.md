...
url: https://msrc.microsoft.com/blog/2025/06/redirectionguard-mitigating-unsafe-junction-traversal-in-windows/
source: Microsoft Security Response Center
date: 2025-06-26
fetch_date: 2025-10-06T22:53:36.512560
---

# RedirectionGuard: Mitigating unsafe junction traversal in Windows

This is the Trace Id: 3648d1262cf56591df1eff42c79126b2
...
Problems arise when privileged local Windows services access file paths containing redirection without realizing it. For example, a service may use a temporary folder, `C:\MyService`, where it stores some data in a file. Once finished, the service deletes everything in `C:\MyService` with SYSTEM level p...