...
date: 2026-02-24
fetch_date: 2026-02-25T04:14:52.290908
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CarGurus data breach exposes information of 12.4 million accounts](data:image/gif;base64...)
  ...
  + [![North Korean Lazarus group linked to Medusa ransomware attacks](data:image/gif;base64...)
  ...
  + [![Android mental health apps with 14.7M installs filled with security flaws](data:image/gif;base64...)
  ...
  + [![CISA: Recently patched RoundCube flaws now exploited in attacks](data:image/gif;base64...)
  ...
  + [![Phishing campaign targets freight and logistics orgs in the US, Europe](data:image/gif;base64...)
  ...
  + [![Wynn Resorts confirms employee data breach after extortion threat](data:image/gif;base64...)
  ...
  + [![1Campaign platform helps malicious Google ads evade detection](data:image/gif;base64...)
  ...
  + [![This $139 refurbished portable monitor is now under $60](data:image/gif;base64...)

    This $139 refurbished portable monitor is now under $60](https://www.bleepingcomputer.com/offer/deals/this-139-refurbished-portable-monitor-is-now-under-60/)
...
![1Campaign platform helps malicious Google ads evade detection](https://www.bleepstatic.com/content/hl-images/2025/01/15/Google-Ads.jpg)

A newly identified cybercrime service known as 1Campaign is enabling threat actors to run malicious Google Ads that re...