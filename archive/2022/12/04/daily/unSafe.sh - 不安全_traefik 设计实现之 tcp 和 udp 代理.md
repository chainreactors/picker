---
title: traefik 设计实现之 tcp 和 udp 代理
url: https://buaq.net/go-138418.html
source: unSafe.sh - 不安全
date: 2022-12-04
fetch_date: 2025-10-04T00:28:17.937402
---
...
序traefik 处理 http 的代理外，还支持 tcp, udp 的代理转发. 这里通过 traefik 来分析下 tcp 和 udp 代理的设计实现.TCP
*2022-12-3 21:7:16
Author: [xiaorui.cc(查看原文)](/jump-138418.htm)
阅读量:30
收藏*
...
traefik 处理 http 的代理外，还支持 tcp, udp 的代理转发. 这里通过 traefik 来分析下 tcp 和 udp 代理的设计实现.
