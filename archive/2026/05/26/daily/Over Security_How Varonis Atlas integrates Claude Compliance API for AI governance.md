...
date: 2026-05-26
fetch_date: 2026-05-27T06:12:22.646657
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Ghost CMS SQL injection flaw exploited in large-scale ClickFix campaign](data:image/gif;base64...)
  ...
  + [![Laravel Lang packages hijacked to deploy credential-stealing malware](data:image/gif;base64...)
  ...
  + [![Netherlands seizes 800 servers of hosting firm enabling cyberattacks](data:image/gif;base64...)
  ...
  + [![Ubiquiti patches three max severity UniFi OS vulnerabilities](data:image/gif;base64...)
  ...
  + [![KnowledgeDeliver flaw exploited as a zero-day to install web shells](data:image/gif;base64...)
  ...
  + [![Charter confirms data breach after ShinyHunters extortion threat](data:image/gif;base64...)
  ...
  + [![Nine ethical hacking & penetration testing courses for $30](data:image/gif;base64...)

    Nine ethical hacking & penetration testing courses for $30](https://www.bleepingcomputer.com/offer/deals/nine-ethical-hacking-and-penetration-testing-courses-for-30/)
  + [![How Varonis Atlas integrates Claude Compliance API for AI governance](data:image/gif;base64...)
...
###### [Varonis](https://hubs.ly/Q047jyLP0)

* May 26, 2026
* 10:01 AM
* [0](#comment_form)

![Varonis Atlas + Claude](https://www.bleepstatic.com/content/posts/2026/05/22/varonis-atlas-claude.jpg)

Varonis announced an integration with the Claude Compliance API, bringing Claude Enterprise and Claude Platform activity into [Varonis' Atlas AI Security Platform](https://www.varonis.com/platform/ai-security?hsLang=en).

Organizations across industries rely on Claude Enterprise for day-to-day knowledge work and analysis, and Claude Platform...