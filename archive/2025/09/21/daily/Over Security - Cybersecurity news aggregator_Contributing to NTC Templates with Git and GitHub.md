---
title: Contributing to NTC Templates with Git and GitHub
url: https://www.adainese.it/blog/2024/09/25/contributing-to-ntc-templates-with-git-and-github/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-21
fetch_date: 2025-10-02T20:29:20.032566
---
...
Let’s finally see how to contribute to an open-source project. We’ll use the NTC-Templates project as a practical example, for which I have already developed
[46 patches](https://github.com/networktocode/ntc-templates/pulls?q=is%3Apr+author%3Adainok+is%3Amerged)
.

Let’s assume we’ve already made the necessary changes, and now we want to propose them for official inclusion in the
...
 via the web and clone the repository locally:
...
Continue reading
[the post on Patreon](https://www.patreon.com/posts/contributing-to-112037177)
.
