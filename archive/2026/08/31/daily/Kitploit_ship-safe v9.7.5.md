---
title: ship-safe v9.7.5
url: https://kitploit.com/en/posts/github-asamassekou10-ship-safe-v975
source: Kitploit
date: 2026-08-31
fetch_date: 2026-09-01T06:59:46.237007
---
...
![](https://assets.kitploit.com/production/public/tools/49363/31125a0161ee16c772304e3097cdea464c8988cdc8e818ebf8356506fa1f1314.gif)
...
![Ship Safe Logo](https://assets.kitploit.com/production/public/readmes/49363/b1f8834990a38d393bed6703c926c2f633c9d6afc19261eb02c67e9d45b7f350.png)

**Find risky code, AI-agent vulnerabilities, and supply-chain issues before they ship.**

[Website](https://shipsafe.sh) · [Docs](https://shipsafe.sh/docs) · [Security & Data Flow](https://shipsafe.sh/security) · [Benchmark](https://shipsafe.sh/benchmarks) · [Pricing](https://shipsafe.sh/pricing) · [Blog](https://shipsafe.sh/blog) · [Contribute](https://github.com/asamassekou10/ship-safe/contribute)

[![npm version](https://badge.fury.io/js/ship-safe.svg)](https://www.npmjs.com/package/ship-safe)
[![npm downloads](https://img.shields.io/npm/dm/ship-safe.svg)](https://www.npmjs.com/package/ship-safe)
[![CI](https://github.com/asamassekou10/ship-safe/actions/workflows/ci.yml/badge.svg)](https://github.com/asamassekou10/ship-safe/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/asamassekou10/ship-safe?style=social)](https://github.com/asamassekou10/ship-safe/stargazers)
[![Sponsor](https://img.shields.io/badge/Sponsor-%E2%9D%A4-ea4aaa?logo=github)](https://github.com/sponsors/asamassekou10)
...
![Ship Safe REPL demo](https://assets.kitploit.com/production/public/readmes/49363/75988a5baca705edcd06c5d39049d35be36f660fad2362de6700cf40eb72d2dd.gif)
...
![Ship Safe agent demo](https://assets.kitploit.com/production/public/readmes/49363/31125a0161ee16c772304e3097cdea464c8988cdc8e818ebf8356506fa1f1314.gif)
...
Ship Safe Cloud, the hosted dashboard for scan history, PR Guardian, billing, and team workflows, is developed in a private repository because it contains commercial product code and hosted infrastructure workflows. The public `ship-safe` repo remains focused on the MIT-licensed CLI, security agents, rules, fixtures, CI integrations, and documentation. See [Ship Safe Cloud](https://github.com/asamassekou10/ship-safe/blob/HEAD/docs/cloud.md) for the repo boundary.
...
| **SupabaseRLSAgent** | Auth | service\_role key in client code, tables without RLS, anon key inserts |
