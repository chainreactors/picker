---
title: Cyber spionaggio, anche il Wi-Fi potrebbe svelare tanto di noi: ecco come
url: https://www.cybersecurity360.it/nuove-minacce/cyber-spionaggio-anche-il-wi-fi-potrebbe-svelare-tanto-di-noi-ecco-come/
source: Over Security - Cybersecurity news aggregator
date: 2023-03-03
fetch_date: 2025-10-04T08:35:35.590114
---
...
Il Wi-Fi potrebbe favorire il controllo delle persone e attività di spionaggio: è quanto dimostrato da uno studio dell’Università di Pittsburgh, negli USA. Vediamo come con questa tecnologia si possa arrivare a captare informazioni e quali di queste riesce a fornire

Pubblicato il 02 Mar 2023

[Marco Santarelli](https://www.cybersecurity360.it/giornalista/marco-santarelli/)
...
![Cyber spionaggio, anche il Wi-Fi potrebbe svelare tanto di noi: ecco come](data:image/png;base64...)![Cyber spionaggio, anche il Wi-Fi potrebbe svelare tanto di noi: ecco come](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2023/03/Wi-Fi-strumento-di-spionaggio.jpg)

Si parla spesso del **controllo dei nostri dati e dei nostri gusti** da parte di social network, [ultimo tra tutti sotto accusa TikTok](https://www.cybersecurity360.it/news/tiktok-non-e-sicura-lue-chiede-ai-suoi-dipendenti-di-non-usarla-e-disinstallarla-le-motivazioni/), e da parte di tutti i dispositivi che ci circondano e caratterizzano le azioni del nostro quotidiano, ma a quanto pare potrebbe aggiungersi alla lunga lista anche un’insospettabile tecnologia, forse mai tirata in ballo: il **Wi-Fi**.
...
* [Una nuova potenzialità del Wi-Fi](#Una_nuova_potenzialita_del_Wi-Fi)
* [Wi-Fi e cyber spionaggio: esperimenti e risultati](#Wi-Fi_e_cyber_spionaggio_esperimenti_e_risultati)
* [L’ecolocalizzazione e lo studio dei pipistrelli](#Lecolocalizzazione_e_lo_studio_dei_pipistrelli)
* [Wi-Fi come strumento di spionaggio?](#Wi-Fi_come_strumento_di_spionaggio)
...
Attraverso la loro ricerca, che hanno [pubblicato](https://arxiv.org/pdf/2301.00250.pdf) con il titolo “DensePose from Wi-Fi”, sono giunti alla conclusione che è possibile farlo, dato che i segnali Wi-Fi, così come tutte le onde radio, quando incontrano oggetti e persone, subiscono leggere variazioni e forniscono informazioni su forma e movimento degli stessi.
...
Altra applicazione degna di nota risale al 2016 quando, grazie a Dina Katabi, Mingmin Zhao e Fadel Adib del C...