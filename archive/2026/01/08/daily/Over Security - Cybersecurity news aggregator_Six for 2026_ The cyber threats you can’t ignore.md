---
title: Six for 2026: The cyber threats you can’t ignore
url: https://www.bleepingcomputer.com/news/security/six-for-2026-the-cyber-threats-you-cant-ignore/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-08
fetch_date: 2026-01-09T03:31:45.999763
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Logitech Options+, G HUB macOS apps break after certificate expires](data:image/gif;base64...)
  ...
  + [![Max severity Ni8mare flaw lets hackers hijack n8n servers](data:image/gif;base64...)
  ...
  + [![Kimwolf Android botnet abuses residential proxies to infect internal devices](data:image/gif;base64...)
  ...
  + [![Cloud file-sharing sites targeted for corporate data theft attacks](data:image/gif;base64...)
  ...
  + [![Gmail's new AI Inbox uses Gemini, but Google says it won’t train AI on user emails](data:image/gif;base64...)
  ...
  + [![New China-linked hackers breach telcos using edge device exploits](data:image/gif;base64...)
  ...
  + [![FBI warns about Kimsuky hackers using QR codes to phish U.S. orgs](data:image/gif;base64...)
  ...
  + [![xAI teases major Grok upgrade, hints at Grok Code CLI](data:image/gif;base64...)
...
###### [Corelight](https://corelight.com/contact?utm_source=bleepingcomputer&utm_medium=article-3&utm_campaign=awareness-wave-2)

* January 8, 2026
* 10:02 AM
* [0](#comment_form)

![Hacker in the New Year](https://www.bleepstatic.com/content/posts/2026/01/07/corelight-hacker-new-year.jpg)

As we kick off 2026, cybersecurity is undergoing rapid transformation. In just the past year, we’ve seen a surge in attacks driven by advances in AI, automation, and the subsequent increased sophistication of social engineering techniques. This year promises...