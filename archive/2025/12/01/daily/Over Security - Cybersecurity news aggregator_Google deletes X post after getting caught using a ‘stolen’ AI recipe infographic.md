---
title: Google deletes X post after getting caught using a ‘stolen’ AI recipe infographic
url: https://www.bleepingcomputer.com/news/artificial-intelligence/google-deletes-x-post-after-getting-caught-using-a-stolen-ai-recipe-infographic/
source: Over Security - Cybersecurity news aggregator
date: 2025-12-01
fetch_date: 2025-12-02T03:18:53.734986
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![GreyNoise launches free scanner to check if you're part of a botnet](data:image/gif;base64...)
  ...
  + [![The Cyber Monday 2025 Cybersecurity, IT, VPN, & Antivirus Deals](data:image/gif;base64...)

    The Cyber Monday 2025 Cybersecurity, IT, VPN, & Antivirus Deals](https://www.bleepingcomputer.com/news/security/the-cyber-monday-2025-cybersecurity-it-vpn-and-antivirus-deals/)
  + [![Microsoft to secure Entra ID sign-ins from script injection attacks](data:image/gif;base64...)
  ...
  + [![New ShadowV2 botnet malware used AWS outage as a test opportunity](data:image/gif;base64...)
  ...
  + [![Be a global communicator with with all 14 Babbel languages in this deal](data:image/gif;base64...)

    Be a global communicator with with all 14 Babbel languages in this deal](https://www.bleepingcomputer.com/offer/deals/be-a-global-communicator-with-with-all-14-babbel-languages-in-this-deal/)
  + [![Glassworm malware returns in third wave of malicious VS Code packages](data:image/gif;base64...)
  ...
  + [![SmartTube YouTube app for Android TV breached to push malicious update](data:image/gif;base64...)
  ...
  + [![Microsoft says new Outlook can't open some Excel attachments](data:image/gif;base64...)
...
* [Deals](https://deals.bleepingcomputer.com/)
  ...
  + [![eLearning](data:image/gif;base64...)
    ...
    eLearning](https://deals.bleepingcomputer.com/deals/elearning?utm_source=bleepingcomputer....