---
title: Microsoft's Patch Tuesday baker's dozen: 12 critical bugs plus a SharePoint RCE
url: https://go.theregister.com/feed/www.theregister.com/2025/08/12/august_patch_tuesday/
source: The Register - Security
date: 2025-08-13
fetch_date: 2025-10-07T00:49:57.715875
---
...
The good news is that Microsoft says none of the [August security holes](https://msrc.microsoft.com/update-guide/releaseNote/2025-Aug) are under active exploitation. But before you put your feet up and relax, or pop some champagne, remember that the software giant said [July's patches](https://www.theregister.com/2025/07/08/microsoft_patch_tuesday/) didn't address any active exploits…and we all know how that turned out (cough) [SharePoint](https://www.theregister.com/2025/07/26/microsoft_sharepoint_attacks_leak/) (cough).

Let's start with the known bug, an elevation of privilege flaw in Windows Kerberos network authentication protocol. It's tracked as [CVE-2025-53779](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-53779). Microsoft rates it 7.2 on the ten-point CVSS scale, and the software giant deems "exploitation less likely," probably because to abuse this vulnerability an attacker would first need to be authenticated with explicit permissions to the delegated Managed Service A...