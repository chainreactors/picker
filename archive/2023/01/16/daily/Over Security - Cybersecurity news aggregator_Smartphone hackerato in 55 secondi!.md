---
title: Smartphone hackerato in 55 secondi!
url: https://hackerjournal.it/11183/smartphone-hackerato-in-55-secondi/
source: Over Security - Cybersecurity news aggregator
date: 2023-01-16
fetch_date: 2025-10-04T04:00:08.289094
---

# Smartphone hackerato in 55 secondi!
...
Un gruppo di pirati informatici ha sfruttato una vulnerabilità zero-day per completare l’hack e avere pieno accesso a un Samsung Galaxy S22.
...
![](https://hackerjournal.it/wp-content/uploads/2023/01/samsung-galaxy-s22-hackerato.jpeg)

* Share
* Tweet

Lo smartphone del colosso coreano, caratterizzato dalla presenza del sistema di sicurezza Knox (una tecnologia proprietaria con funzionalità a livello hardware e chip dedicati) è stato violato in meno di un minuto! A compiere l’impresa alcuni gruppi di hacker durante la competizione [**Pwn2Own**](https://www.secwest.net/pwn2own), manifestazione svoltasi a Toronto, in Canada. **Durante tale evento, ideato proprio per individuare le falle di sicurezza e permettere alle aziende di risolverle le problematiche, i pirati informatici hanno sfruttato una [vulnerabilità zero-day](https://hackerjournal.it/encyclopedia/zero-day/) per completare l’hack e avere pieno accesso al device**. Nello specifico, il primo giorno sono stati scoperti due punti deboli dai team STAR Labs e Chim team. Il secondo giorno, è stato il team Pentest Limited che ha ottenuto il controllo completo del device. Mentre durante il terzo giorno, il **Samsung Galaxy S22 è stato hackerato in meno di un minuto**.

Related Topics:[hack](https://hackerjournal.it/tag/hack/)[knox](https://hackerjournal.it/tag/knox/)[Pwn2Own](https://hackerjournal.it/tag/pwn2own/)[Vulnerabilità](https://hackerjournal.it/tag/vulnerabilita/)[Zero-day](https://hackerjournal.it/tag/zero-day/)
