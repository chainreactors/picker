---
title: La conformità alla NIS2 negli ambienti OT passa per lo Zero Trust e la segmentazione di rete
url: https://www.securityinfo.it/2024/09/24/la-conformita-alla-nis2-negli-ambienti-ot-passa-per-lo-zero-trust-e-la-segmentazione-di-rete/
source: Over Security - Cybersecurity news aggregator
date: 2024-09-25
fetch_date: 2025-10-06T18:28:56.874596
---
...
Set 24, 2024  [Marina Londei](https://www.securityinfo.it/author/marina-londei/ "Articoli scritti da Marina Londei")
 ...
 [0](https://www.securityinfo.it/2024/09/24/la-conformita-alla-nis2-negli-ambienti-ot-passa-per-lo-zero-trust-e-la-segmentazione-di-rete/#respond)

---

Negli ultimi anni **gli ambienti OT sono diventati sempre più interconnessi** e per questo richiedono **misure di sicurezza robuste i**n grado non solo di proteggere i dati, ma anche di garantire l’integrità della produzione. Con la direttiva NIS2, le aziende che dispongono di ambienti OT sono chiamate a rafforzare le loro difese e **proteggere efficacemente gli ambienti di produzione connessi.**

![ambienti OT NIS2](https://www.securityinfo.it/wp-content/uploads/2024/09/ai-generated-8782740_1920.jpg)

Tony Fergusson, CISO di [ZScaler](https://www.zscaler.it/), spiega che garantire la sicurezza degli ambienti OT è un processo che comporta **sfide significative**: i macchinari in uso hanno una durata di vita di 30-40 anni, quindi **le tradizionali misure di protezione non sempre sono adeguate**. Bisogna anche considerare che le reti OT affrontano cambiamenti complessi a causa della natura continua dei processi produttivi, e per questo molte aziende rinunciano a modernizzarle.

Un altro fattore di rischio deriva dall’a**ccesso di fornitori terzi agli ambienti** per scopi di manutenzione: fornire accesso VPN alle reti IT a questi fornitori comporta dei rischi di sicurezza intrinseci, ma le imprese non possono rinunciare agli interventi di manutenzione remota.
...
* [it](https://www.securityinfo.it/tag/it/), [NIS2](https://www.securityinfo.it/tag/nis2/), [OT](https://www.securityinfo.it/tag/ot/), [protezione OT](https://www.securityinfo.it/tag/protezione-ot/), [Segmentazione della rete](https://www.securityinfo.it/tag/segmentazione-della-rete/), [Zero Trust](https://www.securityinfo.it/tag/zero-trust/)

[Il trojan Necro ha attaccato 11 mil...