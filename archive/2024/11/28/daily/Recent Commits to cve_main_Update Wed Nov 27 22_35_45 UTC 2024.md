---
title: Update Wed Nov 27 22:35:45 UTC 2024
url: https://github.com/trickest/cve/commit/961dcb5a60c129fde385240b2bf050929ac63056
source: Recent Commits to cve:main
date: 2024-11-28
fetch_date: 2025-10-06T19:15:39.636746
---

# Update Wed Nov 27 22:35:45 UTC 2024
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftrickest%2Fcve%2Fcommit%2F961dcb5a60c129fde385240b2bf050929ac63056)
...
[Browse files](/trickest/cve/tree/961dcb5a60c129fde385240b2bf050929ac63056)Browse files
...
```
1 parent a21d256 commit 961dcb5

Copy full SHA for 961dcb5
```
...
* 2014
  ...
  + [CVE-2014-3456.md](#diff-a4335f98621227bc067e25c65dc6a523e0326127db9dbad033a1b8196025c636)
...
Collapse file: 2014/CVE-2014-3456.md

### [`‎2014/CVE-2014-3456.md‎`](#diff-a4335f98621227bc067e25c65dc6a523e0326127db9dbad033a1b8196025c636)
...
| --- | --- | --- |
| `@@ -0,0 +1,17 @@` | | | |
|  | `1` | `+ ### [CVE-2014-3456](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3456)` |
...
|  | `6` | `+ ### Description` |
|  | `7` | `+` |
|  | `8` | `+ Cross-site scripting (XSS) vulnerability in GitLab Enterprise Edition (EE) 6.6.0 before 6.6.2 allows remote attackers to inject arbitrary web script or HTML via unspecified vectors.` |
|  | `9` | `+` |
|  | `10` | `+ ### POC` |
|  | `11` | `+` |
|  | `12` | `+ #### Reference` |
|  | `13` | `+ - https://www.gitlab.com/2014/02/27/gitlab-ee-6-6-2-security-release/` |
|  | `14` | `+` |
|  | `15` | `+ #### Github` |
