---
title: Tests URLs for Local File Inclusion (LFI), Remote File Inclusion (RFI), SQL injection (SQLi), and Cross Site Scripting (XSS), Server Side Template Inj...
url: https://twitter.com/Dinosn/status/1616359618157969409
source: Twitter @Nicolas Krassas
date: 2023-01-21
fetch_date: 2025-10-04T04:27:34.917706
---

# Tests URLs for Local File Inclusion (LFI), Remote File Inclusion (RFI), SQL injection (SQLi), and Cross Site Scripting (XSS), Server Side Template Inj...
