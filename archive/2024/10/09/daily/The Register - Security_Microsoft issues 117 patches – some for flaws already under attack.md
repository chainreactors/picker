...
date: 2024-10-09
fetch_date: 2025-10-06T18:58:15.090539
---
...
Microsoft has delivered [117 patches](https://msrc.microsoft.com/update-guide/releaseNote/2024-Oct) – two of which are for vulnerabilities under active exploitation – and plenty of others that are sufficiently serious that they deserve your rapid attention.

The most serious flaw already being exploited by malfeasants is [CVE-2024-43572](https://msrc.microsoft.com/update-guide/en-US/vulnerability/CVE-2024-43572) – a 7.8-rated problem with Microsoft's Management Console that would allow an unauthorized local attacker to run code on a machine using untrusted Microsoft Saved Console (MSC) files. Such files are essentially management utilities that can be accessed from the Microsoft Management Console. Running a bad MSC file could have nasty consequences.

[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg_specialfeatures/cybersecuritymonth&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300...