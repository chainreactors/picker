---
title: Windows Hello for Business – Past and Present Attacks
url: https://insinuator.net/2025/06/windows-hello-for-business-past-and-present-attacks/
source: Insinuator.net
date: 2025-06-21
fetch_date: 2025-10-06T22:53:18.861145
---
...
[Back](https://insinuator.net/#post-15294)

[Misc](https://insinuator.net/category/misc/)

[June 20, 2025](https://insinuator.net/2025/06/windows-hello-for-business-past-and-present-attacks/) by [Tillmann Oßwald](https://insinuator.net/author/tosswald/)

# Windows Hello for Business – Past and Present Attacks

[Tillmann Oßwald](https://insinuator.net/author/tosswald/ "Tillmann Oßwald")
...
Passwordless and password-based logon mechanisms share largely similar architectures, with only a few key distinctions. [As previously discussed,](https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Cyber-Sicherheit/SiSyPHus/AFUNKT.pdf?__blob=publicationFile&v=6) in a traditional password-based logon process, WinLogon initiates user authentication by launching LogonUI. This presents the login interface and relies on a credential provider to collect the user’s credentials – usually username and password. These credentials are then passed via WinLogon to the Local Security Authority Subsystem Service (LSASS.exe) for validation and user authentication.
