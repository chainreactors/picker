---
title: European Commission discloses breach that exposed staff data
url: https://www.bleepingcomputer.com/news/security/european-commission-discloses-breach-that-exposed-staff-data/
source: Over Security - Cybersecurity news aggregator
date: 2026-02-09
fetch_date: 2026-02-10T04:27:12.530320
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Chinese cyberspies breach Singapore's four largest telcos](data:image/gif;base64...)
  ...
  + [![Hackers breach SmarterTools network using flaw in its own software](data:image/gif;base64...)
  ...
  + [![Men charged in FanDuel scheme fueled by thousands of stolen identities](data:image/gif;base64...)
  ...
  + [![Microsoft: Exchange Online flags legitimate emails as phishing](data:image/gif;base64...)
  ...
  + [![Chinese cyberspies breach Singapore's four largest telcos](data:image/gif;base64...)
    ...
    Chinese cyberspies breach Singapore's four largest telcos](https://www.bleepingcomputer.com/news/security/chinese-cyberspies-breach-singapores-four-largest-telcos/)
  + [![Hackers exploit SolarWinds WHD flaws to deploy DFIR tool in attacks](data:image/gif;base64...)
  ...
  + [![Hackers breach SmarterTools network using flaw in its own software](data:image/gif;base64...)
    ...
    Hackers breach SmarterTools network using flaw in its own software](https://www.bleepingcomputer.com/news/security/hackers-breach-smartertools-network-using-flaw-in-its-own-software/)
  + [![Password guessing without AI: How attackers build targeted wordlists](data:image/gif;base64...)
...
![European Union flag](https://www.bleepstatic.com/content/hl-images/2026/01/20/European_Union.jpg)

The European Commission is investigating a breach after finding evidence that its mobile device management platform was hacked. The Commissio...