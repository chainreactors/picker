---
title: Spain arrests 34 suspects linked to Black Axe cyber crime
url: https://www.bleepingcomputer.com/news/security/spain-arrests-34-suspects-linked-to-black-axe-cyber-crime/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-10
fetch_date: 2026-01-11T03:41:34.453424
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CISA retires 10 emergency cyber orders in rare bulk closure](data:image/gif;base64...)
  ...
  + [![Cisco switches hit by reboot loops due to DNS client bug](data:image/gif;base64...)
  ...
  + [![Microsoft is retiring 'Send to Kindle' in Word](data:image/gif;base64...)
  ...
  + [![BreachForums hacking forum database leaked, exposing 324,000 accounts](data:image/gif;base64...)
  ...
  + [![Spain arrests 34 suspects linked to Black Axe cyber crime](data:image/gif;base64...)
  ...
  + [![Use the most popular AI model for a one-time $75 payment](data:image/gif;base64...)

    Use the most popular AI model for a one-time $75 payment](https://www.bleepingcomputer.com/offer/deals/use-the-most-popular-ai-model-for-a-one-time-75-payment/)
...
![Spain arrests 34 suspects linked to Black Axe cyber crime](https://www.bleepstatic.com/content/hl-images/2026/01/09/money.jpg)

Authorities in Spain have arrested 34 individuals allegedly part of a criminal network involved in cyber fraud and believed to be connected to the Black Axe group responsible for illicit activi...