---
title: Krawl v2.4.0
url: https://kitploit.com/en/posts/github-blessedrebus-krawl-v240
source: Kitploit
date: 2026-09-12
fetch_date: 2026-09-13T07:01:30.833958
---
...
* **[AI Generated Deception Pages](https://github.com/blessedrebus/krawl/blob/main/docs/ai_generation.md)**: **Let attackers help generate your fake vulnerable attack surface**
...
* **[Canary Token](https://github.com/blessedrebus/krawl/blob/main/docs/canary-token.md) Integration**: External alert triggering
...
You can easily expose Krawl alongside your other services to shield them from web crawlers and malicious users using a reverse proxy. For more details, see the [Reverse Proxy documentation](https://github.com/blessedrebus/krawl/blob/main/docs/reverse-proxy.md).
...
For more details, see the [Dashboard documentation](https://github.com/blessedrebus/krawl/blob/main/docs/dashboard.md).
