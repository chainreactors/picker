...
![Oz Hair and Beauty Logo](https://logos.haveibeenpwned.com/OzHairAndBeauty.png)

# Oz Hair and Beauty Data Breach

## What Happened

In August 2026, Australian beauty retailer [Oz Hair and Beauty was the target of an xpl0itrs extortion attack](https://www.cyberdaily.au/security/14061-exclusive-oz-hair-and-beauty-confirms-cyber-incident). The group subsequently published data allegedly obtained from the company, which included 2M unique email addresses along with names, phone numbers, geographic locations (suburb and postcode) and purchases.
