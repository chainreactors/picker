---
title: A practical Cisco NDO multi-site use case: data validation
url: https://www.adainese.it/blog/2025/11/16/a-practical-cisco-ndo-multi-site-use-case-data-validation/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-30
fetch_date: 2025-12-01T03:35:59.175612
---
...
[![Patreon Image](/blog/2025/11/16/a-practical-cisco-ndo-multi-site-use-case-data-validation/b36177a12c219cbc0b4cab62584dffd1.webp)](/blog/2025/11/16/a-practical-cisco-ndo-multi-site-use-case-data-validation/b36177a12c219cbc0b4cab62584dffd1.webp)

* **VLAN\_ID** must contain an integer within a defined VLAN pool.
* **VLAN\_NAME** must contain an alphanumeric string without spaces (hyphens and underscores are allowed). Uppercase or lowercase can be enforced if needed.
* **SITE** must contain one of the following values: RM, MI, or SHARED. This field defines the object name and the associated tenant template in NDO.

Continue reading
[the post on Patreon](https://www.patreon.com/posts/140726870)
.
