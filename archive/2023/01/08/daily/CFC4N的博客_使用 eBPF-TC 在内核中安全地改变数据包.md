...
url: https://www.cnxct.com/using-ebpf-tc-to-securely-mangle-packets-in-the-kernel/
source: CFC4N的博客
date: 2023-01-08
fetch_date: 2025-10-04T03:19:32.519706
---
...
[2023/01/07](https://www.cnxct.com/using-ebpf-tc-to-securely-mangle-packets-in-the-kernel/)  [CFC4N](https://www.cnxct.com/author/admin/)

### 文章目录

1. [介绍](#ftoc-heading-1)
2. [项目背景 – 将数据包发送到 OpenZiti 端点](#ftoc-heading-2)
3. [TC-eBPF IFW – tproxy 目标条目](#ftoc-heading-3)
4. [TC-eBPF IFW – 插入和映射](#ftoc-heading-4)
   1. [TC-eBPF – 有状态防火墙](#ftoc-heading-5)
   2. [TC-eBPF IFW – 入站](#ftoc-heading-6)
   3. [eBPF 用户空间集成](#ftoc-heading-7)
   4. [TC-eBPF IFW – 数据流图](#ftoc-heading-8)
   5. [总结：](#ftoc-heading-9)
   6. [原文地址：](#ftoc-heading-10)
...
![](//image.cnxct.com/2023/01/qJTZ9uPxE.jpg)
