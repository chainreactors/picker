---
title: 域渗透、Kerberos、NTLM看不懂？免费送4本Windows安全圣经
url: https://mp.weixin.qq.com/s/w1NorX4kzCCjdflqEMKdgA
source: Doonsec's feed
date: 2026-07-27
fetch_date: 2026-07-28T04:58:02.599623
---

# 域渗透、Kerberos、NTLM看不懂？免费送4本Windows安全圣经

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/9j14GSZeRZaNjhmv5TAd9O1QVNOUt4gSkkiaic0b0M8VD2y2zMPy6GlaCrTvW5mm0lPQ5hCwed7xyWaCCeaF9ZgsEtnVG3ibVcUwAEIMlEkbqU/0?wx_fmt=jpeg)
...
跟人民邮电出版社争取到了粉丝福利：本文阅读量2000以内，送4本《Windows安全内幕》；超过2000阅读加送1本。转发到朋友圈/安全社群，帮你同事朋友一起抽。

**🎁 参与方式**

1. 转发本文到朋友圈或安全/运维/开发相关社群
2. 将截图贴到评论区并留言
3. 阅读量达标后，按留言点赞量依次截取前4位或前5位粉丝送出

**⏰ 活动时间**：即日起至7月30日晚20：00

为什么是这本书？Windows运维、安全、开发三个岗位的人，几乎都会被这几个问题卡住——

域渗透到底是怎么发生的？NTLM/Kerberos被滥用时系统层面发生了什么？

凭据存在SAM数据库和AD里，底层到底怎么存、怎么被偷的？

权限越权、访问令牌伪造、隐藏账户持久化，怎么在审计日志里看出来？

市面上讲Windows安全的书不少，但从安全参考监视器（SRM）→ 访问令牌 → 安全描述符 → SAM/AD凭据存储 → NTLM/Kerberos协商这条主线讲透的，James Forshaw这本是目前唯一的中文版。

作者James Forshaw，Google Project Zero团队成员，20余年微软生态漏洞研究，在Windows平台披露过数百个公开漏洞；本书由PowerShell发明人、微软前技术院士Jeffrey Snover亲自作序推荐。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/jbK5xPfic2R27If5Bgn6w15nKok6RWCmR44V5vQHfMgoyIiaMSUeaBH9IHY0BCeFelOWGtCjyKcE0xaFTicsRHK1GLqRq2Qf4elFvicnRH299pE/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=1)
...
Windows安全架构：内核+用户态的安全参考监视器，访问令牌、安全描述符、SDDL怎么运作

身份验证体系：交互式登录、SAM/AD凭据存储、NTLM、Kerberos、协商协议全链路

PowerShell实战：配套550+条专用命令，复现NTLM中继、Kerberoasting、域渗透等真实攻防场景
...
* 本文阅读量 **2000以内**：送出 **4 本**《Windows安全内幕》（定价148.80元）
* 阅读量 **超过2000**，加送 **1本**
...
越早转发，抽中概率越高——阅读量冲得越高，送的书越多， everyone wins。
