---
title: .NET 安全基础入门知识库（12.27更新）
url: https://mp.weixin.qq.com/s?__biz=MzUyOTc3NTQ5MA==&mid=2247497749&idx=1&sn=5d759e501761ba03ded086835922b779&chksm=fa5956f8cd2edfee02c3ec2344f1eac8fad9c24f9d1a171319bf5a599c09cb444ddbe97313d9&scene=58&subscene=0#rd
source: dotNet安全矩阵
date: 2024-12-28
fetch_date: 2025-10-06T19:39:19.574008
---

# .NET 安全基础入门知识库（12.27更新）

![cover_image](https://mmbiz.qpic.cn/mmbiz_jpg/NO8Q9ApS1YibT817wgAwaNYRV0nxq2SeofgDKIJpiaWD18l1p42DGKNJtIyYjXdJZQomnL0iad83sejLibia66mHNgg/0?wx_fmt=jpeg)
...
正如我们微信和星球所收到的众多朋友们的反馈，新朋友们对于学习.NET安全基础知识有着迫切需求。因此，我们**将.NET安全基础入门领域的知识纳入学习计划，提升在应对安全挑战方面的能力，我们决定创立一个专门聚焦于.NET安全基础入门体系化知识的星球《dot.Net安全基础入门》。**
...
考虑将加入星球朋友们主要由.NET新手及零基础的学习者构成，经过深思熟虑，决定以**视频讲解的方式**作为主要学习桥梁，力求以更加生动直观的方式，深入浅出地介绍相关基础知识，助力每位朋友轻松入门，稳步前行。
...
当外部第三方的库更新版本后，我们的应用程序升级或者使用的时候会产生问题，比如，程序漏洞升级到最新的版本后，发现新库不兼容，导致应用不稳定，这个时候就需要考虑恢复到旧版本。

![](https://mmbiz.qpic.cn/mmbiz_png/NO8Q9ApS1YicrAbh2rMDSmT5nPicgVXY8jibg1oIq4ocAmeHwfBMO4rcUIF8HJubvKkEmwBwdy6jRpJ8nTfrxGzhQ/640?wx_fmt=png&from=appmsg)
...
csc编译器是C#的命令行编译器，用于将C#源代码文件编译成中间语言（IL）或直接编译为可执行文件（.exe）或库文件（.dll），
...
![](https://mmbiz.qpic.cn/mmbiz_png/NO8Q9ApS1YibKowUhdibywicSp8xIlufYym2Z2Mc10NnMQ1MjKYaLicXURJ1b05hU1NYLOAJGvicztmRLKEjCyftF2w/640?wx_fmt=other&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
目前已有90+位朋友抢先预定，****给朋友们准备早鸟价129元，**后期价格随着内容和质量的不断沉淀会适当提高******视频内容已经打包在星球，感兴趣的朋友可以加入观看学习！

![](https://mmbiz.qpic.cn/mmbiz_jpg/NO8Q9ApS1YicTcktdNcDDGwPjxrgDStKDK6rYNHzBjGgp6cxPTTSxYDR4Xzibgh6gu1ibPGHgdTIJ0eYHibSpKmXew/640?wx_fmt=other&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
