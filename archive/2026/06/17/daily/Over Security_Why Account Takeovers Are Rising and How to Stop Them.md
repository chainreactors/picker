...
date: 2026-06-17
fetch_date: 2026-06-18T06:51:14.748609
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![FortiBleed leak exposes Fortinet VPN credentials for 73,000 devices.](data:image/gif;base64...)
  ...
  + [![Microsoft working on Defender patch for RoguePlanet zero-day](data:image/gif;base64...)
  ...
  + [![Malicious JetBrains Marketplace plugins steal AI API keys from developers](data:image/gif;base64...)
  ...
  + [![Steam Workshop abused to spread malware via Wallpaper Engine app](data:image/gif;base64...)
  ...
  + [![Leak confirms OpenAI is testing a ChatGPT for Science subscription](data:image/gif;base64...)
  ...
  + [![Google to use UK and EU user IP addresses for ad personalization](data:image/gif;base64...)
  ...
  + [![This refurbished Apple Watch Series 11 is on sale for $325 while stock lasts](data:image/gif;base64...)

    This refurbished Apple Watch Series 11 is on sale for $325 while stock lasts](https://www.bleepingcomputer.com/offer/deals/this-refurbished-apple-watch-series-11-is-on-sale-for-325-while-stock-lasts/)
  + [![FortiBleed leak exposes Fortinet VPN credentials for 73,000 devices.](data:image/gif;base64...)
...
###### [Specops Software](https://specopssoft.com/contact-us/?utm_source=bleepingcomputer&utm_medium=referral&utm_campaign=infinipoint_bleepingcomputer_referral_na&utm_content=article)

* June 17, 2026
* 10:00 AM
* [0](#comment_form)

![Cyber laptop](https://www.bleepstatic.com/content/posts/2026/06/11/cyber-laptop.jpg)

Organizations now manage thousands of human and non-human identities across cloud services, software-as-a-service applications, endpoints and remote environments.  As hybrid working, Bring-You...