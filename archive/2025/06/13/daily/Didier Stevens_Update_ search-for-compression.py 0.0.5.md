...
date: 2025-06-13
fetch_date: 2025-10-06T22:51:56.864800
---
...
Filed under: [My Software](https://blog.didierstevens.com/category/my-software/),[Update](https://blog.didierstevens.com/category/update/) — Didier Stevens @ 8:40

I added option -u (–unique) to remove duplicates to [search-for-compressions.py](https://github.com/DidierStevens/Beta/blob/master/search-for-compression.py).

### Share this:

* [Click to share on Facebook (Opens in new window)
  Facebook](https://blog.didierstevens.com/2025/06/12/update-search-for-compression-py-0-0-5/?share=facebook)
* [Click to share on X (Opens in new window)
  X](https://blog.didierstevens.com/2025/06/12/update-search-for-compression-py-0-0-5/?share=x)

### *Related*

[Leave a Comment](https://blog.didierstevens.com/2025/06/12/update-search-for-compression-py-0-0-5/#respond)

## Leave a Comment [»](#postcomment "Leave a comment")

No comments yet.

[RSS feed for comments on this post.](https://blog.didierstevens.com/2025/06/12/update-search-for-compression-py-0-0-5/feed/) [TrackBack URI](https://blog.didierstevens.com/2025/06/12/update-search-for-compression-py-0-0-5/trackback/)
...
* ## Blog Stats
  ...
  + 7,865,474 hits
* ## [Twitter @DidierStevens](http://twitter.com/DidierStevens)

  [Tweets by DidierStevens](https...