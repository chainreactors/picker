---
title: [SANS ISC] A Backdoor with Smart Screenshot Capability
url: https://blog.rootshell.be/2023/02/09/sans-isc-a-backdoor-with-smart-screenshot-capabilitysans-isc/
source: /dev/random
date: 2023-02-10
fetch_date: 2025-10-04T06:16:23.381352
---
...
[February 9, 2023](https://blog.rootshell.be/2023/02/09/sans-isc-a-backdoor-with-smart-screenshot-capabilitysans-isc/ "13:03") [Malware](https://blog.rootshell.be/category/security/malware/), [Python](https://blog.rootshell.be/category/software/python/), [SANS Internet Storm Center](https://blog.rootshell.be/category/sans-internet-storm-center/), [Security](https://blog.rootshell.be/category/security/) [One comment](https://blog.rootshell.be/2023/02/09/sans-isc-a-backdoor-with-smart-screenshot-capabilitysans-isc/#comments)

I published the following diary on isc.sans.edu: “*A Backdoor with Smart Screenshot Capability*“:
...
For a while, backdoors and trojans have implemented screenshot capabilities. From an attacker’s point of view, it’s interesting to “see” what’s displayed on the victim’s computer. To take a screenshot in Python is easy as this… [Read [more](https://isc.sans.edu/diary/A%20Backdoor%20with%20Smart%20Screenshot%20Capability/29534)]

![](https://blog.rootshell.be/wp-content/uploads/2023/02/isc-20230209-1.png)

[Malware](https://blog.rootshell.be/tag/malware/)[Python](https://blog.rootshell.be/tag/python/)[SANS ISC](https://blog.rootshell.be/tag/sans-isc/)[Security](https://blog.rootshell.be/tag/security/)
...
1. ![](https://secure.gravatar.com/avatar/89a476f7a1acf8f26cabc673318651598a9ae5fb632fc9ad5892cdabcb87d8db?s=56&d=mm&r=g) **clever** says:

   [April 13, 2023 at 06:55](https://blog.rootshell.be/2023/02/09/sans-isc-a-backdoor-with-smart-screenshot-capabilitysans-isc/#comment-682612)

   .. does his keylogger like uhm also, uhm like log the keys only when the user is actively pressing the key ?
