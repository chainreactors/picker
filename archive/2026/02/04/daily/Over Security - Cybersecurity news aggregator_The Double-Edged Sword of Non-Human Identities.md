...
url: https://www.bleepingcomputer.com/news/security/the-double-edged-sword-of-non-human-identities/
source: Over Security - Cybersecurity news aggregator
date: 2026-02-04
fetch_date: 2026-02-05T04:09:56.120176
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CISA flags critical SolarWinds RCE flaw as exploited in attacks](data:image/gif;base64...)
  ...
  + [![Russian hackers exploit recently patched Microsoft Office bug in attacks](data:image/gif;base64...)
  ...
  + [![Mozilla announces switch to disable all Firefox AI features](data:image/gif;base64...)
  ...
  + [![Notepad++ update feature hijacked by Chinese state hackers for months](data:image/gif;base64...)
  ...
  + [![Hackers compromise NGINX servers to redirect user traffic](data:image/gif;base64...)
  ...
  + [![Critical n8n flaws disclosed along with public exploits](data:image/gif;base64...)
  ...
  + [![Tech prices are high, but this refurbished iPad is still under $400](data:image/gif;base64...)

    Tech prices are high, but this refurbished iPad is still under $400](https://www.bleepingcomputer.com/offer/deals/tech-prices-are-high-but-this-refurbished-ipad-is-still-under-400/)
  + [![CISA: VMware ESXi flaw now exploited in ransomware attacks](data:image/gif;base64...)
...
###### [Flare](https://try.flare.io/bleeping-computer/?utm_campaign=35747122-Bleeping%20Computer%20-%20Jan%2027%20-%20From%20Cipher%20to%20Fear&utm_source=Paid%20Media&utm_medium=Bleeping%20Computer&utm_term=From%20Cipher%20to%20Fear&utm_content=From%20Cipher%20to%20Fear)

* February 4, 2026
* 10:05 AM
* [0](#comment_form)

![Cyber Sword](https://www.bleepstatic.com/content/posts/2026/02/02/cyber-sword.jpg)

In a sweeping analysis conducted in late 2025, Flare researchers uncovered more than [10,000 Docker Hub container images leaking secrets](https://flare.io/learn/resources/docker-hub-secrets-exposed/?utm_campaign=36827706-Bleeping%20Computer%20Double%...