...
url: https://go.theregister.com/feed/www.theregister.com/2023/03/23/chatgpt_fake_chrome_extension/
source: The Register - Security
date: 2023-03-24
fetch_date: 2025-10-04T10:33:21.920272
---
...
The malicious extension – Chat GPT For Google (note the erroneous space in the name of the chatbot) – is very similar in name and code to the real ChatGPT For Google extension. In fact, the phony extension is based on the same [open source project](https://github.com/wong2/chatgpt-google-extension) used by the actual [ChatGPT For Google](https://chatgpt4google.com/) tool – all the fraudsters had to do was add a few lines of cookie-stealing code.
