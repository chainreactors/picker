...
date: 2023-01-23
fetch_date: 2025-10-04T04:35:38.972591
---
...
Filed under: [maldoc](https://blog.didierstevens.com/category/maldoc/),[Malware](https://blog.didierstevens.com/category/malware/),[My Software](https://blog.didierstevens.com/category/my-software/) — Didier Stevens @ 9:24

This is a new tool (based on my [Python template](https://blog.didierstevens.com/my-python-templates/) for binary files) to analyze OneNote files.

This version is limited to handling embedded files (for the moment).

![](https://blog.didierstevens.com/wp-content/uploads/2023/01/20230122-102046.png)

As I might still make significant changes to the user interface, I’ve put [this tool](https://github.com/DidierStevens/Beta/blob/master/onedump.py) in my [GitHub beta repository](https://github.com/DidierStevens/Beta).

### Share this:

* [Click to share on Facebook (Opens in new window)
  Facebook](https://blog.didierstevens.com/2023/01/22/new-tool-onedump-py/?share=facebook)
* [Click to share on X (Opens in new window)
  X](https://blog.didierstevens.com/2023/01/22/new-tool-onedump-py/?share=x)

### *Related*

[Leave a Comment](https://blog.didierstevens.com/2023/01/22/new-tool-onedump-py/#respond)

## Leave a Comment [»](#postcomment "Leave a comment")

No comments yet.

[RSS feed for comments on this post.](https://blog.didierstevens.com/2023/01/22/new-tool-onedump-py/feed/) [TrackBack URI](https://blog.didierstevens.com/2023/01/22/new-tool-onedump-py/trackback/)
...
* ## Categories
  ...
  + [Windows Vista](https://blog.didierstevens.com/category/windows-vis...