...
url: https://buaq.net/go-137422.html
source: unSafe.sh - 不安全
date: 2022-11-28
fetch_date: 2025-10-03T23:54:54.013222
---
...
![](https://8aqnet.cdn.bcebos.com/c398d098fc22b34ac1838b1fc59cd711.jpg)

Windows App 运行控制机制 Smart App Control 的内部安全架构分析（上）

本文会详细分析Windows即将推出的最大安全功能——智能应用控制（Smart App Control，SAC）。“智能应用控制”功
*2022-11-27 12:0:0
Author: [www.4hou.com(查看原文)](/jump-137422.htm)
阅读量:31
收藏*
...
之后，将查询SmartScreen OriginClaim未继承属性，如果它被发现并设置标签CLAIM\_DANGEROUS\_EXT (0x80) (这不是官方名称)，然后函数将继续检查ImageFile是否有被认为是危险扩展名。同样，在所有情况下，代码都将检查ImageFile是否具有InstallerExtension。对于安装程序扩展，它只会检查.msi，对于危险扩展的情况，这些值如下：

![11.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20221013/1665653460116047.png "1665653460116047.png")

如果ImageFile与这些值中的任何一个匹配，则分数将设置为DangerousExtension (0x800)，并通过调用CiCatDbSmartlockerDefenderCheck向防御措施发出查询，有关此函数稍后将详细讨论。

本文翻译自：https://n4r1b.com/posts/2022/09/smart-app-control-internals-part-2/如若转载，请注明原文地址

文章来源: https://www.4hou.com/posts/EQpK
