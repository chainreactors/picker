---
title: cmcp v0.4.0
url: https://kitploit.com/en/posts/github-agentrust-io-cmcp-v040
source: Kitploit
date: 2026-08-31
fetch_date: 2026-09-01T06:59:38.275957
---
...
![](https://assets.kitploit.com/production/public/tools/49259/c608befe534567088266975fd4469cc2ff700fc27be87e347f481ee2aaafc285.png)
...
![cMCP](https://raw.githubusercontent.com/agentrust-io/cmcp/HEAD/docs/assets/icon.svg)

# cMCP: Confidential MCP Runtime

### Enforce MCP tool policy inside a TEE, where the agent it governs cannot reach it

[![Documentation](https://img.shields.io/badge/Documentation-cmcp.agentrust--io.com-7c3aed?style=for-the-badge)](https://cmcp.agentrust-io.com)
...
> **Developer Preview** - launched at the Confidential Computing Summit, June 23 2026. May have breaking changes before v1.0. See [STATUS.md](https://github.com/agentrust-io/cmcp/blob/HEAD/STATUS.md) for exactly what ships today versus what is on the roadmap.
...
See [docs/quickstart.md](https://github.com/agentrust-io/cmcp/blob/HEAD/docs/quickstart.md) for the full walkthrough: Cedar policy, tool catalog, first TRACE Claim, and verification (no hardware TEE required).
...
Provider auto-detect probe order: `azure...