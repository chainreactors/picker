---
title: "BingBang" flaw enabled altering of Bing search results, account takeover
url: https://www.malwarebytes.com/blog/news/2023/03/bing-and-other-microsoft-applications-fall-victim-to-account-takeover-flaw
source: Over Security - Cybersecurity news aggregator
date: 2023-04-01
fetch_date: 2025-10-04T11:24:13.745710
---
...
![Cloud computing](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/03/asset_upload_file27662_262666.jpg?w=736)
...
Researchers from Wiz have discovered a way to [allow for search engine manipulation and account takeover](https://www.wiz.io/blog/azure-active-directory-bing-misconfiguration). The research in question focuses on several Microsoft applications, with everything stemming from a new type of attack aimed at [Azure Active Directory](https://azure.microsoft.com/en-us/products/active-directory).

Azure Active Directory is a single sign-on and multi-factor [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication) service used by organisations around the world. In Microsoft’s own words, “Governance ensures the right people have access to the right resources, and only when they need it”.
...
Thankfully Microsoft was notified about these issues, and by the time the latest Bing update was rolled out the issues had been addressed. From its [Guidance Document](https://msrc.microsoft.com/blog/2023/03/guidance-on-potential-misconfiguration-of-authorization-of-multi-tenant-applications-that-use-azure-ad/):
...
The initial Bing issue was first reported to Microsoft on January 31, and it was fixed the same ...