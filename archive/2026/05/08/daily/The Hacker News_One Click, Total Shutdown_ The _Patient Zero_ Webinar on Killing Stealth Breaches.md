...
date: 2026-05-08
fetch_date: 2026-05-09T05:09:02.360538
---
...
**The Hacker News**May 08, 2026Artificial Intelligence / Threat Detection

[![](data:image/png;base64...)](https://thehacker.news/patient-zero-playbook?source=article)
...
**[Register for the Webinar: The Patient Zero Playbook](https://thehacker.news/patient-zero-playbook?source=article)**
...
[Secure Your Spot – Register Now ➜](https://thehacker.news/patient-zero-playbook?source=article)
...
[artificial intelligence](https://thehackernews.com/search/label/artificial%20intelligence), [cybersecurity](https://thehackernews.com/search/label/cybersecurity), [data breach](https://thehackernews.com/search/label/data%20breach), [email security](https://thehackernews.com/search/label/email%20security), [Incident response](https://thehackernews.com/search/label/Incident%20response), [Malware](https://thehackernews.com/search/label/Malware), [network security](https://thehackernews.com/search/label/network%20security), [Phishing](https://thehackernews.com/search/label/Phishing), [threat detection](https://thehackernews.com/search/label/threat%20detection), [Zero Trust](https://thehackernews.com/search/label/Zero%20Trust)

⚡ Top Stories This Week

[![Harvester Deploys Linux GoGra Backdoor in South Asia Using Microsoft Graph API](data:image/svg+xml;base64... "Harvester Deploys Linux GoGra Backdoor in South Asia Using Microsoft Graph API")
...
[![Malicious KICS Docker Images and VS Code Extensions Hit Checkmarx Supply Chain](data:image/svg+xml;base64... "Malicious KICS Docker Images and VS Code Extensions Hit Checkmarx Supply Chain")
...
[![Apple Fixes iOS Flaw That Let FBI Recover Deleted Signal Messages](data:image/svg+xml;base64... "Apple Fixes iOS Flaw That Let FBI Recover Deleted Signal Messages")
...
[![Vercel Finds More Compromised Accounts in Context.ai-Linked Breach](data:image/svg+xml;base64... "Vercel Finds More Compromised Accounts in Context.ai-Linked Breach")
...
[![ThreatsDay Bulletin: $290M DeFi Hack, macOS LotL Abuse, ProxySmart SIM Farms +25 New Stories](data:image/svg+xml;base64... "ThreatsDay Bulletin: $290M DeFi Hack, macOS LotL Abuse, ProxySmart SIM Farms +25 New Stories")
...
[![Bitwarden CLI Compromised in Ongoing Checkmarx Supply Chain Campaign](data:image/svg+xml;base64... "Bitwarden CLI Compromised in Ongoing Checkmarx Supply Chain Campaign")
...
[![LMDeploy CVE-2026-33626 Flaw Exploited Within 13 Hours of Disclosure](data:image/svg+xml;base64... "LMDeploy CVE-2026-33626 Flaw Exploited Within 13 Hours of...