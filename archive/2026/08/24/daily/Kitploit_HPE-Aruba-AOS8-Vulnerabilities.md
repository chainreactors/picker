---
title: HPE-Aruba-AOS8-Vulnerabilities
url: https://kitploit.com/en/tools/github/jm00nj/hpe-aruba-aos8-vulnerabilities
source: Kitploit
date: 2026-08-24
fetch_date: 2026-08-25T02:58:53.194666
---
...
HPE-Aruba-AOS8-Vulnerabilities — ArubaOS 8.13.2.0 pre-auth attack surface research. XXE+SSRF, ICMP reflection, buffer over-read, hardcoded credentials — all submitted to HPE Bugcrowd, marked N/A. No fixes issued. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/jm00nj/hpe-aruba-aos8-vulnerabilities

![](https://assets.kitploit.com/production/public/tools/51061/f8b8c72c4b920a141841ea8118bde2f51d6dfbc26f17298ceece689a0096b595-display-v1.webp)

[Vulnerability Analysis](/en/categories/vulnerability-analysis)[Exploitation](/en/categories/exploitation)[Network Security](/en/categories/network-security)[Wireless Security](/en/categories/wireless-security)[Binary Analysis](/en/categories/binary-analysis)[Firmware Analysis](/en/categories/firmware-analysis)

![GitHub](/providers/github.png)jm00nj/hpe-aruba-aos8-vulnerabilities
...
[View Repository](https://github.com/jm00nj/hpe-aruba-aos8-vulnerabilities)[Website](https://netacoding.com/)

32 months ago![Not yet reviewed](/_next/image?url=%2Fbadges%2Fkitploit_badge_not_reviewed_full.png&w=48&q=75)
...
| --- | --- | --- | --- | --- | --- |
| 1 | [Pre-Auth XXE → HTTP SSRF](https://github.com/jm00nj/hpe-aruba-aos8-vulnerabilities/blob/HEAD/01-xxe-http-ssrf/writeup.md) | 9e946ca3 | CWE-611 | 9.3 Critical | N/A — RaR expired unanswered |
| 2 | [ICMP Reflection + Smurf](https://github.com/jm00nj/hpe-aruba-aos8-vulnerabilities/blob/HEAD/02-smurf-reflection/writeup.md) | 09e49fa1 | CWE-290, CWE-406 | 7.4 High | N/A |
| 3 | [Ghost Leak](https://github.com/jm00nj/hpe-aruba-aos8-vulnerabilities/blob/HEAD/03-ghost-leak/writeup.md) | c5eda0ae | CWE-126, CWE-1284, CWE-354 | 6.5 Medium | N/A — RaR submitted |
| 4 | [Pre-Auth XXE → FTP SSRF with RETR](https://github.com/jm00nj/hpe-aruba-aos8-vulnerabilities/blob/HEAD/04-xxe-ftp-ssrf/report_ftp_ssrf_p1.md) | 0c716fec | CWE-611 | — | N/A |
| 5 | [Hardcoded FTP Credential / sap:x (CWE-798](https://github.com/jm00nj/hpe-aruba-aos8-vulnerabilities/blob/HEAD/05-Hardcoded-FTP-Credential/CAN-2026-2032115_ArubaOS_Hardcoded_Credential_sap.md) | d13d0e83 | CWE-798, CWE-125 | — | Active — No response |
...
Triage response: *"only zeroed bytes"* — attributing the VirtualBox virtual NIC clean padding characteristic to absence of vulne...