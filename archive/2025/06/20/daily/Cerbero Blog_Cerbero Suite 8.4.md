---
title: Cerbero Suite 8.4
url: https://blog.cerbero.io/cerbero-suite-8-4/
source: Cerbero Blog
date: 2025-06-20
fetch_date: 2025-10-06T22:51:34.227384
---
...
![](/wp-content/uploads/2025/06/84/sort_tables.png)

## Table Filtering

Filtering works the same way. Even if a table doesn’t come with a visible filter, you can now bring one up and use it. Like sorting, this just works out of the box for anything using the default table control.

![](/wp-content/uploads/2025/06/84/filter_tables.png)

## Exporting Data from Controls

You can now export data from tables and tree controls via the context menu. Supported formats include text, CSV (for tables), JSON, and XML. Another long-requested feature finally ticked off.

![](/wp-content/uploads/2025/06/84/export_ctrls.png)

Besides these main additions, we’ve also included some improvements, bug fixes, and updates to bundled software.

![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [June 19, 2025June 19, 2025](https://blog.cerbero.io/cerbero-suite-8-4/)Categories [Engine](https://blog.cerbero.io/category/engine/), [Suite](https://blog.cerbero.io/category/suite/)Tags [Filter](https://blog.cerbero.io/tag/filter/), [News](https://blog.cerbero.io/tag/news/), [Sorting](https://blog.cerbero.io/tag/sorting/), [Tables](https://blog.cerbero.io/tag/tables/)

## One thought on “Cerbero Suite 8.4”

1. Pingback: [Memory Analysis Package 0.4 – Cerbero Blog](https://blog.cerbero.io/memory-analysis-package-0-4/)

## Leave a Reply [Cancel reply](/cerbero-suite-8-4/#respond)
...
[Previous Previous post: WIM Format Package](https://blog.cerbero.io/wim-format-package/)

[Next Next post: Memory Analysis Package 0.4](https://blog.cerbero.io/memory-analysis-package-0-4/)
