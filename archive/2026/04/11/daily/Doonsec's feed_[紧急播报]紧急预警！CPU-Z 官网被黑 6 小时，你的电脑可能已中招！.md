---
title: [紧急播报]紧急预警！CPU-Z 官网被黑 6 小时，你的电脑可能已中招！
url: https://mp.weixin.qq.com/s/9FAU0eQqcqaq0RpYDp1CpQ
source: Doonsec's feed
date: 2026-04-11
fetch_date: 2026-04-12T04:41:22.615500
---

# [紧急播报]紧急预警！CPU-Z 官网被黑 6 小时，你的电脑可能已中招！

![cover_image](https://mmbiz.qpic.cn/mmbiz_jpg/icCLY10D8tvLueUDVIGYlfBRvOia1o7Nmz7hTwUZRfIG6hZuFFQiaVAsCGib1j537IicaibFkRyx3gYh82BkqhTk1IXueiaKXOLc8pGTcjCib5coIRw/0?wx_fmt=jpeg)
...
🚀哈喽～各位宝子们周末好~~👋！宝子们👋 今天必须给大家带来一个十万火急的安全提醒！知名硬件检测工具 CPU-Z 和 HWMonitor 的官网被黑客入侵，恶意软件正在通过官方下载链接传播，数百万用户面临风险！；以下的详细内容👇

![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvK4oicqXHPOHeenWLgRS94slVJNQwJhKwbXTicmFXSt4J6RnQVia1yowndkkRCZPPAFJex28sJ3LDzApGfefd6ROFn8tg4n2o7FR4/640?wx_fmt=png&from=appmsg)

## 2. 报道内容

### 6 小时的供应链投毒攻击（🔍 发生了什么？）

法国软件公司 CPUID 旗下的两款明星产品 ——CPU-Z（硬件检测神器）和HWMonitor（系统监控工具）的官方网站cpuid.com，在2026 年 4 月 9 日 15:00 UTC 至 4 月 10 日 10:00 UTC（约 6 小时）期间被黑客成功入侵。攻击者篡改了官网的下载链接，将正常安装包替换为带有恶意软件的版本，这是一起典型的供应链投毒攻击。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvLnlNhbUvoTM8jQhdib60Cibe6O6uK6UvltMC1OoyOD6OMHA2MNReNwRTfucfoRFN9qKmJ19dPTn0P1qNibMqoL6QvkSb67m68P8w/640?wx_fmt=png&from=appmsg)

### 🚨 有多危险？

被篡改的安装包会执行以下恶意行为： 植入Gen:Variant.Tedy.913517 木马，黑客可远程控制你的电脑 利用DLL 侧加载技术，劫持系统文件 CRYPTBASE.dll，实现隐蔽执行 运行PowerShell 脚本，动态编译恶意代码，建立异常网络连接 窃取浏览器密码、系统信息，甚至控制摄像头和麦克风

![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvILkVLDw3n5T7b051Fyt5OId7stDGP3BtRrvosAVX5hjcc9a8mQYtZHrru5iadRuaHCYnb9usLeSu8H5VUibQ3FwCPpmWQJjGqUA/640?wx_fmt=png&from=appmsg)

### 官方回应

CPUID 负责人 Doc TB 在 X 平台（原 Twitter）确认： 调查仍在进行中，但我们目前初步确认是一个次要功能（类似侧边 API）在 4 月 9 日 - 4 月 10 日之间被入侵 6 小时，导致主站随机显示恶意链接，原始签名文件本身并未被篡改。我们已经发现、修复问题。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvLfv4kvrFbobrg10kg3u715euuMT2zw3BVOvOK8lkjr6eiaK2Mry5dPibPL9AS3WvtkPKZomSYOCOpzL4KbET04dr8AY2KX2aibE0/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvJOxJBQVk0rQbuvvrP70icvzNMBqk7j5zXQQj1U5gw7KmwnXdHYIsxa6znXgTAuiahUHT0W8aWK8Z89icBa9wIQuAONPojJztZKlk/640?wx_fmt=png&from=appmsg)

你可以尝试问一下关于打靶场的问题

![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvL7QRf2ias3UaPEp2wuVZQH8mbCKf5KvTyl8X9tr8y0OQvS6Lc5JofGNeDtxXzsYE8tc8szHmXTLFTY3A6Hav99MVia90eqROgWI/640?wx_fmt=png&from=appmsg)
