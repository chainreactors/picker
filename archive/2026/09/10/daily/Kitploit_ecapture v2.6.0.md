---
title: ecapture v2.6.0
url: https://kitploit.com/en/posts/github-gojue-ecapture-v260
source: Kitploit
date: 2026-09-10
fetch_date: 2026-09-11T06:51:39.395801
---
...
![](https://assets.kitploit.com/production/public/tools/6909/d8c1e57110e6b78645e08be93bca888b988d3c7ae7580e14f2e7c20b034cc21a.png)
...
![eCapture Logo](https://assets.kitploit.com/production/public/readmes/6909/d8c1e57110e6b78645e08be93bca888b988d3c7ae7580e14f2e7c20b034cc21a.png)

[汉字](https://github.com/gojue/ecapture/blob/master/README-zh_Hans.md) | English
...
> [!IMPORTANT]
> Supports Linux/Android on x86\_64 (kernel 4.18+) and aarch64 (kernel **5.5+**). Kernel version requirements apply per CPU architecture for both Linux and Android.
> Need ROOT permission or specific [Linux capabilities](https://github.com/gojue/ecapture/blob/master/docs/minimum-privileges.md).
...
![](https://raw.githubusercontent.com/gojue/ecapture/HEAD/images/ecapture-help-v0.8.9.svg)
...
> **⚠️ Security Note**: `--privileged=true` grants full host access. For production use, consider specific capabilities instead. See [Minimum Privileges Guide](https://github.com/gojue/ecapture/blob/master/docs/minimum-privileges.md#method-3-docker-with-specific-capabilities).
...
> 📄 For complete output examples, see [docs/example-outputs.md](https://github.com/gojue/ecapture/blob/master/docs/example-outputs.md).
...
> 📄 For complete pcapng mode output, see [docs/example-outputs.md](https://github.com/gojue/ecapture/blob/master/docs/example-outputs.md#tls-module--pcapng-mode).
...
* Youtube video: [How to use eCapture v0.1.0](https://www.youtube.com/watch?v=CoDIjEQCvvA...