---
title: chef-os-hardening
url: https://kitploit.com/en/tools/github/dev-sec/chef-os-hardening
source: Kitploit
date: 2026-09-07
fetch_date: 2026-09-08T06:41:00.899634
---
...
chef-os-hardening — This chef cookbook provides numerous security-related configurations, providing all-round base protection. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/dev-sec/chef-os-hardening

![](https://assets.kitploit.com/production/public/tools/54389/548f1fad20bbb57cd5acbcccf354f5f4ed4bd6c29cf0ef96288bb4299c8ceea1-display-v1.webp)

[Cloud Infrastructure Security](/en/categories/cloud-infrastructure-security)[Configuration Auditing](/en/categories/configuration-auditing)[DevSecOps](/en/categories/devsecops)[Authentication](/en/categories/authentication)

![GitHub](/providers/github.png)dev-sec/chef-os-hardening

# chef-os-hardening

This chef cookbook provides numerous security-related configurations, providing all-round base protection.

[View Repository](https://github.com/dev-sec/chef-os-hardening)

452132351 month ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
[![Supermarket](http://img.shields.io/cookbook/v/os-hardening.svg)](https://supermarket.getchef.com/cookbooks/os-hardening)
[![Tests](https://github.com/dev-sec/chef-os-hardening/actions/workflows/test.yml/badge.svg)](https://github.com/dev-sec/chef-os-hardening/actions/workflows/test.yml)
...
* `['os-hardening']['security']['suid_sgid']['dry_run_on_unknown'] = false`
  ...
  It will still search the filesystems to look for SUID/SGID bits but it will only print them in your log. This option is only ever recommended, when you first configure `remove_from_unknown` fo...