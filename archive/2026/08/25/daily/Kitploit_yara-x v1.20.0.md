---
title: yara-x v1.20.0
url: https://kitploit.com/en/posts/github-virustotal-yara-x-v1200
source: Kitploit
date: 2026-08-25
fetch_date: 2026-08-26T03:05:05.175964
---
...
![](https://assets.kitploit.com/production/public/tools/42042/125a803ce887b8df38070280749e5f5c3e318ab16166ff4355665107ec7fb2dc.png)
...
Contributions to YARA-X are welcome! For details on the Google Contributor License Agreement (CLA) requirement, code style conventions, and how to submit pull requests, please read [CONTRIBUTING.md](https://github.com/virustotal/yara-x/blob/HEAD/CONTRIBUTING.md).

[Read more](/en/tools/github/virustotal/yara-x?expand=1)

## Categories

[Defensive Tools](/en/categories/defensive-tools)[Disk Forensics](/en/categories/disk-forensics)[Indicator of Compromise (IOC) Management](/en/categories/ioc-management)[Static Analysis](/en/categories/static-analysis)[Dynamic Analysis (Sandboxing)](/en/categories/dynamic-analysis-sandboxing)[Memory Forensics](/en/categories/memory-forensics)[Threat Feeds & Aggregators](/en/categories/threat-feeds-aggregators)[Vulnerability Analysis](/en/categories/vulnerability-analysis)[Forensics](/en/categories/forensics)[Mobile Forensics](/en/categories/mobile-forensics)[Network Security](/en/categories/network-security)[Data Recovery](/en/categories/data-recovery)[Malware Analysis](/en/categories/malware-analysis)[Binary Analysis](/en/categories/binary-analysis)[Threat Intelligence](/en/categories/threat-intelligence)[Incident Response](/en/categories/incident-response)[Email Security](/en/categories/email-security)
