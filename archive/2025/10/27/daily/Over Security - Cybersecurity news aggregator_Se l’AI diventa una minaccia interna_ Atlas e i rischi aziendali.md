---
title: Se l’AI diventa una minaccia interna: Atlas e i rischi aziendali
...
![Atlas OpenAi rischi aziendali](data:image/png;base64...)![Atlas OpenAi rischi aziendali](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/10/Atlas-OpenAi-rischi-aziendali.jpg)

---

Gli episodi recenti che hanno **coinvolto strumenti come Microsoft Copilot**, dove [l’agente AI ha eseguito comandi nascosti](https://cybersecuritynews.com/copilot-prompt-injection-vulnerability-2/) all’interno di file aziendali, mostrano come [i modelli linguistici possano diventare vettori operativi di rischio](https://www.cybersecurity360.it/news/ai-contro-ai-la-nuova-frontiera-del-phishing/).
...
* [Cos’è Atlas e cosa fa](#Cose_Atlas_e_cosa_fa)
* [Perché Atlas è diverso e amplifica i rischi](#Perche_Atlas_e_diverso_e_amplifica_i_rischi)
* [Dal browser personale all’agente operativo aziendale](#Dal_browser_personale_allagente_operativo_aziendale)
* [Atlas e le nuove superfici di rischio in azienda](#Atlas_e_le_nuove_superfici_di_rischio_in_azienda)
* [L’AI come nuovo insider digitale](#LAI_come_nuovo_insider_digitale)
* [Dal phishing al prompt hijacking](#Dal_phishing_al_prompt_hijacking)
* [Il caso Copilot: quando l’AI esegue istruzioni nascoste](#Il_caso_Copilot_quando_lAI_esegue_istruzioni_nascoste)
* [Cosa accadrebbe in Atlas](#Cosa_accadrebbe_in_Atlas)
* [I rischi concreti per le imprese](#I_rischi_concreti_per_le_imprese)
* [Security-by-Context e mitigazioni operative](#Security-by-Context_e_mitigazioni_operative)
* [Governance e responsabilità](#Governance_e_responsabilita)
* [L’AI componente del perimetro aziendale](#LAI_componente_del_perimetro_aziendale)
* [L’agente AI entra in organico](#Lagente_AI_entra_in_organico)

## Cos’è Atlas e cosa fa

Atlas è, infatti, il [nuovo browser sviluppato da OpenAI](https://www.cybersecurity360.it/news/atlas-il-browser-intelligente-di-openai-che-ricorda-cosa-facciamo-online-i-rischi-privacy/) e **costruito nativamente intorno a ChatGPT**, come componente integrata del motore di navigazione e non come estensione. Non è cioè un plug-in di terze parti.
...
3. una memoria persistente, che conserva “fatti e intuizioni” (*facts and insights* secondo la [privacy policy ufficiale di OpenAI](https://help.openai.com/en/articles/12574142-chatgpt-atlas-data-controls-and-privacy)) per rendere le risposte sempre più mirate e personalizzate nel tempo.
...
Questa architettura (memoria, linguaggio e azione) rappresenta una **discontinuità rispetto ai sistemi concorrenti**, dal momento che gli altri browser potenziati, come ad esempio Gemini e Copilot, limitano la loro attività alla singola sessione e non archiviano i...