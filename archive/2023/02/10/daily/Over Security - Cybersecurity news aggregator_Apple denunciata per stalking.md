---
title: Apple denunciata per stalking
url: https://hackerjournal.it/11315/apple-denunciata-per-stalking/
source: Over Security - Cybersecurity news aggregator
date: 2023-02-10
fetch_date: 2025-10-04T06:15:41.876877
---

# Apple denunciata per stalking
...
Due donne accusano gli AirTag di aver favorito le molestie assillanti da parte degli ex compagni
...
![](https://hackerjournal.it/wp-content/uploads/2023/02/Apple_airtag-Orizzontale.jpg)

* Share
* Tweet

**Dopo aver subito stalking da parte dei relativi ex partner, due donne americane hanno deciso di denunciare [Apple](www.apple.com).** Perché? Semplice: gli ex hanno utilizzato degli AirTag per seguirle. La causa è stata intentata perché entrambe le signore hanno ritenuto che le misure adottate da Apple per evitare che questi strumenti possano essere utilizzati per lo stalking siano insufficienti. Una delle due donne ha spiegato che il suo ex compagno aveva nascosto un AirTag nel passaruota dell’auto, così da poterla seguire senza problemi, mentre l’uomo dell’altra donna lo aveva nascosto nello zaino del figlio. **Nel frattempo Apple ha apportato modifiche agli [AirTag](https://www.apple.com/it/airtag/) per migliorare la difesa della privacy, ad esempio aumentando il volume del segnale acustico emesso quando si trova lontano dall’iPhone del proprietario, ma pare che le misure prese siano state giudicate insufficienti**.

[Leggi anche](https://hackerjournal.it/10368/apple-nuova-protezione-lockdown-mode-contro-cyber-attacchi-su-ios/): **Apple presenta in anteprima una funzionalità di sicurezza rivoluzionaria che offre una protezione aggiuntiva specializzata agli utenti** che potrebbero essere a rischio di attacchi informatici altamente mirati da parte di società private che sviluppano spyware mercenario sponsorizzato dallo stato.

Related Topics:[airtag](https://hackerjournal.it/tag/airtag/)[apple](https://hackerjournal.it/tag/apple/)[Privacy](https://hackerjournal.it/tag/privacy/)
