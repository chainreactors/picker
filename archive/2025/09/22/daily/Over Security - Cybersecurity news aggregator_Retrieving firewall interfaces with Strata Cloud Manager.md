---
title: Retrieving firewall interfaces with Strata Cloud Manager
url: https://www.adainese.it/blog/2025/09/21/retrieving-firewall-interfaces-with-strata-cloud-manager/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-22
fetch_date: 2025-10-02T20:30:14.008099
---

# Retrieving firewall interfaces with Strata Cloud Manager
...
[![Post cover](/images/vendors/paloalto.webp)](/images/vendors/paloalto.webp)

Let’s look at a second example that illustrates both the functionality and the complexity of SCM’s APIs.

In this scenario, we want to retrieve the **Ethernet interfaces** of the firewalls. A quick search in the documentation leads us to the correct
[API endpoint](https://pan.dev/scm/api/config/ngfw/network/list-ethernet-interfaces/)
.

Using the custom class we created earlier, the code is straightforward:

[![Patreon Image](/blog/2025/09/21/retrieving-firewall-interfaces-with-strata-cloud-manager/696f4baeb7953cabf36e4b266b2c74d2.webp)](/blog/2025/09/21/retrieving-firewall-interfaces-with-strata-cloud-manager/696f4baeb7953cabf36e4b266b2c74d2.webp)

Continue reading
[the post on Patreon](https://www.patreon.com/posts/retrieving-with-136480239)
.
