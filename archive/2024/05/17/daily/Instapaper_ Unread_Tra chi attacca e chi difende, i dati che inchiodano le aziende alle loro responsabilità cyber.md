---
title: Tra chi attacca e chi difende, i dati che inchiodano le aziende alle loro responsabilità cyber
url: https://www.cybersecurity360.it/cybersecurity-nazionale/tra-chi-attacca-e-chi-difende-i-dati-che-inchiodano-le-aziende-alle-loro-responsabilita-cyber/
source: Instapaper: Unread
date: 2024-05-17
fetch_date: 2025-10-06T17:23:41.505500
---
...
![rapporto clusit](data:image/png;base64...)![rapporto clusit](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2024/05/rapporto-clusit.jpg)

---

Il **Clusit**, l’Associazione italiana per la Sicurezza informatica, lo scorso marzo ha pubblicato il **rapporto 2024** di cui [abbiamo già parlato qui](https://www.cybersecurity360.it/news/attacchi-cyber-nei-dati-clusit-uno-scenario-fosco-nel-2023-piu-12-per-cento/).

Il report, [prelevabile qui](https://clusit.it/rapporto-clusit/), evidenzia un’evoluzione del cyber crimine e una crescita degli attacchi sia in termini di quantità sia in termini di qualità.
...
> [Italia tra gli ultimi della classe in materia di privacy e cyber security](https://www.cybersecurity360.it/cultura-cyber/italia-tra-gli-ultimi-della-classe-in-materia-di-privacy-e-cyber-security/)

Indice degli argomenti

* [Il rapporto Clusit 2024 in breve](#Il_rapporto_Clusit_2024_in_breve)
* [Le tecniche d’attacco](#Le_tecniche_dattacco)
* [Cosa non dice il rapporto Clusit 2024](#Cosa_non_dice_il_rapporto_Clusit_2024)
  + [Uno spiraglio c’è](#Uno_spiraglio_ce)
* [Le vie d’uscita](#Le_vie_duscita)

## Il rapporto Clusit 2024 in breve

Ciò che le oltre 370 pagine del rapporto Clusit 2024 dicono in modo esplicito può essere riassunto così, rimandando il lettore agli [approfondimenti del caso](https://www.cybersecurity360.it/tag/clusit/): rispetto al 2022, il 2023 ha fatto segnare nella sola Italia un **aumento degli attacchi totali pari al 65%** andando a colpire soprattutto la finanza, il manifatturiero e la sanità.
...
I [malware](https://www.cybersecurity360.it/nuove-minacce/malware-cosa-sono-come-riconoscerli-e-come-rimuoverli/) sono, in generale e a livello globale, la tecnica più usata dagli incursori, tant’è che **rappresentano il 36% degli attacchi** (+10% rispetto al 2022). Nella numerosa famiglia dei malware rientrano [anche in ransomware](https://www.cybersecurity360.it/nuove-minacce/ransomware/porto-giapponese-ransomware/) che, di fatto, è il chiavistello più utilizzato giacché fonte di guadagni. Sempre a livello globale, e questo dato è interessante, è stato registrato un [aumento degli attacchi DDoS](https://www.cybersecurity360.it/nuove-minacce/ddos-cosa-sono-questi-attacchi-hacker-e-come-stanno-evolvendo/) del 98%.

In Italia, per la prima volta, **tali attacchi hanno superato i malware** (i dati del report, lo ricordiamo, fanno riferimento al 2023) e, rappresentando più di una minaccia su tre (il 3...