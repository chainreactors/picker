---
title: Dropper-GCleaner-C2-Infrastructure-Kernel-Driver-PowerShell-Conhost-Payload-Analysis
url: https://kitploit.com/en/tools/github/kaandemir993/dropper-gcleaner-c2-infrastructure-kernel-driver-powershell-conhost-payload-analysis
source: Kitploit
date: 2026-08-20
fetch_date: 2026-08-21T03:02:56.470712
---
...
Dropper-GCleaner-C2-Infrastructure-Kernel-Driver-PowerShell-Conhost-Payload-Analysis — Reverse engineering analysis of Dropper GCleaner, a malware that uses a resilient C2 infrastructure, kernel driver loading, PowerShell/Conhost execution, and .rdata payload extraction. Includes 30+ C2 domains, NtLoadDriver, and full API list." | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/kaandemir993/dropper-gcleaner-c2-infrastructure-kernel-driver-powershell-conhost-payload-analysis

![](https://assets.kitploit.com/production/public/tools/50578/163a4594ae3dd7493972a2100c0825385fb33e3767f2f3a32351294e35b7008a.png)

[Privilege Escalation](/en/categories/privilege-escalation)[Memory Forensics](/en/categories/memory-forensics)[Persistence Mechanisms](/en/categories/persistence-mechanisms)[Reverse Engineering](/en/categories/reverse-engineering)[Data Exfiltration](/en/categories/data-exfiltration)[Malware Analysis](/en/categories/malware-analysis)[Command and Control](/en/categories/command-and-control)[Binary Analysis](/en/categories/binary-analysis)[Threat Intelligence](/en/categories/threat-intelligence)
...
![GitHub](/providers/github.png)kaandemir993/dropper-gcleaner-c2-infrastructure-kernel-driver-powershell-conhost-payload-analysis
...
[View Repository](https://github.com/kaandemir993/dropper-gcleaner-c2-infrastructure-kernel-driver-powershell-conhost-payload-analysis)

1171 day ago![Not yet reviewed](/_next/image?url=%2Fbadges%2Fkitploit_badge_not_reviewed_full.png&w=48&q=75)

## 1. C2 Infrastructure – Resilient & Redundant Servers
...
![GCleaner Dropper C2 Domains](https://assets.kitploit.com/production/public/readmes/50578/163a4594ae3dd7493972a2100c0825385fb33e3767f2f3a32351294e35b7008a.png)
...
![GCleaner Dropper PowerShell Strings](https://assets.kitploit.com/production/public/readmes/50578/b12ce0fe8004dfc3dee29593ee4044237edb9995b7874ec32809da9b6b303fb4.png)
...
![GCleaner Dropper Kernel & Privilege Strings](https://assets.kitploit.com/production/public/readmes/50578/062a68adf12d69db07e0d484a006bad8c02aa70dc8f72f990f09a3312ff8c72a.png)
...
![GCleaner Dropper Conhost Kernel Strings](https://assets.kitploit.com/production/public/readmes/50578/f9e8066bd9995b9ab75a4286f8c45c600249d27fe06195544a240b60d5d87302.png)
...
Binary Ninja analysis of the `.rdata` section reveals the complete payload of Dropper GCleaner . The API list confirms its capabilities as a full...