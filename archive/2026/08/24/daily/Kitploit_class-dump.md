---
title: class-dump
url: https://kitploit.com/en/tools/github/nygard/class-dump
source: Kitploit
date: 2026-08-24
fetch_date: 2026-08-25T02:59:17.298249
---
...
class-dump — Generate Objective-C headers from Mach-O files. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/nygard/class-dump

![](https://assets.kitploit.com/production/public/tools/50844/15abe3932da2fdc6a16d2a4ebf53418f5421ab604484a930ae857da74095b693-display-v1.webp)

[Static Analysis](/en/categories/static-analysis)[iOS Security](/en/categories/ios-security)[Reverse Engineering](/en/categories/reverse-engineering)[Binary Analysis](/en/categories/binary-analysis)[Top in iOS Security #17](/en/categories/ios-security)

![GitHub](/providers/github.png)nygard/class-dump

# class-dump

Generate Objective-C headers from Mach-O files.

[View Repository](https://github.com/nygard/class-dump)

3.6k9004 years ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
[Website](http://stevenygard.com/projects/class-dump)
...
[Download Tool](https://github.com/nygard/class-dump)
