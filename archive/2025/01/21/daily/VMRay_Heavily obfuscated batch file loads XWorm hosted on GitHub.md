---
title: Heavily obfuscated batch file loads XWorm hosted on GitHub
url: https://www.vmray.com/heavily-obfuscated-batch-file-loads-xworm-hosted-on-github/
source: VMRay
date: 2025-01-21
fetch_date: 2025-10-06T20:09:11.015335
---
...
![](https://www.vmray.com/wp-content/uploads/2025/01/7-1024x891.png)
...
* Uses an [open-source Batch obfuscator](https://github.com/SkyEmie/batch-obfuscator) with multi-staged symbol mapping to build strings during execution

* Uses [cacls.exe](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/cacls) to verify whether the process is running with admin privileges

* Drops a VBS script to prompt a UAC dialog to elevate privileges

* Adjusts Windows Defender exclusion paths via PowerShell

* Downloads an instance of XWorm fr...