---
title: mirth-connect-security-poc
url: https://kitploit.com/en/tools/github/abhinavagarwal07/mirth-connect-security-poc
source: Kitploit
date: 2026-09-12
fetch_date: 2026-09-13T07:01:29.189308
---
...
[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/abhinavagarwal07/mirth-connect-security-poc

![](https://assets.kitploit.com/production/public/tools/54825/f44fd0fc6ea5d384e12ef4ed550988dfb120e00a53ac6c475a3e4b747dc391df-display-v1.webp)

[Defensive Tools](/en/categories/defensive-tools)[Vulnerability Analysis](/en/categories/vulnerability-analysis)[Exploitation](/en/categories/exploitation)[Web Application Exploitation](/en/categories/web-application-exploitation)[Security Virtualization](/en/categories/security-virtualization)[Penetration Testing](/en/categories/penetration-testing)[Learning & Education](/en/categories/education)

![GitHub](/providers/github.png)abhinavagarwal07/mirth-connect-security-poc
...
[View Repository](https://github.com/abhinavagarwal07/mirth-connect-security-poc)

272 days ago![Not yet reviewed](/_next/image?url=%2Fbadges%2Fkitploit_badge_not_reviewed_full.png&w=48&q=75)
...
| --- | --- | --- | --- | --- | --- |
| [CVE-2026-82583](https://www.cve.org/CVERecord?id=CVE-2026-82583) | `_getTables` `selectLimit` injection | Authenticated API user | Password-table export to the public web root; bundled Derby freeze until restart | 8.3 / 7.2 | [`sql-selectlimit-injection/`](https://github.com/abhinavagarwal07/mirth-connect-security-poc/blob/main/sql-selectlimit-injection) |
| [CVE-2026-78224](https://www.cve.org/CVERecord?id=CVE-2026-78224) | XSLT Step XXE | Unauthenticated channel client | OOB read of a target-local file; channel-local slow-entity DoS | 8.2 / 8.8 | [`xslt-step-xxe/`](https://github.com/abhinavagarwal07/mirth-connect-security-poc/blob/main/xslt-step-xxe) |
| [CVE-2026-82578](https://www.cve.org/CVERecord?id=CVE-2026-82578) | XML Batch Adaptor XXE | Unauthenticated channel client | OOB read of a target-local file | 7.5 / 8.7 | [`xml-batch-xxe/`](https://github.com/abhinavagarwal07/mirth-connect-security-poc/blob/main/xml-batch-xxe) |
...
Batch processing is off by default, t...