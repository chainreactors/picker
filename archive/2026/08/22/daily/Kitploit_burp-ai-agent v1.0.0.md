---
title: burp-ai-agent v1.0.0
url: https://kitploit.com/en/posts/github-six2dez-burp-ai-agent-v100
source: Kitploit
date: 2026-08-22
fetch_date: 2026-08-23T02:57:06.443506
---
...
![](https://assets.kitploit.com/production/public/tools/266/75a50bb9106ff22bcc97696f2e53148accc4e05bb70d544a81758948f7ecfb25.png)
...
![Custom AI Agent Screenshot](https://assets.kitploit.com/production/public/readmes/266/75a50bb9106ff22bcc97696f2e53148accc4e05bb70d544a81758948f7ecfb25.png)
...
* **Native [Anthropic](https://github.com/six2dez/burp-ai-agent/blob/HEAD/docs/anthropic-backend.md) backend** (CAP-01) — direct Anthropic Messages API via Burp's HTTP transport; all traffic appears in Proxy history.
...
* **[External MCP servers](https://github.com/six2dez/burp-ai-agent/blob/HEAD/docs/external-mcp-servers.md)** (CAP-02) — connect to external/custom MCP servers (SSE or stdio) so AI agents can call their tools alongside Burp's built-in tools.
...
![Load Extension](https://assets.kitploit.com/production/public/readmes/266/06e11c9047fd05a7378f90511cc4fb2cd01d992469f572117ecc6304c26ef9d5.png)
...
| **Anthropic** | Cloud API | Enter your Anthropic API key in Settings. API traffic routes through Burp's proxy. See [docs/anthropic-backend.md](https://github.com/six2dez/burp-ai-agent/blob/HEAD/docs/anthropic-backend.md). |
...
Leave extra headers empty unless your gateway requires them. The extension sends requests to `/v1/chat/completions` an...