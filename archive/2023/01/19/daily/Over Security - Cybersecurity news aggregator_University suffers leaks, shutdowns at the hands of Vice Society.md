---
title: University suffers leaks, shutdowns at the hands of Vice Society
url: https://www.malwarebytes.com/blog/news/2023/01/university-suffers-leaks-shutdowns-at-the-hands-of-vice-society
source: Over Security - Cybersecurity news aggregator
date: 2023-01-19
fetch_date: 2025-10-04T04:19:36.168156
---
...
![ransomware on screen](https://www.threatdown.com/wp-content/uploads/2023/01/asset_upload_file15265_255559.jpg?w=736)
...
The Vice Society ransomware gang is back and making some unfortunate waves in the education sector. According to Bleeping Computer, the Society has held their ransomware laden hands up and [admitted an attack on the University of Duisberg-Essen](https://www.bleepingcomputer.com/news/security/vice-society-ransomware-leaks-university-of-duisburg-essen-s-data/). Sadly this isn’t the University’s [first encounter with ransomware attacks](https://security.geant.org/connect-interview-how-the-university-of-duisburg-essen-ude-prevented-a-ransomware-attack/), though it has proven to perhaps be its worst, given reports of leaks and changes to its IT infrastructure.

## Ransomware and a destroyed network

When word spread of the attack back in November, it essentially shuttered the university’s entire network and [removed it from the internet](https://www.gcr21.org/the-centre/news/year/current/cyber-attack-on-university-duisburg-essen). Essential functionality such as email and telephone were entirely non-functional. “Large parts” of the servers were encrypted, alongside the usual ransom demands.

At the time, there was no word as to who did it. This has all changed now, with the leaking of files onto the dark web. A [statement from the University](https://www-uni--due-org.translate.goog/udeoffline/kriminelle-veroeffentlichung-von-daten-im-darknet) mentions that it refused to pay the ransom, not wanting to support criminal offences or contribute to ransomware authors doing it to someone else next time. The University will also be contacting people and institutions affected by the data leak.
...
Though it’s not possible for anyone but the University itself to confirm the legitimacy of these claims and files, on the surface it doesn’t sound very good. Vice Society has been targeting education for some time now, with an ever growing number of schools and learning resources being [massively impacted by the attacks](https://www.threatdown.com/blog/multiple-schools-hit-by-vice-society-ransomware-attack/).

The UDE attack alone broke the University’s IT in half at the end of November, bringing portions of the network back online in a way that was so unsatisfactory that the whole thing had to be [rebuilt from the ground up](https://www.uni-due.org/udeoffline/wiederaufbau-der-it-infrastruktur/) a week or so into the start of January.
...
[![Stop ransomware](http://www.threatdown.com/wp-content/uploads/2024/06/easset_upload_file23110_239551_e.jpg)](http://www.threatdown.com/wp-content/uploads/2024/06/easset_upload_file23110_239551_e.jpg)
