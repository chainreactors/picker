...
url: https://krebsonsecurity.com/2023/03/why-you-should-opt-out-of-sharing-data-with-your-mobile-provider/
source: Over Security - Cybersecurity news aggregator
date: 2023-03-21
fetch_date: 2025-10-04T10:10:50.201067
---
...
[39 Comments](https://krebsonsecurity.com/2023/03/why-you-should-opt-out-of-sharing-data-with-your-mobile-provider/#comments)
...
According to [a succinct CPNI explainer at TechTarget](https://www.techtarget.com/searchnetworking/definition/CPNI), CPNI is private and protected information that cannot be used for advertising or marketing directly.
...
Hence, the carriers can share and sell this data because they’re not explicitly prohibited from doing so. All three major carriers say they take steps to anonymize the customer data they share, but researchers have shown it is not terribly difficult [to de-anonymize supposedly anonymous web-browsing data](https://www.vice.com/en/article/gygx7y/your-anonymous-browsing-data-isnt-actually-anonymous).

“Your phone, and consequently your mobile provider, know a lot about you,” [wrote](https://mashable.com/article/how-to-stop-tmobile-att-verizon-from-sharing-my-data) Jack Morse for **Mashable**. “The places you go, apps you use, and the websites you visit potentially reveal all kinds of private information — e.g. religious beliefs, health conditions, travel plans, income level, and specific tastes in pornography. This should bother you.”
...
AT&T’s [CPNI opt-out page](https://www.att.com/ecpnioptout/InitiateCPNIForm.action) says it shares CPNI data with several of its affiliates, including **WarnerMedia**, **DirecTV** and **Cricket Wireless**. Until recently, AT&T also shared CPNI data with **Xandr**, whose [privacy policy](https://docs.xandr.com/bundle/service-policies/page/third-party-providers.html) in turn explains that it shares data with *hundreds of other advertising firms*. Microsoft [bought Xandr from AT&T last year](https://about.att.com/story/2022/xandr-microsoft.html).

## T-MOBILE

According to the [Electronic Privacy Information Center](https://www.epic.org) (EPIC),**T-Mobile** seems to be the only company out of the big three to extend to all customers the rights conferred by the [California Consumer Privacy Act](https://en.wikipedia.org/wiki/California_Consumer_Privacy_Act) (CCPA).
...
EPIC notes that all three major carriers say resetting the consumer’s device ID and/or clearing cookies in the browser will similarly reset any opt-out preferences (i.e., the customer will need to...