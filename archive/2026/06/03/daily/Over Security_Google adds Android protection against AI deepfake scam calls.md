...
date: 2026-06-03
fetch_date: 2026-06-04T06:31:57.896412
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![New 'HTTP/2 Bomb' DoS attack crashes web servers in under a minute](data:image/gif;base64...)
  ...
  + [![CISA warns of active attacks exploiting Android, Linux bugs](data:image/gif;base64...)
  ...
  + [![Police dismantles 9 crime groups in illegal streaming crackdown](data:image/gif;base64...)
  ...
  + [![VS Code zero-day lets hackers steal GitHub tokens in one click](data:image/gif;base64...)
  ...
  + [![Chinese hackers use new Atlas RAT malware in European cyberattacks](data:image/gif;base64...)
  ...
  + [![U.S. sanctions Nobitex crypto exchange used by Iranian ransomware actors](data:image/gif;base64...)
  ...
  + [![ CISA warns of cyberattacks targeting fuel tank monitoring systems](data:image/gif;base64...)
...
![Android](https://www.bleepstatic.com/content/hl-images/2026/06/03/android.jpg)

Google is introducing a new Android security feature that will detect and flag phone calls in which scammers use artificial intelligen...