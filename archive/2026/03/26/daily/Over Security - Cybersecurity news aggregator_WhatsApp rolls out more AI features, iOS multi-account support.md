...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Popular LiteLLM PyPI package backdoored to steal credentials, auth tokens](data:image/gif;base64...)
  ...
  + [![HackerOne discloses employee data breach after Navia hack](data:image/gif;base64...)
  ...
  + [![Firefox now has a free built-in VPN with 50GB monthly data limit](data:image/gif;base64...)
  ...
  + [![Infinite Campus warns of breach after ShinyHunters claims data theft](data:image/gif;base64...)
  ...
  + [![Ajax football club hack exposed fan data, enabled ticket hijack](data:image/gif;base64...)
  ...
  + [![CISA: New Langflow flaw actively exploited to hijack AI workflows](data:image/gif;base64...)
  ...
  + [![Edit, convert, and sign PDFs without switching apps for just $40](data:image/gif;base64...)

    Edit, convert, and sign PDFs without switching apps for just $40](https://www.bleepingcomputer.com/offer/deals/edit-convert-and-sign-pdfs-without-switching-apps-for-just-40/)
  + [![UK sanctions Xinbi marketplace linked to Asian scam centers](data:image/gif;base64...)
...
[![ThreatLocker](https://www.bleepstatic.com/c/t/tl-970.jpg)](https://www.threatlocker.com/because-a-fast-response-isnt-fast-enough?utm_source=bleeping_computer&utm_medium=sponsor&utm_campaign=not_fast_enough_financial_3-26&utm_content=not_fast_enough_financial-970x250&utm_term=display)

* [Home](https://www.bleepingcomputer.com/)
* [News](https://www.bleepingcomputer.com/news/)
* [Software](https://www.bleepingcomputer.com/news/software/)
* WhatsApp rolls out more AI features, iOS multi-account support
...
![WhatsApp](https://www.bleepstatic.com/content/hl-images/2026/03/26/whatsapp.jpg)

WhatsApp is rolling out multiple features designed to make the app easier to use, including AI-powered mes...