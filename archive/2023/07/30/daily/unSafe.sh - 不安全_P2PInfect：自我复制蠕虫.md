...
url: https://buaq.net/go-173190.html
source: unSafe.sh - 不安全
date: 2023-07-30
fetch_date: 2025-10-04T11:51:15.351504
---
...
![](https://8aqnet.cdn.bcebos.com/5dd0a0ce3b5b6d5ff1f2f5b900ff0140.jpg)

P2PInfect：自我复制蠕虫

导语：2023年7月11日，Unit 42
*2023-7-29 12:0:0
Author: [www.4hou.com(查看原文)](/jump-173190.htm)
阅读量:51
收藏*
...
P2PInfect蠕虫功能复杂设计先进，其中的关键是使用Rust语言，具备了灵活性功能，允许蠕虫在多个操作系统中快速传播。

设计和构建P2P网络来执行恶意软件的自动传播，在云目标或加密劫持领域并不常见。同时，研究人员认为它的目的是在多个平台上攻击和支持尽可能多的Redis易受攻击的实例。

研究人员在多个地理区域的HoneyCloud平台上捕获了几个样本，认为P2P节点的数量正在增长。这是由于潜在目标的数量非常多，在过去两周内，超过30.7万个Redis实例公开通信，另外，蠕虫能够在不同地区危害研究人员的多个Redis蜜罐。目前，研究人员还没有估计存在多少节点，也没有估计与P2PInfect相关的恶意网络的增长速度。

研究人员建议组织监控所有Redis应用程序，包括本地应用程序和云环境中的应用程序，以确保它们在/tmp目录中不包含随机文件名。此外，DevOps人员应持续监控其Redis实例，以确保其维护合法操作和网络访问。所有Redis实例也应更新到其最新版本，或更新到redis/5:6.0.16-1+deb11u2, redis/5:5.0.14-1+deb10u2, redis/5:6.0.16-2 and redis/5:7.0~rc2-2。

本文翻译自：https://unit42.paloaltonetworks.com/peer-to-peer-worm-p2pinfect/如若转载，请注明原文地址
...
![](https://www.4hou.com/captcha/flat?ncoYJHpg)
