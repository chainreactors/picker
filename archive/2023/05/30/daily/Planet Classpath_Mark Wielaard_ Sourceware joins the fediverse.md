---
title: Mark Wielaard: Sourceware joins the fediverse
url: https://gnu.wildebeest.org/blog/mjw/2023/05/30/sourceware-joins-the-fediverse/
source: Planet Classpath
date: 2023-05-30
fetch_date: 2025-10-04T11:38:23.336438
---

# Mark Wielaard: Sourceware joins the fediverse
...
A few weeks back [Sourceware](https://sourceware.org/) [joined](https://sfconservancy.org/news/2023/may/15/sourceware-joins-sfc/) the [Software Freedom Conservancy](https://sfconservancy.org/). This week Sourceware joins the fediverse at [@sourceware@fosstodon.org](https://fosstodon.org/%40sourceware).

The account will be used for Sourceware announcements, notices about downtime and temporary issues with our network.

Sourceware is [run by volunteers](https://sourceware.org/mission.html#organization) who can be contacted on the public [overseers@sourceware.org](https://sourceware.org/mailman/listinfo/overseers) mailinglist [[inbox]](https://inbox.sourceware.org/overseers/).

Or you can file an issue in the Sourceware Infrastructure bugzilla [component](https://sourceware.org/bugzilla/buglist.cgi?product=sourceware&component=Infrastructure).

There is also an irc channel [#overseers](https://web.libera.chat/?channel=#overseers) on *irc.libera.chat*. *Overseers Open Office* hours take place in the same irc channel every second Friday of the month at UTC 18:00.
...
[Checking usage of realloc with Valgrind](https://gnu.wildebeest.org/blog/mjw/2023/07/26/checking-usage-of-realloc-with-valgrind/) »
