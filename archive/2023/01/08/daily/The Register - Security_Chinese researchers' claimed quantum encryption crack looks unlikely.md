...
url: https://go.theregister.com/feed/www.theregister.com/2023/01/07/chinese_researchers_claimed_quantum_encryption/
source: The Register - Security
date: 2023-01-08
fetch_date: 2025-10-04T03:20:29.220525
---
...
[The paper](https://arxiv.org/abs/2212.12372), titled "Factoring integers with sublinear resources on a superconducting quantum processor," suggests that the application of Claus Peter Schnorr's [recent factoring algorithm](https://eprint.iacr.org/2021/933), in conjunction with a quantum approximate optimization algorithm ([QAOA](https://arxiv.org/abs/1411.4028)), can break asymmetric RSA-2048 encryption using a non-fault tolerant ([NISQ](https://en.wikipedia.org/wiki/Noisy_intermediate-scale_quantum_era), or noisy intermediate scale quantum) quantum computer with only 372 physical quantum bits or qubits.

[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg_security/front&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aOA...