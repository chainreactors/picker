---
title: vopono v0.10.21
url: https://kitploit.com/en/posts/github-jamesmcm-vopono-01021
source: Kitploit
date: 2026-08-22
fetch_date: 2026-08-23T02:56:59.015740
---
...
![](https://assets.kitploit.com/production/public/tools/5265/aa672d08e07533568bf45fd05ddd36de42d564de81fc76add6e50226ae4617e7.png)
...
![vopono logo](https://assets.kitploit.com/production/public/readmes/5265/aa672d08e07533568bf45fd05ddd36de42d564de81fc76add6e50226ae4617e7.png)
...
also supported (e.g. for enterprise VPNs). See the [vopono User Guide](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md) for more details.
...
![Screenshot](https://assets.kitploit.com/production/public/readmes/5265/c4898ce83b031c07d44c6a1cef68d645871c949f5b8653173b18afd459662def.png)
...
\*\* See the [User Guide](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md) for authentication instructions for generating the OpenVPN config files via `vopono sync`. You must copy the authentication header of the form `AUTH-xxx=yyy` where `yyy` is the value of the `x-pm-uid` header in the same request when logged in, in your web browser.

\*\*\* For ProtonVPN you can generate and download specific Wireguard config
files, and use them as a custom provider config. See the [User Guide](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md)
...
running as a systemd service, etc. see the [User Guide](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md).
...
See [USERGUIDE.md](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md) for a ready‑to‑copy systemd unit.
...
See the [vopono User Guide](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md) for much more detailed usage instructions
...
![Raspbian Screenshot](https://assets.kitploit.com/production/public/readmes/5265/7c00ae9eb8b7dde91ddc3966dd2c98f93ef14ee47e7b702fbbe52aaf4c837fca.png)
...
Check the [User Guide](https://github.com/jamesmcm/vopono/blob/HEAD/USERGUIDE.md) for details on port forwarding and
using vopono with daemons ...