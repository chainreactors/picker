---
title: UNetLab: the evolution of iou-web
url: https://www.adainese.it/blog/2024/07/22/unetlab-the-evolution-of-iou-web/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-21
fetch_date: 2025-10-02T20:28:54.479833
---
...
In 2013, I realized that iou-web was too limited. I needed a “unified” approach to emulate a network, including firewalls, load balancers, a

In 2013, I realized that iou-web was too limited. I needed a “unified” approach to emulate a network, including firewalls, load balancers, and more. Additionally, multicasting using IOL was problematic. I had several new prerequisites:

* Include vendor virtual appliances in labs.
* Integrate real IOS images in labs.
* Possibly include emulators from different vendors.
* Support multi-user environments.

Continue reading
[the post on Patreon](https://www.patreon.com/posts/unetlab-of-iou-108584286)
.
