---
title: multi-juicer v10.3.1
url: https://kitploit.com/en/posts/github-juice-shop-multi-juicer-v1031
source: Kitploit
date: 2026-09-03
fetch_date: 2026-09-04T06:42:35.448300
---
...
![](https://assets.kitploit.com/production/public/tools/6750/a5724f1f98d4c9441111d762bd78f56662ca96fef2fbf7fa15f4e433cc695bc2.png)
...
![MultiJuicer, Multi User Juice Shop Platform](https://raw.githubusercontent.com/juice-shop/multi-juicer/HEAD/images/multijuicer-cover.svg)
...
![MultiJuicer, High Level Architecture Diagram](https://raw.githubusercontent.com/juice-shop/multi-juicer/HEAD/images/high-level-architecture.svg)

For a detailed description of the architecture and individual components, see the [Architecture Documentation](https://github.com/juice-shop/multi-juicer/blob/main/ARCHITECTURE.md).

> 👉 **New to MultiJuicer?** See the [visual walkthrough](https://github.com/juice-shop/multi-juicer/blob/main/guides/walkthrough/walkthrough.md) for how participants register, get their JuiceShop instances and how the scores are tracked on the scoreboard.
...
See [production notes](https://github.com/juice-shop/multi-juicer/blob/main/guides/production-notes/production-notes.md) for a checklist of values you'll likely need to configure before using MultiJuicer in proper events.

To setup MultiJuicer with support for the JuiceShop v20+ AI/LLM realted challenges, see [AI/LLM configuration guide](https://github.com/juice-shop/multi-juicer/blob/main/guides/llm/llm.md)
...
* [Digital Ocean](https://github.com/juice-shop/multi-juicer/blob/main/guides/digital-ocean/digital-ocean.md)
* [AWS](https://github.com/juice-shop/multi-juicer/blob/main/guides/aws/aws.md)
* [OpenShift](https://github.com/juice-shop/multi-juicer/blob/main/guides/openshift/openshift.md)
* [Plain Kubernetes](https://github.com/juice-shop/multi-juicer/blob/main/guides/k8s/k8s.md)
* [Azure](https://github.com/juice-shop/multi-juicer/blob/main/guides/azure/azure.md)
...
You can find the default config values under: [helm/multi-juicer/values.yaml](https://github.com/juice-shop/multi-juicer/blob/main/helm/multi-juicer/values.yaml)
...
To customize the theming of the JuiceShop instances and the MultiJuicer UI (theme, logo, enabled challenges, ...), see the [JuiceShop customization guide](https://github.com/juice-shop/multi-juicer/blob/main/guides/customization/customization.md).
...
* *1GB memory & 1CPU overhead*, for MultiJuicer itself
* *300MB & 0.2CPU \* number of participants / teams*, for the individual JuiceShop Instances
...
You can reach us in the `#project-juiceshop` channel of the OWASP Slack Workspace. We'd love to hear any feedback or usage reports you got. If you are not already in the OWASP Slack Workspace, you can join vi...