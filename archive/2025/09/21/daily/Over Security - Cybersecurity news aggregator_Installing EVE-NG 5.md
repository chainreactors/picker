---
title: Installing EVE-NG 5
url: https://www.adainese.it/blog/2024/07/27/installing-eve-ng-5/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-21
fetch_date: 2025-10-02T20:29:02.592453
---
...
EVE-NG is installed from packages downloaded from the
[official repository](http://www.eve-ng.net/focal)
 via APT. All the following commands should be executed by the **root** user via SSH.
...
Next, we can reload the repositories, upgrade the system, and install
[EVE-NG CE](https://www.eve-ng.net/index.php/community/)
 along with other packages we will use later:
...
Continue reading
[the post on Patreon](https://www.patreon.com/posts/installing-eve-5-108920885)
.
