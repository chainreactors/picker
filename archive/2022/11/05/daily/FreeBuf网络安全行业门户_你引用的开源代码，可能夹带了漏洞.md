---
title: 你引用的开源代码，可能夹带了漏洞
url: https://www.freebuf.com/articles/network/345163.html
source: FreeBuf网络安全行业门户
date: 2022-11-05
fetch_date: 2025-10-03T21:45:33.764846
---
...
![](https://image.3001.net/images/20220921/1663746647_632ac257d62e6ef605d34.png!small)
...
* 需要定位的目标是一个SIGALG\_LOOKUP \*类型变量和一个if块；
* 变量在if同一层代码块中定义或赋值；
...
![](https://image.3001.net/images/20220921/1663746666_632ac26adff9d2316c0de.png!small)
...
![](https://image.3001.net/images/20220921/1663746686_632ac27ed3542caa7ad6a.png!small)

![](https://image.3001.net/images/20220921/1663746702_632ac28ede780553a1656.png!small)

### 3.3. 关键语法节点的查询条件表述

![](https://image.3001.net/images/20220921/1663746724_632ac2a40f2888bc691b1.png!small)

### 3.4. 查询条件筛选与规则优化

![](https://image.3001.net/images/20220921/1663746745_632ac2b9f084fd7d6ec20.png!small)
...
![](https://image.3001.net/images/20220921/1663746759_632ac2c723929647ec47a.png!small)

由此可见，该商业方案确实是采用按片段相似度确定与某些历史版本的最大似然成分的。但可能由于知识库（KB）难以持续、细粒度更新，参与到相似度判定的代码片段也并不完整、缺少一定的模糊性，导致判定出的最大似然度的版本也只有1.7...