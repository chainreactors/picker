---
title: Global Police Operation Shuts Down 600 Cybercrime Servers Linked to Cobalt Strike
url: https://thehackernews.com/2024/07/global-police-operation-shuts-down-600.html
source: The Hacker News
date: 2024-07-05
fetch_date: 2025-10-06T17:51:21.022604
---
...
**Jul 04, 2024**Ravie LakshmananMalware / Cyber Attack

[![Cobalt Strike Servers](data:image/png;base64... "Cobalt Strike Servers")](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjlf6GtEhZl8dfQAnzp0661l3PWA7AJuZJj-jT2D_J8FWi3045L0worLiaayRMflAHNruXZDPPauYJfECA9N5ibf9ZxotZY_f-L5SKBo_FU1DdJb__YsTXuoDn_4zK35QtG7u79rGhsvxIVrPPE-NmR07C7CEfThzN_EFlGeSYCEksUdS_G0245HLlOb4fD/s790-rw-e365/crime-map.png)
...
The [crackdown](https://www.europol.europa.eu/media-press/newsroom/news/europol-coordinates-global-action-against-criminal-abuse-of-cobalt-strike) targeted older, unlicensed versions of the Cobalt Strike red teaming framework between June 24 and 28, according to Europol.
...
However, as previously observed by [Google](https://thehackernews.com/2022/11/google-identifies-34-cracked-versions.html) and [Microsoft](https://thehackernews.com/2023/04/microsoft-takes-legal-action-to-disrupt.html), cracked versions of the software have found their way into the hands of malicious actors, who have time-and-again abused it for post-exploitation purposes.
...
Data [shared](https://www.trellix.com/blogs/research/disrupting-cobalt-strike-with-threat-intelligence/) by Trellix shows that the U.S., India, Hong Kong, Spain, and Canada account for over 70% of the countries targeted by threat actors using Cobalt Strike. A majority of the Cobalt Strike infrastructure is hosted in China, the U.S., Hong Kong, Russia, and Singapore.

According to a [recent report](https://unit42.paloaltonetworks.com/attackers-exploit-public-cobalt-strike-profiles/) from Palo Alto Networks Unit 42, attacks involving the tool make use of a payload called Beacon, which uses text-based profiles called Malleable C2 to alter the characteristics of Beacon's web traffic in an attempt to avoid detection.

"Although Cobalt Strike is a legitimate piece of software, sadly cybercriminals have exploited its use for nefarious purposes," Paul Foster, director of threat leadership at the NCA, [said](https://www.nationalcrimeagency.gov.uk/news/national-crime-agency-leads-international-operation-to-degrade-illegal-versions-of-cobalt-strike) in a statement.
...
"Using a blend of fraudulent phone calls and social engineering, the criminals are responsible for €2,500,000 in losses," Europol [said](https://www.europol.europa.eu/media-press/newsroom/news/call-blocked-hard-and-fast-action-against-54-spanish-phone-fraudsters) earlier this week.
...
"Victims worked 12-hour workdays, extended to 14 hours if they failed to recruit others, and had their documents confiscated," the agency [said](https://www.interpol.int/en/News-an...