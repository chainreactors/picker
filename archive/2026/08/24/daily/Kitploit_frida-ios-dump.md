...
url: https://kitploit.com/en/tools/github/alonemonkey/frida-ios-dump
source: Kitploit
date: 2026-08-24
fetch_date: 2026-08-25T02:59:12.304677
---
...
frida-ios-dump — Extracts decrypted IPA files from jailbroken iOS devices using Frida for reverse engineering, security analysis, and mobile app pentesting. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/alonemonkey/frida-ios-dump

![](https://assets.kitploit.com/production/public/tools/50811/f2e9552f70413b5f151739707e9e2d35a64611bda0db0c12c90465681e50ac68-display-v1.webp)

[Encryption/Decryption Tools](/en/categories/encryption-decryption-tools)[iOS Security](/en/categories/ios-security)[Mobile App Pentesting](/en/categories/mobile-app-pentesting)[Reverse Engineering](/en/categories/reverse-engineering)[Mobile Forensics](/en/categories/mobile-forensics)[Penetration Testing](/en/categories/penetration-testing)[Mobile Security](/en/categories/mobile-security)[Top in iOS Security #6](/en/categories/ios-security)[Top in Mobile App Pentesting #13](/en/categories/mobile-app-pentesting)[Top in Mobile Forensics #13](/en/categories/mobile-forensics)

3.9k7363 years ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
[Top in Mobile Security #13](/en/categories/mobile-security)

![GitHub](/providers/github.png)alonemonkey/frida-ios-dump
...
[View Repository](https://github.com/alonemonkey/frida-ios-dump)
...
For SSH/SCP make sure you have your public key added to the target device's ~/.ssh/authorized\_keys file.
...
[Download Tool](https://github.com/alonemonkey/frida-ios-dump)