...
date: 2026-02-14
fetch_date: 2026-02-15T04:26:20.975060
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Fake job recruiters hide malware in developer coding challenges](data:image/gif;base64...)
  ...
  + [![Claude LLM artifacts abused to push Mac infostealers in ClickFix attack](data:image/gif;base64...)
  ...
  + [![CISA flags critical Microsoft SCCM flaw as exploited in attacks](data:image/gif;base64...)
  ...
  + [![Critical BeyondTrust RCE flaw now exploited in attacks, patch now](data:image/gif;base64...)
  ...
  + [![One threat actor responsible for 83% of recent Ivanti RCE attacks](data:image/gif;base64...)
  ...
  + [![Snail mail letters target Trezor and Ledger users in crypto-theft attacks](data:image/gif;base64...)
  ...
  + [![Pay once and get 1TB of Koofr cloud storage for life](data:image/gif;base64...)

    Pay once and get 1TB of Koofr cloud storage for life](https://www.bleepingcomputer.com/offer/deals/pay-once-and-get-1tb-of-koofr-cloud-storage-for-life/)
  + [![Fake job recruiters hide malware in developer coding challenges](data:image/gif;base64...)
...
Threat actors are sending physical letters pretending to be from Trezor and Ledger, makers of cryptocurrency hardware wallets, to...