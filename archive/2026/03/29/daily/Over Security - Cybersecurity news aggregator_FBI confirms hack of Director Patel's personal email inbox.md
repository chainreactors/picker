...
date: 2026-03-29
fetch_date: 2026-03-30T04:46:48.763096
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![European Commission investigating breach after Amazon cloud account hack](data:image/gif;base64...)
  ...
  + [![Fake VS Code alerts on GitHub spread malware to developers](data:image/gif;base64...)
  ...
  + [![Backdoored Telnyx PyPI package pushes malware hidden in WAV audio](data:image/gif;base64...)
  ...
  + [![FBI confirms hack of Director Patel's personal email inbox](data:image/gif;base64...)
  ...
  + [![File read flaw in Smart Slider plugin impacts 500K WordPress sites](data:image/gif;base64...)
  ...
  + [![Stop paying monthly for PDF software and get lifetime access for $70](data:image/gif;base64...)

    Stop paying monthly for PDF software and get lifetime access for $70](https://www.bleepingcomputer.com/offer/deals/stop-paying-monthly-for-pdf-software-and-get-lifetime-access-for-70/)
  + [![New Infinity Stealer malware grabs macOS data via ClickFix lures](data:image/gif;base64...)
...
![](https://www.bleepstatic.com/content/hl-images/2026/03/29/Iran_personal_email_hack.png)

The Handala hackers associated with Iran have breached the personal email account of FBI Director K...