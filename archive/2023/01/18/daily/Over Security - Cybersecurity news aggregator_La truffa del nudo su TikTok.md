---
title: La truffa del nudo su TikTok
url: https://hackerjournal.it/11191/la-truffa-del-nudo-su-tiktok/
source: Over Security - Cybersecurity news aggregator
date: 2023-01-18
fetch_date: 2025-10-04T04:13:56.092848
---

# La truffa del nudo su TikTok
...
I malintenzionati sfruttano una challenge virale su TikTok per rubare dati, password e carte di credito degli utenti
...
![](https://hackerjournal.it/wp-content/uploads/2023/01/maxresdefault.jpg)

* Share
* Tweet

Tutto nasce da una challenge apparsa sul social. **Invisible Body**, **questo è il sul nome, sfiderebbe gli utenti a riprendersi nudi con lo smartphone, utilizzando però un filtro per dare un effetto sfocato all’immagine**. Nello stesso momento, un filmato sponsorizza un software in grado di rimuovere l’effetto sfocato e di mostrare i corpi nudi. L’applicativo, ovviamente, oltre a non mantenere le promesse nascondeva un pericoloso **[malware](https://hackerjournal.it/encyclopedia/malware/)** al suo interno. A scoprirlo è stata la società di sicurezza informatica **[Checkmarx](https://checkmarx.com/)**, secondo la quale l’**Invisible Body Challenge** **avrebbe raggiunto una popolarità tale da renderla vulnerabile ad attacchi informatici**. Nello specifico, due video diffusi su [TikTok](https://www.tiktok.com/) sponsorizzavano questo software e i ricercatori hanno scoperto che, una volta effettuati i passaggi indicati nel filmato, **il malcapitato finiva in una chat non identificata e in automatico veniva installato sul proprio dispositivo il [malware](https://hackerjournal.it/encyclopedia/malware/ "Malware o “software malevolo” è un termine generico che descrive un programma/codice dannoso che mette a rischio un sistema.") WASP Stealer in grado di sottrarre informazioni sensibili**.

Related Topics:[Invisible Body](https://hackerjournal.it/tag/invisible-body/)[Malware](https://hackerjournal.it/tag/malware/)[Social](https://hackerjournal.it/tag/social/)[TikTok](https://hackerjournal.it/tag/tiktok/)[Truffa](https://hackerjournal.it/tag/truffa/)[WASP Stealer](https://hackerjournal.it/tag/wasp-stealer/)
