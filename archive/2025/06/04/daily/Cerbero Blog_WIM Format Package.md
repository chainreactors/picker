---
title: WIM Format Package
url: https://blog.cerbero.io/wim-format-package/
source: Cerbero Blog
date: 2025-06-04
fetch_date: 2025-10-06T22:51:55.428445
---
...
We’re excited to announce the release of the [WIM Format package](https://cerbero.io/packages/wimformat/), which adds support for the Windows Imaging (WIM) file format.

![](/wp-content/uploads/2025/06/wim.png)
...
Additionally, when used in conjunction with the [ISO Format package](https://cerbero.io/packages/isoformat/), it’s possible to seamlessly access WIM images embedded within ISO files—making the analysis of Windows installation media even more efficient.

![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [June 3, 2025](https://blog.cerbero.io/wim-format-package/)Categories [Package](https://blog.cerbero.io/category/package/)Tags [Installation](https://blog.cerbero.io/tag/installation/), [Setup](https://blog.cerbero.io/tag/setup/), [windows](https://blog.cerbero.io/tag/windows/)

## Leave a Reply [Cancel reply](/wim-format-package/#respond)
...
[Previous Previous post: HFS+ File System](https://blog.cerbero.io/hfs-file-system/)

[Next Next post: Cerbero Suite 8.4](https://blog.cerbero.io/cerbero-suite-8-4/)
