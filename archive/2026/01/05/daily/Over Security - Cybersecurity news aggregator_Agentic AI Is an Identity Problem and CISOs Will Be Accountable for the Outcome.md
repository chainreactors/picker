...
url: https://www.bleepingcomputer.com/news/security/agentic-ai-is-an-identity-problem-and-cisos-will-be-accountable-for-the-outcome/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-05
fetch_date: 2026-01-06T03:27:59.945080
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Ledger customers impacted by third-party Global-e data breach](data:image/gif;base64...)
  ...
  + [![ClickFix attack uses fake Windows BSOD screens to push malware](data:image/gif;base64...)
  ...
  + [![NordVPN denies breach claims, says attackers have ](data:image/gif;base64...)
  ...
  + [![New GlassWorm malware wave targets Macs with trojanized crypto wallets](data:image/gif;base64...)
  ...
  + [![ClickFix attack uses fake Windows BSOD screens to push malware](data:image/gif;base64...)
    ...
    ClickFix attack uses fake Windows BSOD screens to push malware](https://www.bleepingcomputer.com/news/security/clickfix-attack-uses-fake-windows-bsod-screens-to-push-malware/)
  + [![US broadband provider Brightspeed investigates breach claims](data:image/gif;base64...)
  ...
  + [![VSCode IDE forks expose users to ](data:image/gif;base64...)
...
###### [Token Security](https://www.token.security/book-a-demo?utm_source=3rd-party&utm_medium=bleepingcomputer&utm_campaign=bleepingcomputer&utm_content=jan-5)

* January 5, 2026
* 10:05 AM
* [0](#comment_form)

![CISOs on the line header](https://www.bleepstatic.com/content/posts/2026/01/05/token-security-cisos-on-the-line.jpg)

*By Itamar Apelblat, CEO & Co-founder, Token Security*

If you are a CISO today, agentic AI probably feels familiar in an uncomfortable way. The technology is new, but the pattern is not. Business leaders are pushing hard to deploy AI agents across the organization, while security tea...