---
title: LastPass was undone by an attack on a remote employee
url: https://www.malwarebytes.com/blog/news/2023/03/lastpass-breach-investigation-reveals-remote-work-weak-link
source: Over Security - Cybersecurity news aggregator
date: 2023-03-03
fetch_date: 2025-10-04T08:35:38.858848
---
...
![LastPass](https://www.malwarebytes.com/wp-content/uploads/sites/2/2023/03/easset_upload_file1863_260702_e.png?w=736)
...
Last August, LastPass suffered a well publicised breach: Developer systems were [compromised and source code stolen](https://www.bleepingcomputer.com/news/security/lastpass-developer-systems-hacked-to-steal-source-code/). This resulted in a second breach in November, which was [revealed by LastPass in December](https://www.theverge.com/2022/12/28/23529547/lastpass-vault-breach-disclosure-encryption-cybersecurity-rebuttal). The company has now [revealed](https://support.lastpass.com/help/incident-2-additional-details-of-the-attack) that the individual(s) responsible for the attack also compromised a remote employee’s computer, in order to capture credentials used in the second attack.

The credentials allowed the attacker to steal data from Amazon AWS [cloud](https://www.malwarebytes.com/what-is-the-cloud) storage servers used by LastPass for [a little over two months](https://www.bleepingcomputer.com/news/security/lastpass-devops-engineer-hacked-to-steal-password-vault-data-in-2022-breach/).

The remote developer’s PC was reportedly compromised via a remote code execution vulnerability in a third-party media player, which was exploited to deploy a [keylogger](https://www.malwarebytes.com/keylogger). After this, the attacker was able to wait until the employee entered their master password and authenticated themselves with multi-factor [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication).
...
At the moment, there is *nothing you need to do if you have already followed the advice during the December breach reveal*. However, if you are only now finding out about the various LastPass bre...