---
title: conductai
url: https://kitploit.com/en/tools/github/sseshachala/conductai
source: Kitploit
date: 2026-08-28
fetch_date: 2026-08-29T08:30:59.072774
---
...
[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/sseshachala/conductai

![](https://assets.kitploit.com/production/public/tools/53453/79459352b949d63b35c41dbe1c0cdd39bf00d6e623f4afa193a42a10786b86dc-display-v1.webp)

[Cloud Security](/en/categories/cloud-security)[AI Security](/en/categories/ai-security)

![GitHub](/providers/github.png)sseshachala/conductai
...
[View Repository](https://github.com/sseshachala/conductai)[Website](https://conductai.ai)

21712h 47m ago![Not yet reviewed](/_next/image?url=%2Fbadges%2Fkitploit_badge_not_reviewed_full.png&w=48&q=75)
...
![Conduct — live run trace showing agent executing an issue-to-PR agent template](https://assets.kitploit.com/production/public/readmes/53453/79459352b949d63b35c41dbe1c0cdd39bf00d6e623f4afa193a42a10786b86dc/54011e45814b5101cbbac0230515483cd8da4640db38a20bdae6e0c3e72abef0-display-v1.webp)
...
* [SECURITY.md](https://github.com/sseshachala/conductai/blob/HEAD/SECURITY.md) — vulnerability reporting policy, scope, coordinated disclosure, and safe harbor.
* [Threat model](https://github.com/sseshachala/conductai/blob/HEAD/docs/threat-model.md) — system context, trust boundaries, attacker goals, mitigations, and residual risks.
* [Policy decision contract](https://github.com/sseshachala/conductai/blob/HEAD/docs/policy-decision-contract.md) — `guard_check` decision semantics and fail-mode behavior.
* [Audit log verification](https://github.com/sseshachala/conductai/blob/HEAD/docs/audit-log-verification.md) — independent `prev_hash`/`entry_hash` chain...