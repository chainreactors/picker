---
title: IFPS Format Package
url: https://blog.cerbero.io/ifps-format-package/
source: Cerbero Blog
date: 2024-08-13
fetch_date: 2025-10-06T18:03:50.752922
---
...
We have released the [IFPS Format package](https://cerbero.io/packages/ifpsformat/) for all licenses of Cerbero Suite. IFPS (RemObjects PascalScript) bytecode files are utilized by InnoSetup, a popular script-driven Windows installation system, to enhance the installer’s functionality through custom scripts and can potentially be used by malware to execute malicious code.

![](/wp-content/uploads/2024/08/ifps/0.png)

From the [developer’s page](https://www.remobjects.com):
...
![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [August 12, 2024August 12, 2024](https://blog.cerbero.io/ifps-format-package/)Categories [Package](https://blog.cerbero.io/category/package/)Tags [Disassembler](https://blog.cerbero.io/tag/disassembler/), [InnoSetup](https://blog.cerbero.io/tag/innosetup/), [Pascal](https://blog.cerbero.io/tag/pascal/), [Script](https://blog.cerbero.io/tag/script/)

## One thought on “IFPS Format Package”

1. Pingback: [InnoSetup Format Package – Cerbero Blog](https://blog.cerbero.io/innosetup-format-package/)

## Leave a Reply [Cancel reply](/ifps-format-package/#respond)
...
[Previous Previous post: Cerbero Journal Issue 5](https://blog.cerbero.io/cerbero-journal-issue-5/)

[Next Next post: InnoSetup Format Package](https://blog.cerbero.io/innosetup-format-package/)
