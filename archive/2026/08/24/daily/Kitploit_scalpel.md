---
title: scalpel
url: https://kitploit.com/en/tools/github/sleuthkit/scalpel
source: Kitploit
date: 2026-08-24
fetch_date: 2026-08-25T02:59:09.433445
---
...
scalpel — File carving and indexing tool for digital forensics, recovering files from disk images based on header/footer pattern matching, regular expressions, multithreading, and optional GPU-accelerated processing. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/sleuthkit/scalpel

![](https://assets.kitploit.com/production/public/tools/50804/8d654aee3bfa4b7861f44fbfb17542137c555c23f72e49c506b39f6d2693b0d3-display-v1.webp)

[Disk Forensics](/en/categories/disk-forensics)[Steganography](/en/categories/steganography)[Data Recovery](/en/categories/data-recovery)[Digital Forensics](/en/categories/digital-forensics)[Top in Data Recovery #6](/en/categories/data-recovery)[Top in Disk Forensics #16](/en/categories/disk-forensics)[Top in Steganography #15](/en/categories/steganography)

![GitHub](/providers/github.png)sleuthkit/scalpel

# scalpel

File carving and indexing tool for digital forensics, recovering files from disk images based on header/footer pattern matching, regular expressions, multithreading, and optional GPU-accelerated processing.

6871122 years ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
[View Repository](https://github.com/sleuthkit/scalpel)
...
[Download Tool](https://github.com/sleuthkit/scalpel)