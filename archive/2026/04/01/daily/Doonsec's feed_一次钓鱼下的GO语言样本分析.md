---
title: 一次钓鱼下的GO语言样本分析
url: https://mp.weixin.qq.com/s/weibRimV1em1aN1v9GDQLw
source: Doonsec's feed
date: 2026-04-01
fetch_date: 2026-04-02T04:27:04.726402
---

# 一次钓鱼下的GO语言样本分析

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/EYGYnyEdzQWonUvsoTmlPGp4q8TTLTS2EK4FPzCFOjBcTo3MzOAtSQK4XKo1Op68nSA000IWym9v9Xqib5tlmHLMlXN88rfzicfujghVp8GQ4/0?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/EYGYnyEdzQVhsRHBD13CSXJ67lQ9EMZiaq4EyW4OYuqTQu3ysiaK6w4rrbuIU8BC8joxicmcwt5ZTQcmAAfE7mNhxkgfUQhvAhvOnwa94piaF6Q/640?wx_fmt=png&from=appmsg)
...
![0](https://mmbiz.qpic.cn/mmbiz_png/EYGYnyEdzQVOqU27RkpfibcricBVSJ0HDTH936ZpIggOMnGdkK8UKYn4IQJ2X736l2EYqZeekVzhxtr4nuvdogwLBM9tOlc4myLL2lcqU1rt0/640?wx_fmt=png&from=appmsg)

初步判断恶意代码编写在三个导出函数中，把黑DLL放到IDA9.3版本自动反编译，然后使用快捷键Ctrl+F逐一寻找导出函数名，对了还有main\_init函数：

g\_assertion\_message\_expr函数

该函数存在大量加密字符，初步判断为恶意代码！

![0](https://mmbiz.qpic.cn/mmbiz_png/EYGYnyEdzQUlGTomrwaxF5cJpeUoU7Z6Rtok8pZ2Fn2OfIt2HZTCmOUNKUVHHNfumMibzRYYfvFHMuaQUGoXonznNvzj6bs0MbAxMvFDtww4/640?wx_fmt=png&from=appmsg)

main\_init函数

该函数调用了VirtualAlloc、RtlCopyMemory、赋值给了上面导出函数g\_assertion\_message\_expr执行！

![0](https://mmbiz.qpic.cn/sz_mmbiz_png/EYGYnyEdzQVdwBxkqL7kAdGsOiaYN6O640biaibfSPprbE6c6VCwm6BsVicicYosgCkpgtHfrfP4rg2A1OHaVzkoWwALLEl7hLicgicSvIEbr3mokg/640?wx_fmt=png&from=appmsg)
...
![0](https://mmbiz.qpic.cn/mmbiz_png/EYGYnyEdzQW6YibHiayYfD6TAR7vWOibztL6BbbicVUmCgsLaaZtjnIZBtMGtia3tCibI0WH0Nyibng5JqMmnIqe4iao8QAhxycPTOyLZOicLBcPKEicg/640?wx_fmt=png&from=appmsg)
