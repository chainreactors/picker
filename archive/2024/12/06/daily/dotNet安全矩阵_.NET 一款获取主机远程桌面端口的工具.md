---
title: .NET 一款获取主机远程桌面端口的工具
url: https://mp.weixin.qq.com/s?__biz=MzUyOTc3NTQ5MA==&mid=2247497261&idx=3&sn=36cd7fef9f973676c6861b293b606feb&chksm=fa5958c0cd2ed1d685f5c022e5f143eaed693c2447f0066833db42d98522ef9e1a4b8a28a76a&scene=58&subscene=0#rd
source: dotNet安全矩阵
date: 2024-12-06
fetch_date: 2025-10-06T19:39:19.037398
---

# .NET 一款获取主机远程桌面端口的工具

![cover_image](https://mmbiz.qpic.cn/mmbiz_jpg/NO8Q9ApS1Y8A7Qhn1ssuqNzv0iceS7ZhOqTFH01c6mwhLjcXkAt6CxoHl6J4UrZzgacgVVL93dtaf8zRZIicpdyg/0?wx_fmt=jpeg)
...
Sharp4GetRdpPort 是一款获取目标主机远程桌面服务端口号的实用工具，常应用于内网渗透测试中的信息收集环节。

![](https://mmbiz.qpic.cn/mmbiz_jpg/NO8Q9ApS1Y8A7Qhn1ssuqNzv0iceS7ZhOpWTV118vZqgcendkXMrGLtVpwj4JzPGgib3DBvazrWXeSv6H0SBfroQ/640?wx_fmt=jpeg&from=appmsg)

03

使用方法

与其他工具相比，Sharp4GetRdpPort 不需要管理员权限即可运行。普通用户权限下即可直接读取目标主机的 RDP 端口号，极大地降低了使用门槛，当前 RDP 使用端口号 3389，如下图所示，

![](https://mmbiz.qpic.cn/mmbiz_png/NO8Q9ApS1Y8A7Qhn1ssuqNzv0iceS7ZhOZ8ATHiattonVggJ51yR8pkVnjOBSmicPqr9iaU97bsnJEuNYMcPRbnSOQ/640?wx_fmt=png&from=appmsg)

但在实际环境中，管理员可能出于安全考虑对端口进行自定义修改，因此使用这款工具可以大大简化渗透中的任务。

04

原理解析

Sharp4GetRdpPort 的核心原理是通过读取目标主机注册表中的 Terminal Server 配置信息来提取 RDP 的具体端口号。工具通过以下注册表路径读取端口号
...
通过 Sharp4GetRdpPort，渗透测试人员可以快速准确地收集这些关键信息，为后续操作提供支持。文章涉及的工具已打包在星球，感兴趣的朋友可以加入自取。
...
[![](https://mmbiz.qpic.cn/mmbiz_jpg/NO8Q9ApS1Y8A7Qhn1ssuqNzv0iceS7ZhOuZ0AO4P1eFeG2xTdR2V6GWibiaxO2RenUJzrwOfvsdqofibI6H2uY0CLQ/640?wx_fmt=jpeg)](https://mp.weixin.qq.com/s?__biz=MzUyOTc3NTQ5MA==&mid=2247497195&idx=1&sn=cf64ddd96482f7e25aa18fcc7283afdb&scene=21#wechat_redirect)
