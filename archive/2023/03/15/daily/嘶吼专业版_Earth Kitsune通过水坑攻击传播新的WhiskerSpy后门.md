...
url: https://mp.weixin.qq.com/s?__biz=MzI0MDY1MDU4MQ==&mid=2247558674&idx=2&sn=919a59ea78b0e85fb8389ce79d7657de&chksm=e9143628de63bf3eff621376ea8c0a7494c8ca9b3aea7449cfd726f23290fe3936ae406f53b8&scene=58&subscene=0#rd
source: 嘶吼专业版
date: 2023-03-15
fetch_date: 2025-10-04T09:37:01.073971
---

# Earth Kitsune通过水坑攻击传播新的WhiskerSpy后门

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuWicQFUmz9ibNz1cvaXsMNmOy7kkplhe7nYOibiapkmL8WHyOKNtnMYlKsg/0?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuOd7oK9YFPEBTGSukKgo0pmFGVIuz3xAzJFbMA1IoVic0wINuQqqfz9Q/640?wx_fmt=png)WhiskerSpy感染链
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGutdxRjBTN5tp5wwA01nq57ZzOelrpJh12PwbZKcnbO74c9aiaRIhLFJg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuNB0ADPzJ6TZuNsHwDcZn94nTOibjbTAkfqYiaqaDoGjhUBw62vukUS6g/640?wx_fmt=png)

原始页面（左侧）和带有注入脚本的页面（右侧）之间的网页内容比较

该网站加载带有以下重定向代码的恶意JavaScript（popup.js）：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGu4zGy97iaQibLhxSicVQLmiaDiatK5uYMXXMr074iczZJPJqCoOg7tQbH7icqQ/640?wx_fmt=png)

嵌入式JavaScript重定向到恶意安装程序下载

# ![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuxnq3TheG4InYBE9uqgL8sSH50l2tTibCib5HcePnCKsp9BHoIEezbd8w/640?wx_fmt=png)修复安装程序
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGucLMUQDicTxhCoHxUFD4Yicev8vttkiaf4pg3nJ51BFvLNXasZxs86LFFw/640?wx_fmt=png)

原始（上）和修复（下）安装程序，在修复版本中某些参数的大小会增加

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGugQgicPsNKmurVFlNMmYZfBy4sb44184XvKsM76s050GYQVwlDyic6ebg/640?wx_fmt=png)

在修复的安装程序中新添加了.odata部分

修复后的安装程序的入口点被更改为立即跳转到shellcode。shellcode使用简单密钥(XOR 0x01)加密。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuTcqO0ZfkxYX6PsXicvIicqOTnhLianLCZbfOgSiaRJhHdojYHqZNLKrMuA/640?wx_fmt=png)

修复后的安装程序的入口点跳转到.odata部分的代码中

解密后，shellcode运行几个PowerShell命令来下载恶意软件的其他阶段。这些文件都是可执行文件，从一开始就有几百个字节，使用单字节密钥进行异或。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuW5GRF2l3zmwS3oWHOb2sjOrnZicv5icUibFbEic9keiaBmSmsBhcRFkl3eA/640?wx_fmt=png)

.odata部分中的Shellcode调用几个PowerShell命令来下载其他加载器

然后，它恢复原始入口点(总共15个字节)，以确保原始安装程序按预期运行。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGu1WMXA9J2zVCwBwfah9LKQtMribx3iajBkJUegZ6HnDxOCRYYOJpTZP2A/640?wx_fmt=png)

.odata部分中的Shellcode恢复安装程序的原始入口点

# ![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuxnq3TheG4InYBE9uqgL8sSH50l2tTibCib5HcePnCKsp9BHoIEezbd8w/640?wx_fmt=png)下载的二进制文件：加载器

**通过OneDrive持久化的路径（Icon.jpg）**

这包含路径\microsoft\onedrive\vcruntime140.dll，这是另一个下载文件（bg.jpg）以vcruntime140.dll的名称释放的位置。

# ![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuxnq3TheG4InYBE9uqgL8sSH50l2tTibCib5HcePnCKsp9BHoIEezbd8w/640?wx_fmt=png)持久性和加载器滥用OneDrive侧加载漏洞(Bg.jpg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGu6INo7ET7OUtpuVea9ITsoveTJoBPXPWHyO96R25mLJicpSQuVFswSZg/640?wx_fmt=png)

原始memset函数，注意地址0x18000C7D1处的指令返回（retn）

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuHicUJIb5icqVo1u7mPBFWicbITbFic8LoXA7GLyLPvMiaMEL1vkOHtjuH4w/640?wx_fmt=png)
...
# ![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuxnq3TheG4InYBE9uqgL8sSH50l2tTibCib5HcePnCKsp9BHoIEezbd8w/640?wx_fmt=png)持久性和加载程序使用恶意Google Chrome扩展(Favicon.jpg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuTC7UMvc1SBQDqNXVawiaDEAyYibdlUEGgb1zf2nBewMomKbrWZ6Xy9pQ/640?wx_fmt=png)

扩展清单，请注意扩展ID (allowed\_origins)路径导致被释放的可执行文件和type =标准输入/输出

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuUxph959ibceyuiawSrnSP9qbOtg0ptgJMFjK9icRaox3o9Vaa7Vib9UtTw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuceQ9TL2tTt5EgBOHaEicftNXeWHiaZia8Z9b6icGIC6F7m8LTO22eDFd6A/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuRtpR7WLPibBVU2iacXwh0x3Q8ryf77HeyhLib0pGicic4P8rRP5vZz3x4vg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuodRpV50szibCI7Pz6WNjibS0p5OwpRnB3tdQOoKiaagK12NIoKgLElX7w/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuFSuwaBTWdMh9NkQRzW44bhMVJe5iaDq4uxSR6pDUApLluYIeqGmHnyA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGuauE0XQKTCPEcQ9dzY3Thd2fAMj2XZowZtVHs1zcqZHSEllYliasZd5A/640?wx_fmt=png)

注册新计算机

随后上传带有客户端公钥的x坐标和加密的AES密钥的64字节文件(函数号= 1;POST请求:l

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2icP4v3hMwmb4NlEx1gqGRGulzVGnhzqZhrIPgHXJmwVyGmMUibWlr9GmqpJL37NFQzJ4TloFI1ePWg/64...