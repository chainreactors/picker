---
title: Warning: "FaceStealer" iOS and Android apps steal your Facebook login
url: https://www.malwarebytes.com/blog/news/2022/10/warning-facestealer-ios-and-android-apps-steal-your-facebook-login
source: Over Security - Cybersecurity news aggregator
date: 2022-10-20
fetch_date: 2025-10-03T20:25:23.814557
---
...
![Facebook login screen on a mobile phone](https://www.malwarebytes.com/wp-content/uploads/sites/2/2022/10/asset_upload_file39567_241247.jpg?w=736)
...
Earlier this month, security researchers from Meta [found](https://about.fb.com/news/2022/10/protecting-people-from-malicious-account-compromise-apps/) 400 malicious [Android](https://www.malwarebytes.com/cybersecurity/basics/how-to-clean-your-phone-from-virus) and iOS apps designed to steal user Facebook login credentials.

Such mobile [malware](https://www.malwarebytes.com/malware), which Malwarebytes [detects](https://www.malwarebytes.com/for-home) typically as **Android/Trojan.Spy.Facestealer**, usually arrives as an app disguised as a useful or entertaining tool. But before the app can be fully used, it asks users to login to their accounts, at which point their usernames and passwords are sent to the fraudsters.
...
If the apps appear to have positive reviews, that’s because the developers are thought to be creating five-star reviews to bury the negative ones. This is a known [social engineering](https://www.malwarebytes.com/social-engineering) tactic to entice users further to try an app.
...
If you think you’ve entereed your Facebook credentials into a dodgy app, change your password immediately. Don’t reuse passwords you use on other accounts, and make sure you enable two-factor [authentication](https://www.malwarebytes.com/cybersecurity/basics/what-is-authentication) ([2FA](https://www.malwarebytes.com/cybersecurity/basics/2fa)) on your Facebook account. You can also let Facebook alert you of attempted log-ins to your account.

Finally, report all suspicious apps using Meta’s [Data Abuse Bounty program](https://www.facebook.com/data-abuse/report).

**SHARE THIS ARTICLE**

[![X](https://www.malwarebytes.com/wp-content/themes/malwarebytes/assets/src/images/x-twitter-logo-grey.svg)](https://x.com...