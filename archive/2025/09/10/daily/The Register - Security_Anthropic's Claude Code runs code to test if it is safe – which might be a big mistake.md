---
title: Anthropic's Claude Code runs code to test if it is safe – which might be a big mistake
url: https://go.theregister.com/feed/www.theregister.com/2025/09/09/ai_security_review_risks/
source: The Register - Security
date: 2025-09-10
fetch_date: 2025-10-02T19:56:37.212897
---
...
[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg_security/front&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aN5ocwNuwVW7J3M_XuFCIgAAAdU&t=ct%3Dns%26unitnum%3D2%26raptor%3Dcondor%26pos%3Dtop%26test%3D0)](https://pubads.g.doubleclick.net/gampad/jump?co=1&iu=/6978/reg_security/front&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aN5ocwNuwVW7J3M_XuFCIgAAAdU&t=ct%3Dns%26unitnum%3D2%26raptor%3Dcondor%26pos%3Dtop%26test%3D0)

#### [Security](/security/)

[**15**
![comment bubble on white](/design_picker/f5daacc84b9722c1e31ba85f836c37e4ad993fc4/graphics/icons/bubble_comment_white.png)](https://forums.theregister.com/forum/all/2025/09/09/ai_security_review_risks/ "View comments on this article")
...
Anthropic introduced [automated security reviews](https://www.anthropic.com/news/automate-security-reviews-with-claude-code) in Claude Code last month, promising to ensure that "no code reaches production without a baseline security review." The AI-driven review checks for common vulnerability patterns including authentication and authorization flaws, insecure data handling, dependency vulnerabilities, and SQL injection.

Checkmarx [reported](https://checkmarx.com/zero-post/bypassing-claude-code-how-easy-is-it-to-trick-an-ai-security-reviewer/) that the /security-review command in Claude Code was successful in finding simple vulnerabilities such as XSS (cross-site scripting) and even an authorization bypass issue that many static analysis tools might miss. However, it was defeated by a remote code execution vulnerability using the Python data analysis library pandas, and wrongly concluded it was a false positive.

[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg_s...