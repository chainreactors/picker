...
url: https://go.theregister.com/feed/www.theregister.com/2023/02/15/apple_patches_zeroday_vulnerability/
source: The Register - Security
date: 2023-02-16
fetch_date: 2025-10-04T06:49:20.398401
---
...
[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg_security/patches&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aOBS7lA5Zphf0iPTbK_ndQAAAAU&t=ct%3Dns%26unitnum%3D2%26raptor%3Dcondor%26pos%3Dtop%26test%3D0)](https://pubads.g.doubleclick.net/gampad/jump?co=1&iu=/6978/reg_security/patches&sz=300x50%7C300x100%7C300x250%7C300x251%7C300x252%7C300x600%7C300x601&tile=2&c=2aOBS7lA5Zphf0iPTbK_ndQAAAAU&t=ct%3Dns%26unitnum%3D2%26raptor%3Dcondor%26pos%3Dtop%26test%3D0)

#### [Patches](/security/patches/)

[**7**
![comment bubble on white](/design_picker/f5daacc84b9722c1e31ba85f836c37e4ad993fc4/graphics/icons/bubble_comment_white.png)](https://forums.theregister.com/forum/all/2023/02/15/apple_patches_zeroday_vulnerability/ "View comments on this article")
...
Updates macOS 13.2.1, iOS 16.3.1, iPadOS 16.3.1, and Safari 16.3.1 fix the flaw, tracked as [CVE-2023-23529](https://github.com/advisories/GHSA-27h2-hvpr-p74q), which may allow maliciously crafted web content to execute arbitrary code. It's described by Apple as a type confusion flaw fixed by improved checks.

The issue had to do with [JsonWebToken code](https://github.com/auth0/node-jsonwebtoken/commit/e1fa9dcc12054a8681db4e6373da1b30cf7016e3) that accepted asymmetric encryption keys not associated with a specific algorithm through the [`jwt.verify()`](https://github.com/auth0/node-jsonwebtoken#jwtverifytoken-secretorpublickey-options-callback) function. For example, DSA keys could be used with the [RS256 algorithm](https://auth0.com/blog/rs256-vs-hs256-whats-the-difference/). This evidently permitted signature verification with insecure key types.
