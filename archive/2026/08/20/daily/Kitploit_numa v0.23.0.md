---
title: numa v0.23.0
url: https://kitploit.com/en/posts/github-razvandimescu-numa-v0230
source: Kitploit
date: 2026-08-20
fetch_date: 2026-08-21T03:02:47.698775
---
...
![](https://assets.kitploit.com/production/public/tools/13090/5d6f10865bf168b1b4d4b8a8223ff961e66cfc2fe7f91754e71f105f2f921cc0.gif)
...
Add path-based routing (`app.numa/api → :5001`), share services across machines via LAN discovery, or configure everything in [`numa.toml`](https://github.com/razvandimescu/numa/blob/HEAD/numa.toml).
...
* [`packaging/client/`](https://github.com/razvandimescu/numa/blob/HEAD/packaging/client/) — ODoH client mode (anonymous DNS), Numa + starter `numa.toml`.
* [`packaging/relay/`](https://github.com/razvandimescu/numa/blob/HEAD/packaging/relay/) — public ODoH relay, Numa + Caddy + ACME.
