...
date: 2026-06-02
fetch_date: 2026-06-03T06:46:47.445757
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Critical Windows Netlogon RCE flaw now exploited in attacks](data:image/gif;base64...)
  ...
  + [![ChatGPT share links abused to host fake outage pages to deliver malware](data:image/gif;base64...)
  ...
  + [![Palo Alto GlobalProtect VPN auth bypass flaw now exploited in attacks](data:image/gif;base64...)
  ...
  + [![Microsoft fixes outage affecting MFA setup, MySignIn service](data:image/gif;base64...)
  ...
  + [![Microsoft's Coreutils project brings Linux commands to Windows](data:image/gif;base64...)
  ...
  + [![OpenAI upgrades GPT-5.5, as it plans to retire legacy ChatGPT models](data:image/gif;base64...)
  ...
  + [![Critical Kirki flaw exploited to hijack WordPress admin accounts](data:image/gif;base64...)
  ...
  + [![Over 116,000 Minecraft systems infected in WeedHack malware campaign](data:image/gif;base64...)
...
###### [Push Security](https://pushsecurity.com/demo/?utm_source=bleeping-computer&utm_medium=sponsored-content&utm_term=article)

* June 2, 2026
* 10:30 AM
* [0](#comment_form)

![Push Security](https://www.bleepstatic.com/content/posts/2026/06/01/Bleeping-Thumbnail.jpg)

Security teams are staring at two AI problems at once. Adversaries are using AI to iterate on phishing kits, generate lures, and rotate infrastructure faster than blocklists can follow. Employees are adopting AI tools faster than security teams can review them, pasting sens...