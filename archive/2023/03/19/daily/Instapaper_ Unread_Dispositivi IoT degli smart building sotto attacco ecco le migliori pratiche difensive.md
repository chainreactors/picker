---
title: Dispositivi IoT degli smart building sotto attacco ecco le migliori pratiche difensive
url: https://www.cybersecurity360.it/soluzioni-aziendali/dispositivi-iot-degli-smart-building-sotto-attacco-ecco-le-migliori-pratiche-difensive/
source: Instapaper: Unread
date: 2023-03-19
fetch_date: 2025-10-04T10:03:09.872396
---
...
Anche i dispositivi IoT connessi alla rete utilizzati negli edifici intelligenti sono altamente suscettibili di attacchi informatici. È dunque fondamentale comprendere ed eseguire i migliori standard di cyber security IoT per prevenire future intrusioni informatiche e proteggere gli asset più preziosi

Pubblicato il 17 Mar 2023

[Francesco Genchi](https://www.cybersecurity360.it/giornalista/francesco-genchi/)

Managing Director Italy di Johnson Controls

![Dispositivi IoT degli smart building sotto attacco: ecco le migliori pratiche difensive](data:image/png;base64...)![Dispositivi IoT degli smart building sotto attacco: ecco le migliori pratiche difensive](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2023/03/IoT-smart-building-cyber-security.jpg)

Storicamente, la **sicurezza delle informazioni (InfoSec)** non è mai stata una preoccupazione significativa per i **sistemi operativi degli edifici**, caratterizzati da protocolli proprietari e infrastrutture chiuse con dati limitati. Ma, man mano che l’adozione di **architetture aperte e interoperabili** si è diffusa, sono diventati **target per i** [**ransomware**](https://www.cybersecurity360.it/nuove-minacce/ransomware-cose-come-rimuoverlo-e-come-difendersi/), causando **costi significativi di bonifica**, **guasti all’infrastruttura** e **rischi per i lavoratori**.
...
* [I rischi della centralizzazione dei sistemi IoT](#I_rischi_della_centralizzazione_dei_sistemi_IoT)
* [Come difendere i dispositivi IoT degli smart building](#Come_difendere_i_dispositivi_IoT_degli_smart_building)
  + [Persone](#Persone)
  + [Processo](#Processo)
  + [Tecnologia](#Tecnologia)
* [Conclusioni](#Conclusioni)

## **I rischi della centralizzazione dei sistemi IoT**
