---
title: Update Mon Jan 27 04:22:47 UTC 2025
url: https://github.com/trickest/cve/commit/863bfc48e5dd52b0ac34eca3b6ccfca2ae091c10
source: Recent Commits to cve:main
date: 2025-01-28
fetch_date: 2025-10-06T20:07:38.495386
---

# Update Mon Jan 27 04:22:47 UTC 2025
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftrickest%2Fcve%2Fcommit%2F863bfc48e5dd52b0ac34eca3b6ccfca2ae091c10)
...
[Browse files](/trickest/cve/tree/863bfc48e5dd52b0ac34eca3b6ccfca2ae091c10)Browse files
...
```
1 parent f22674c commit 863bfc4
...
Collapse file: 2015/CVE-2015-7802.md

### [`‎2015/CVE-2015-7802.md‎`](#diff-4e8fcd5b86a5410409cd0ffcd9231914314843c0a6ff3c985fd81bb959759f17)
...
| --- | --- | --- |
| `@@ -0,0 +1,17 @@` | | | |
|  | `1` | `+ ### [CVE-2015-7802](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2015-7802)` |
...
|  | `6` | `+ ### Description` |
|  | `7` | `+` |
|  | `8` | `+ gifread.c in gif2png, as used in OptiPNG before 0.7.6, allows remote attackers to cause a denial of service (uninitialized memory read) via a crafted GIF file.` |
|  | `9` | `+` |
|  | `10` | `+ ### POC` |
|  | `11` | `+` |
|  | `12` | `+ #### Reference` |
|  | `13` | `+ - https://sourceforge.net/p/optipng/bugs/53/` |
|  | `14` | `+` |
|  | `15` | `+ #### Github` |
...
| Original file line number | Diff line number | Dif...