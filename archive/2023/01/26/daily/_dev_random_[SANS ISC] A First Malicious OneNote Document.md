---
title: [SANS ISC] A First Malicious OneNote Document
url: https://blog.rootshell.be/2023/01/25/sans-isc-a-first-malicious-onenote-document/
source: /dev/random
date: 2023-01-26
fetch_date: 2025-10-04T04:53:27.940883
---
...
[January 25, 2023](https://blog.rootshell.be/2023/01/25/sans-isc-a-first-malicious-onenote-document/ "18:40") [Malware](https://blog.rootshell.be/category/security/malware/), [SANS Internet Storm Center](https://blog.rootshell.be/category/sans-internet-storm-center/), [Security](https://blog.rootshell.be/category/security/) [Leave a comment](https://blog.rootshell.be/2023/01/25/sans-isc-a-first-malicious-onenote-document/#respond)

I published the following diary on isc.sans.edu: “*A First Malicious OneNote Document*“:

Attackers are always trying to find new ways to deliver malware to victims. They recently started sending Microsoft OneNote files in massive phishing campaigns. OneNote files (ending the extension “.one”) are handled automatically by computers that have the Microsoft Office suite installed. Yesterday, my honeypot caught a first sample. This is a good opportunity to have a look at these files. The file, called “delivery-note.one”, was delivered as an attachment to a classic phishing email… [Read [more](https://isc.sans.edu/diary/A%20First%20Malicious%20OneNote%20Document/29470)]

![](https://blog.rootshell.be/wp-content/uploads/2023/01/34BFAAFC-493F-41FC-ACB1-050F05A5251B-1024x562.png)

[Malware](https://blog.rootshell.be/tag/malware/)[Office](https://blog.rootshell.be/tag/office/)[SANS ISC](https://blog.rootshell.be/tag/sans-isc/)
