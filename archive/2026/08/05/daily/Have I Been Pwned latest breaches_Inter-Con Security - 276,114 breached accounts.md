...
![Inter-Con Security Logo](https://logos.haveibeenpwned.com/InterConSecurity.png)

# Inter-Con Security Data Breach

## What Happened

In June 2026, [Inter-Con Security was targeted in a ShinyHunters “pay or leak” extortion campaign](https://x.com/DarkWebInformer/status/2069536119545540871). The group subsequently published data it alleged was taken from the company, including 276k unique email addresses along with names, physical addresses, job titles and phone numbers. The data encompassed a combination of contacts, internal users and leads.
