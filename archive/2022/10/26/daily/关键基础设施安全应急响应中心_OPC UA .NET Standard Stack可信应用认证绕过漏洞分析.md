---
title: OPC UA .NET Standard Stack可信应用认证绕过漏洞分析
url: https://mp.weixin.qq.com/s?__biz=MzkyMzAwMDEyNg==&mid=2247532094&idx=1&sn=205506e690121d4569b673e7a408d989&chksm=c1e9f26ff69e7b793d012dfd60aa8a00d4624a8ea2ec7a4fff14aa26936cd03477a7f12dc95d&scene=58&subscene=0#rd
source: 关键基础设施安全应急响应中心
date: 2022-10-26
fetch_date: 2025-10-03T20:54:43.317959
---

# OPC UA .NET Standard Stack可信应用认证绕过漏洞分析

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/iaz5iaQYxGogtvVegfBFQ43LLFhEC6BC0S2upocLtia9DJSz7Ozia6qJ01wibuoAGeFiaGcgdp6hdsBWUhzVhFE3gR7g/0?wx_fmt=jpeg)
...
Match函数将待校验证书Issuer名称和潜在Issuer证书的Subject Name进行对比，此外还检查证书的X.509 Extension中Authority Key Identifier属性中的Serial number和潜在Issuer证书的Serial number是否匹配或者key id是否匹配。如果issuer名匹配且serial number或key\_id中有一项匹配，则GetIssuersNoExceptionsOnGetIssuer会返回true。
