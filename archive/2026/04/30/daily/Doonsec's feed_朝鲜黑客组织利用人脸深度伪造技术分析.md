...
url: https://mp.weixin.qq.com/s/JkHQhee-RkaIXPk_6lMttA
source: Doonsec's feed
date: 2026-04-30
fetch_date: 2026-05-01T05:37:07.692418
---
...
BlueNoroff 攻击组织通过被篡改的 Calendly 日历邀请发送拼写仿冒的 Zoom 会议链接，启动了多阶段攻击链，攻击者在受害者系统中维持了长达 66 天的持久化权限，受害者为北美Web3加密货币公司员工。
...
2. **基于浏览器的摄像头和麦克风访问**
   ...
   接下来，页面以加入会议为借口调用 getUserMedia API，捕获受害者自己的实时摄像头画面。一个单独的、隐蔽的 getUserMedi...