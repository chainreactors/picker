---
title: Findomain v11.0.0-beta.1
url: https://kitploit.com/en/posts/github-findomain-findomain-1100-beta1
source: Kitploit
date: 2026-08-27
fetch_date: 2026-08-28T13:36:45.313869
---
...
* Subdomains monitoring: put data to Discord, Slack or Telegram webhooks. See [Subdomains Monitoring](https://github.com/findomain/findomain/blob/HEAD/README.md#subdomains-monitoring) for more information.
...
* Hability to query directly the Findomain database created with [Subdomains Monitoring](https://github.com/findomain/findomain/blob/HEAD/docs/INSTALLATION.md#subdomains-monitoring) for previous discovered subdomains.
* Hability to import and work data discovered by other tools. See [Working with other tools](https://github.com/findomain/findomain/blob/HEAD/README.md#working-with-other-tools).
* Quiet mode to run it silently.
* Cross platform support: Any platform, it's written in Rust and Rust is multiplatform. See [the documentation](https://github.com/findomain/findomain/blob/HEAD/docs/INSTALLATION.md#build-for-32-bits-or-another-platform) for instructions.
