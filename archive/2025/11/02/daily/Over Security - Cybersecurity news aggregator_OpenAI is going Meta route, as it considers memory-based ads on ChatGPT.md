---
title: OpenAI is going Meta route, as it considers memory-based ads on ChatGPT
url: https://www.bleepingcomputer.com/news/artificial-intelligence/openai-is-going-meta-route-as-it-considers-memory-based-ads-on-chatgpt/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-02
fetch_date: 2025-11-03T03:15:39.080695
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CISA and NSA share tips on securing Microsoft Exchange servers](data:image/gif;base64...)
  ...
  + [![Malicious NPM packages fetch infostealer for Windows, Linux, macOS](data:image/gif;base64...)
  ...
  + [![Canada says hacktivists breached water and energy facilities](data:image/gif;base64...)
  ...
  + [![Microsoft fixes 0x800F081F errors causing Windows update failures](data:image/gif;base64...)
  ...
  + [![Penn hacker claims to have stolen 1.2 million donor records in data breach](data:image/gif;base64...)
  ...
  + [![Open VSX rotates access tokens used in supply-chain malware attack](data:image/gif;base64...)
  ...
  + [![Get lifetime access to Babbel’s language library at this special price](data:image/gif;base64...)

    Get lifetime access to Babbel’s language library at this special price](https://www.bleepingcomputer.com/offer/deals/get-lifetime-access-to-babbels-language-library-at-this-special-price/)
  + [![OpenAI is going Meta route, as it considers memory-based ads on ChatGPT](data:image/gif;base64...)
...
* [Deals](https://deals.bleepingcomputer.com/)
  ...
  + [![eLearning](data:image/gif;base64...)
    ...
    eLearning](https://deals.bleepingcomputer.com/deals/elearning?utm_source=bleepingcomputer.c...