---
title: AperiSolve v3.7.10
url: https://kitploit.com/en/posts/github-zeecka-aperisolve-3710
source: Kitploit
date: 2026-09-05
fetch_date: 2026-09-06T06:39:10.916848
---
...
![](https://assets.kitploit.com/production/public/tools/129/6ed4965b9771573193cfc55fe47f2e90294f70d4ee71c71cff064d5a6470f352.png)
...
[![Website](https://img.shields.io/website?url=https://aperisolve.com)](https://aperisolve.com/)
...
[![Aperi'Solve screenshot](https://assets.kitploit.com/production/public/readmes/129/6ed4965b9771573193cfc55fe47f2e90294f70d4ee71c71cff064d5a6470f352.png)](https://www.aperisolve.com)

Try it now: **<https://www.aperisolve.com>**

Support Aperi'Solve:

[![Sponsor Aperi'Solve on GitHub](https://img.shields.io/badge/Sponsor-Zeecka-ea4aaa?logo=githubsponsors&logoColor=white&style=for-the-badge)](https://github.com/sponsors/Zeecka)
...
See [docs/adding-analyzer.md](https://github.com/zeecka/aperisolve/blob/main/docs/adding-analyzer.md).
...
opt-in via environment variables documented in [`.env.example`](https://github.com/zeecka/aperisolve/blob/main/.env.example).
...
* [docs/adding-analyzer.md](https://github.com/zeecka/aperisolve/blob/main/docs/adding-analyzer.md) — add a new analyzer.
* [docs/deploy.md](https://github.com/zeecka/aperisolve/blob/main/docs/deploy.md) — the tag-driven production deploy flow.
* [CONTRIBUTING.md](https://github.com/zeecka/aperisolve/blob/main/CONTRIBUTING.md) — dev setup, tests, wiki pages, and translations.
...
See [CONTRIBUTING.md](https://github.com/zeecka/aperisolve/blob/main/CONTRIBUTING.md).
...
[binwalk](https://github.com/ReFirmLabs/binwalk), [exift...