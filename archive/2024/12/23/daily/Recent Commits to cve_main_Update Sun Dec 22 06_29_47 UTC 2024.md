---
title: Update Sun Dec 22 06:29:47 UTC 2024
url: https://github.com/trickest/cve/commit/3576c653ffbf8aa938a2abd9d85af0d24b9b1829
source: Recent Commits to cve:main
date: 2024-12-23
fetch_date: 2025-10-06T19:35:55.406247
---
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftrickest%2Fcve%2Fcommit%2F3576c653ffbf8aa938a2abd9d85af0d24b9b1829)
...
[Browse files](/trickest/cve/tree/3576c653ffbf8aa938a2abd9d85af0d24b9b1829)Browse files
...
```
1 parent d3b894a commit 3576c65

Copy full SHA for 3576c65
```
...
* 2004
  ...
  + [CVE-2004-0224.md](#diff-b52b7ff6a37d915583138aca387f51f6f1024ced917921e0f2ac13916317bcde)
...
Collapse file: 2004/CVE-2004-0224.md

### [`‎2004/CVE-2004-0224.md‎`](#diff-b52b7ff6a37d915583138aca387f51f6f1024ced917921e0f2ac13916317bcde)
...
| --- | --- | --- |
| `@@ -0,0 +1,17 @@` | | | |
|  | `1` | `+ ### [CVE-2004-0224](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2004-0224)` |
...
|  | `6` | `+ ### Description` |
|  | `7` | `+` |
|  | `8` | `+ Multiple buffer overflows in (1) iso2022jp.c or (2) shiftjis.c for Courier-IMAP before 3.0.0, Courier before 0.45, and SqWebMail before 4.0.0 may allow remote attackers to execute arbitrary code "when Unicode character is out of BMP range."` |
|  | `9` | `+` |
|  | `10` | `+ ### POC` |
|  | `11` | `+` |
|  | `12` | `+ #### Reference` |
|  | `13` | `+ - http://sourceforge.net/project/shownotes.php?release_id=5767` |
|  | `14` | `+` |
|  | `15` | `+ #### Github` |
...
Copy file name to clipboardExpand all lines: references.t...