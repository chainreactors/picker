...
url: https://www.adainese.it/blog/2024/07/27/installing-ubuntu-linux/
source: Over Security - Cybersecurity news aggregator
date: 2025-09-21
fetch_date: 2025-10-02T20:29:02.057786
---
...
[![Post cover](/images/vendors/linux.webp)](/images/vendors/linux.webp)

Now let’s see how to install Ubuntu Linux Server 20.04 LTS so that it can host EVE-NG. Virtual Environment In a virtual environment, typica

Now let’s see how to install Ubuntu Linux Server 20.04 LTS so that it can host EVE-NG.

## Virtual Environment

In a virtual environment, typically VMware vSphere, I suggest creating a virtual machine with the following specifications:
...
* Memory: 8 GB
* Hard disk: 50 GB
* CD/DVD Drive: select the ISO file of Ubuntu Linux Server 20.04 LTS previously uploaded to the ESXi server

Continue reading
[the post on Patreon](https://www.patreon.com/posts/installing-linux-108911499)
.
