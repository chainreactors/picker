---
title: yakit v1.4.8-0905
url: https://kitploit.com/en/posts/github-yaklang-yakit-v148-0905
source: Kitploit
date: 2026-09-05
fetch_date: 2026-09-06T06:39:25.238478
---
...
![](https://assets.kitploit.com/production/public/tools/188/b287cf6290e949190264b0fa0198fc839d9b8d4120d1cb99bc827f4699f6fafd.png)
...
[![](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/head.jpg)](https://yaklang.io/)

## YAKIT-A Cyber Security ALL-IN-ONE Platform based on Yak language

![](https://img.shields.io/github/issues-pr/yaklang/yakit)
[![](https://img.shields.io/github/downloads/yaklang/yakit/total)](https://github.com/yaklang/yakit/releases)[![](https://img.shields.io/github/contributors-anon/yaklang/yakit)](https://github.com/yaklang/yakit/graphs/contributors)[![](https://img.shields.io/github/release/yaklang/yakit)](https://github.com/yaklang/yakit/releases/)[![](https://img.shields.io/github/issues-raw/yaklang/yakit)](https://github.com/yaklang/yakit/issues)[![](https://img.shields.io/github/stars/yaklang/yakit)](https://github.com/yaklang/yakit/discussions)[![](https://img.shields.io/github/license/yaklang/yakit)](https://github.com/yaklang/yakit/blob/master/LICENSE.md)
...
[Issue feedback](https://github.com/yaklang/yakit/issues) •
[Official website](https://yaklang.io/) •
[Community](#Community) •
[Architecture](#Architecture)

:book:Language： [English](https://github.com/yaklang/yakit/blob/master/README-EN.md) •
[中文](https://github.com/yaklang/yakit/blob/master/README.md)
...
### ![yakit-cdsl.png](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/yakit-cdsl.png)
...
### ![yakit-arch.jpg](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/yakit-arch.jpg)
...
### ![yakit-gongneng.png](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/yakit-gongneng.png)
...
### ![yaklang-caps.jpg](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/yaklang-caps.jpg)
...
### ![yakit-mitm.png](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/yakit-mitm.png)
...
### ![webfuzzer.png](https://raw.githubusercontent.com/yaklang/yakit/HEAD/imgs/webfuzzer.png)

### Fuzztag

The Web Fuzzer module supports seamless integration of functionalities such as Host collision, Intruder, and directory brute-forcing through Fuzz tags. For example, in a single parameter brute-forcing scenario, let's take the user ID as an example. You can use the {{int(1-10)}} tag to automatically generate a range of IDs for brute-forcing. In scenarios where multiple parameters need to be brute-forced, the Cartesian product of the parameters is used for the brute-forcing. This eliminates the need to select the brute-forcing method and import dictionaries, reducing user operation steps and aligning with user habits compared to Burp...