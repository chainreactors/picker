---
title: OSINT CTF i webinary organizowane przez NASK - 24-25 listopada 2025
url: https://gynvael.coldwind.pl/?id=806
source: gynvael.coldwind//vx.log (pl)
date: 2025-11-10
fetch_date: 2025-11-11T03:12:48.344565
---
...
## [OSINT CTF i webinary organizowane przez NASK - 24-25 listopada 2025](?id=806)

ctf:osint

![](/img/osint_nask_2025.png)

NASK - Państwowy Instytut Badawczy, z którym niedawno wspólnie organizowaliśmy finały European Cybersecurity Challenge 2025, idzie za ciosem i przygotował kolejny CTF, tym razem z tematyki OSINT — [**OSINT CTF 2025**](https://osint-ctf.pl/) (24-25 listopada 2025; **rejestracja tylko do 21.11.25 r.**).

Co ciekawe, zawody będą poprzedzone czteroma darmowymi webinarami edukacyjnymi prowadzonymi przez ekspertów z zakresu cyberbezpieczeństwa i analizy danych (z czego dwa się już odbyły i będzie można je obejrzeć na [kanale NASK na YouTubie](https://www.youtube.com/c/NASKPIB)):
...
* 17.11 18:00 – webinar dr hab. Daniel Mider, wykłądowca UW ds. infobrokeringu i
  cyberterroryzmu; **"Bezpieczeństwo specjalisty OSINT & perspektywa rozwoju branży."**
