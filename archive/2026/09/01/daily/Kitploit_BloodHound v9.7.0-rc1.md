---
title: BloodHound v9.7.0-rc1
url: https://kitploit.com/en/posts/github-specterops-bloodhound-v970-rc1
source: Kitploit
date: 2026-09-01
fetch_date: 2026-09-02T06:40:09.057228
---
...
![](https://assets.kitploit.com/production/public/tools/6302/b1b58179696bbc3307ad23ef818395a75decc28649251fa60c6aeda95e91c14a.png)
...
![BloodHound Community Edition](https://raw.githubusercontent.com/specterops/bloodhound/HEAD/cmd/ui/public/img/BHCE_Vertical_RedField.svg)
...
* [Docker Compose Example](https://github.com/specterops/bloodhound/blob/HEAD/examples/docker-compose/README.md)
...
* [Contributors](https://github.com/specterops/bloodhound/blob/HEAD/CONTRIBUTORS.md)
...
under the `Apache-2.0` license. A full copy of the license may be found in the top-level [LICENSE](https://github.com/specterops/bloodhound/blob/HEAD/LICENSE) file.

[Read more](/en/tools/github/specterops/bloodhound?expand=1)

## Categories

[Defensive Tools](/en/categories/defensive-tools)[Privilege Escalation](/en/categories/privilege-escalation)[Reconnaissance](/en/categories/reconnaissance)[Information Gathering](/en/categories/information-gathering)[Penetration Testing](/en/categories/penetration-testing)[Identity & Access Management (IAM)](/en/categories/identity-access-management)[Red Teaming](/en/categories/red-teaming)
