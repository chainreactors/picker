---
title: AI Act e la proposta di moratoria: in gioco è il modello europeo di governo del digitale
...
Nel dibattito europeo sull’intelligenza artificiale, l’appello a “mettere in pausa” il regolamento sull’intelligenza artificiale sta assumendo i tratti di un dissenso interno, che proviene dal tessuto produttivo europeo. Ecco il dilemma sull’AI Act alla prova della moratoria
...
![AI Act, a che punto siamo con la proposta di moratoria europea](data:image/png;base64...)![AI Act, a che punto siamo con la proposta di moratoria europea](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2024/03/AI-Act-si-apre-la-partita-dellattuazione.jpg)

---

Nel dibattito europeo sull’intelligenza artificiale l’appello a “mettere in pausa” l’**[AI Act](https://www.cybersecurity360.it/news/ai-act-pubblicato-in-gazzetta-ufficiale-europea-non-ci-sono-piu-scuse-per-adeguarsi/)** non è più il riflesso prevedibile delle grandi piattaforme d’oltreoceano.
...
* [Ai Act e richiesta di moratoria](#Ai_Act_e_richiesta_di_moratoria)
  + [Il segnale dei 40 gruppi europei](#Il_segnale_dei_40_gruppi_europei)
* [Le scadenze](#Le_scadenze)
  + [Il rischio paradosso](#Il_rischio_paradosso)
  + [In ritardo i riferimenti tecnici](#In_ritardo_i_riferimenti_tecnici)
  + [Il rischio legale asimmetrico](#Il_rischio_legale_asimmetrico)
* [La geografia del dissenso contro l’AI Act e la richiesta di moratoria](#La_geografia_del_dissenso_contro_lAI_Act_e_la_richiesta_di_moratoria)
* [Governance europea: l’AI Act è architettura a più piani](#Governance_europea_lAI_Act_e_architettura_a_piu_piani)
  + [La pausa non è neutrale](#La_pausa_non_e_neutrale)
* [Il modello europeo di governo del digitale](#Il_modello_europeo_di_governo_del_digitale)

## Ai Act e richiesta di moratoria

Il dilemma del regolamento sull’intelligenza artificiale entra nel vivo. L’[AI Act](https://www.agendadigitale.eu/cultura-digitale/ai-act-ci-siamo-ecco-come-plasmera-il-futuro-dellintelligenza-artificiale-in-europa/) è il primo regolamento completo sull’intelligenza artificiale dell’Unione Europea, in vigore dal luglio 2024.

La prima crepa si è resa visibile con la **[lettera aperta](https://sifted.eu/articles/ai-act-pause-opinion-eu-european-startups) di decine di startupper** e **investitori europei** che domandano alla Commissione di fermare l’orologio dell’attuazione per evitare un quadro applicativo opaco, frammentato e controproducente per l’innovazione.
...
### Il segnale dei 40 gruppi europei

Poco dopo, un secondo segnale – ben più rumoroso – è giunto da oltre **quaranta tra i principali gruppi europe**i: dall’aerospazio all’energia, dalla grande distribuzione al bancario, fino ai semiconduttori e all’automotive, i vertici di imprese come Airbus, ASML, Axa, BNP Paribas, Carrefour, Siemens ed altri hanno chiesto una “pausa” di due anni, con accenti che riecheggiano l’esigenza di stabilità interpretativa e di tempi industriali compatibili con investimenti pluriennali.
...
Sul piano istituzionale la Commissione ha reagito con un equilib...