---
title: NIS2 e nomina del referente CSIRT, si apre la procedura sul portale ACN: che c’è da sapere
url: https://www.cybersecurity360.it/legal/nis2-e-nomina-del-referente-csirt-si-apre-la-procedura-sul-portale-acn-che-ce-da-sapere/
source: Over Security - Cybersecurity news aggregator
date: 2025-11-19
fetch_date: 2025-11-20T03:09:38.790056
---
...
![Nomina referente CSIRT](data:image/png;base64...)![Nomina referente CSIRT](https://dnewpydm90vfx.cloudfront.net/wp-content/uploads/2025/11/Nomina-referente-CSIRT.jpg)

---

Da domani, **20 novembre 2025**, sul portale dell’Agenzia per la Cybersicurezza Nazionale (ACN) si accende un tassello chiave del [decreto NIS2](https://www.cybersecurity360.it/legal/nis2-cose-quali-aziende-interessa-obblighi-e-sanzioni/): la procedura telematica per la **designazione del [referente CSIRT](https://www.cybersecurity360.it/legal/nis2-nasce-il-referente-csirt-ruolo-scadenze-e-impatti-operativi-per-le-organizzazioni-italiane/)**.
...
* [Chi è davvero il referente CSIRT](#Chi_e_davvero_il_referente_CSIRT)
* [Competenze minime e competenze reali](#Competenze_minime_e_competenze_reali)
* [Interno o esterno? L’unico criterio serio è la competenza](#Interno_o_esterno_Lunico_criterio_serio_e_la_competenza)
* [Cosa si deve notificare: la soglia dell’“incidente significativo”](#Cosa_si_deve_notificare_la_soglia_dell%E2%80%9Cincidente_significativo%E2%80%9D)
* [Le tempistiche: 24 ore, 72 ore, rapporto intermedio e relazione finale](#Le_tempistiche_24_ore_72_ore_rapporto_intermedio_e_relazione_finale)
* [Le notifiche volontarie: non solo incidenti, ma anche minacce e quasi-incidenti](#Le_notifiche_volontarie_non_solo_incidenti_ma_anche_minacce_e_quasi-incidenti)
* [Punto di Contatto, referente CSIRT, CISO: ruoli da coordinare, non da confondere](#Punto_di_Contatto_referente_CSIRT_CISO_ruoli_da_coordinare_non_da_confondere)
* [Cosa dovrebbero fare adesso i soggetti NIS2](#Cosa_dovrebbero_fare_adesso_i_soggetti_NIS2)

## Chi è davvero il referente CSIRT

L’**[articolo 7 della determinazione del Direttore ACN](https://www.acn.gov.it/portale/documents/d/guest/detacn_piattaformanis_250916-v5_signed)** è molto chiaro: il referente CSIRT è una **persona fisica**, designata dal Punto di Contatto attraverso la procedura che sarà disponibile sul portale. Non è una “struttura”, non è una “funzione aziendale” generica, non è una società esterna in quanto tale. È un nome e un cognome, associato a responsabilità ben precise.
