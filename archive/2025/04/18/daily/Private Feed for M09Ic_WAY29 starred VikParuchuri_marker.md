---
title: WAY29 starred VikParuchuri/marker
url: https://github.com/VikParuchuri/marker
source: Private Feed for M09Ic
date: 2025-04-18
fetch_date: 2025-10-06T22:03:38.614413
---

# WAY29 starred VikParuchuri/marker
...
* [Fork
  1.9k](/login?return_to=%2Fdatalab-to%2Fmarker)
* [Star
   29.1k](/login?return_to=%2Fdatalab-to%2Fmarker)
...
[View license](/datalab-to/marker/blob/master/LICENSE)

[29.1k
stars](/datalab-to/marker/stargazers) [1.9k
forks](/datalab-to/marker/forks) [Branches](/datalab-to/marker/branches) [Tags](/datalab-to/marker/tags) [Activity](/datalab-to/marker/activity)
...
* [Issues
  277](/datalab-to/marker/issues)
* [Pull requests
  38](/datalab-to/marker/pulls)
* [Actions](/datalab-to/marker/actions)
* [Projects
  0](/datalab-to/marker/projects)
* [Security

  ### Uh oh!

  There was an error while loading. Please reload this page.](/datalab-to/marker/security)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[1,329 Commits](/datalab-to/marker/commits/master/) | | |
...
| [.pre-commit-config.yaml](/datalab-to/marker/blob/master/.pre-co...