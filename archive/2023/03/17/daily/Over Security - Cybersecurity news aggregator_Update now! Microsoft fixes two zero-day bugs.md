---
title: Update now! Microsoft fixes two zero-day bugs
url: https://www.malwarebytes.com/blog/news/2023/03/update-now-microsoft-fixes-two-zero-day-bugs
source: Over Security - Cybersecurity news aggregator
date: 2023-03-17
fetch_date: 2025-10-04T09:53:10.987777
---
...
![different kinds of patches](https://www.threatdown.com/wp-content/uploads/2023/03/asset_upload_file35903_262425.png?w=736)
...
**[CVE-2023-24880](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-24880)**: a moderate **Windows SmartScreen** Security Feature Bypass vulnerability. An attacker could craft a malicious file that would evade Mark of the Web (MOTW) defenses, resulting in a limited loss of integrity and availability of security features such as Protected View in Microsoft Office, which rely on MOTW tagging. [Reportedly](https://www.bleepingcomputer.com/news/microsoft/microsoft-fixes-windows-zero-day-exploited-in-ransomware-attacks/), this vulnerability was used in ransomware related attacks.

MOTW, the technology that ensures Windows pops a warning message when trying to open a file downloaded from the Internet makes another [comeback](https://www.malwarebytes.com/blog/news/2022/11/qbot-uses-zero-day-motw-bypass-in-phishing-campaign). The MOTW is an attribute added to files by Windows when they have been sourced from an untrusted location, like the internet or a Restricted Zone. When you download a file from the internet, Windows adds the zone identifier or Mark of the Web as an NTFS stream to the file. And, when you run the file, Windows SmartScreen checks if there is a zone identifier [Alternate Data Stream (ADS)](https://www.malwarebytes.com/blog/news/2015/07/introduction-to-alternate-data-streams) attached to the file. If the ADS indicates `ZoneId=3`, which means that the file was downloaded from the internet, the SmartScreen...