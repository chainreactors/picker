---
title: WeblogicScan
url: https://kitploit.com/en/tools/github/rabbitmask/weblogicscan
source: Kitploit
date: 2026-09-06
fetch_date: 2026-09-07T06:48:45.149609
---
...
WeblogicScan — Automated vulnerability scanner for Oracle WebLogic Server, detecting historical CVEs including deserialization, SSRF, and arbitrary file upload with batch scanning and version identification. | Kitploit

[Tools](/en/tools)/![GitHub](/providers/github.png)GitHub/rabbitmask/weblogicscan

![](https://assets.kitploit.com/production/public/tools/54240/5e0f31506274f90394f759b2a99b94080d157719c0004d85ff2ccb19268cf00a-display-v1.webp)

[Vulnerability Scanners](/en/categories/vulnerability-scanners)[Web Vulnerability Scanners](/en/categories/web-vulnerability-scanners)[Exploitation](/en/categories/exploitation)[Information Gathering](/en/categories/information-gathering)[Web Security](/en/categories/web-security)[Penetration Testing](/en/categories/penetration-testing)

![GitHub](/providers/github.png)rabbitmask/weblogicscan

# WeblogicScan

Automated vulnerability scanner for Oracle WebLogic Server, detecting historical CVEs including deserialization, SSRF, and arbitrary file upload with batch scanning and version identification.

[View Repository](https://github.com/rabbitmask/weblogicscan)

2.3k401343 years ago![Reviewed by Kitploit](/_next/image?url=%2Fbadges%2Fkitploit_badge_reviewed_full.png&w=48&q=75)
...
2020-07-30 14:15:48,267 [+] [172.19.19.19:7001] Weblogic Versio...