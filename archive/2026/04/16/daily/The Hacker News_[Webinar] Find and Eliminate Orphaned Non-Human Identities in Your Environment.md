...
date: 2026-04-16
fetch_date: 2026-04-17T04:51:15.602675
---
...
**The Hacker News**Apr 16, 2026Artificial Intelligence / Enterprise Security

[![](data:image/png;base64...)](https://thehacker.news/ghost-in-the-machine?source=article)
...
[Join our upcoming webinar](https://thehacker.news/ghost-in-the-machine?source=article) where we’ll show you how to find and eliminate these "Ghost Identities" before they become a back door for hackers.
...
> 📅 **Save Your Spot Today:** [Register for the Webinar Here](https://thehacker.news/ghost-in-the-machine?source=article).
...
[API Security](https://thehackernews.com/search/label/API%20Security), [artificial intelligence](https://thehackernews.com/search/label/artificial%20intelligence), [Cloud Infrastructure](https://thehackernews.com/search/label/Cloud%20Infrastructure), [Cloud security](https://thehackernews.com/search/label/Cloud%20security), [cybersecurity](https://thehackernews.com/search/label/cybersecurity), [enterprise security](https://thehackernews.com/search/label/enterprise%20security), [Identity Management](https://thehackernews.com/search/label/Identity%20Management)
...
[![Microsoft Details Cookie-Controlled PHP Web Shells Persisting via Cron on Linux Servers](data:image/svg+xml;base64... "Microsoft Details Cookie-Controlled PHP Web Shells Persisting via Cron on Linux Servers")
...
[![Fortinet Patches Actively Exploited CVE-2026-35616 in FortiClient EMS](data:image/svg+xml;base64... "Fortinet Patches Actively Exploited CVE-2026-35616 in FortiClient EMS")
...
[![Block the Prompt, Not the Work: The End of Doctor No](data:image/svg+xml;base64... "Block ...