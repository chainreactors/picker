...
date: 2026-03-23
fetch_date: 2026-03-24T04:17:43.395712
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![TeamPCP deploys Iran-targeted wiper in Kubernetes attacks](data:image/gif;base64...)
  ...
  + [![Crunchyroll probes breach after hacker claims to steal 6.8M users' data](data:image/gif;base64...)
  ...
  + [![Microsoft Exchange Online service change causes email access issues](data:image/gif;base64...)
  ...
  + [![OpenAI rolls out ChatGPT Library to store your personal files](data:image/gif;base64...)
  ...
  + [![Mazda discloses security breach exposing employee and partner data](data:image/gif;base64...)
  ...
  + [![Tycoon2FA phishing platform returns after recent police disruption](data:image/gif;base64...)
...
![Varonis Atlas](https://www.bleepstatic.com/content/posts/2026/03/18/varonis-atlas.jpg)

Varonis is proud to announce the general availability of [Varonis Atlas](https://www.varonis.com/platform/ai-security?hsLang=en), an end-to-end AI Security Platform that helps organizations see and control AI across the enterprise.

Atlas is the only platform that covers the entire AI security lifecycle — from discovery and posture management to runtime protection and compliance — in a single s...