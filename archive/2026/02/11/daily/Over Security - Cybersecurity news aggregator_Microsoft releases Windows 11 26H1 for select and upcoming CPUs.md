...
date: 2026-02-11
fetch_date: 2026-02-12T04:23:07.589383
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Windows 11 Notepad flaw let files execute silently via Markdown links](data:image/gif;base64...)
  ...
  + [![Crazy ransomware gang abuses employee monitoring tool in attacks](data:image/gif;base64...)
  ...
  + [![Windows 11 Notepad flaw let files execute silently via Markdown links](data:image/gif;base64...)
    ...
    Windows 11 Notepad flaw let files execute silently via Markdown links](https://www.bleepingcomputer.com/news/microsoft/windows-11-notepad-flaw-let-files-execute-silently-via-markdown-links/)
  + [![Microsoft Store Outlook add-in hijacked to steal 4,000 Microsoft accounts](data:image/gif;base64...)
...
![Windows 11](https://www.bleepstatic.com/content/hl-images/2025/10/23/Windows-11.jpg)

Microsoft has announced Windows 11 26H1, but it's not for existing PCs. Instead, it will ship on devices...