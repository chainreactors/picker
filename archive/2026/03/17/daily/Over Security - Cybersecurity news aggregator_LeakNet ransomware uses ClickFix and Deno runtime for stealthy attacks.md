---
title: LeakNet ransomware uses ClickFix and Deno runtime for stealthy attacks
...
date: 2026-03-17
fetch_date: 2026-03-18T04:22:29.882228
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft shares fix for Windows C: drive access issues on Samsung PCs](data:image/gif;base64...)
  ...
  + [![New font-rendering trick hides malicious commands from AI tools](data:image/gif;base64...)
  ...
  + [![Stryker attack wiped tens of thousands of devices, no malware needed](data:image/gif;base64...)
  ...
  + [![New Windows 11 hotpatch fixes Bluetooth device visibility issue](data:image/gif;base64...)
  ...
  + [![Apple pushes first Background Security Improvements update to fix WebKit flaw](data:image/gif;base64...)
  ...
  + [![GlassWorm malware hits 400+ code repos on GitHub, npm, VSCode, OpenVSX](data:image/gif;base64...)
  ...
  + [![Europe sanctions Chinese and Iranian firms for cyberattacks](data:image/gif;base64...)
  ...
  + [![One app, every AI model: 1min.AI is now on lifetime deal](data:image/gif;base64...)

    One app, every AI model: 1min.AI is now on lifetime deal](https://www.bleepingcomputer.com/offer/deals/one-app-every-ai-model-1minai-is-now-on-lifetime-deal/)
...
![LeakNet ransomware uses ClickFix, Deno runtime in stealthy attacks](https://www.bleepstatic.com/content/hl-images/2025/02/12/ransomware-3.jp...