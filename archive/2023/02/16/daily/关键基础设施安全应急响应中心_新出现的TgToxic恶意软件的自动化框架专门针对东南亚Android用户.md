...
url: https://mp.weixin.qq.com/s?__biz=MzkyMzAwMDEyNg==&mid=2247534477&idx=4&sn=dc6c2d83a47beefda05e3d9be71e76c9&chksm=c1e9cbdcf69e42ca37cc4b8aa2fb1689ac0de442f72819e575be6f4a3de5185224dbcdb36408&scene=58&subscene=0#rd
source: 关键基础设施安全应急响应中心
date: 2023-02-16
fetch_date: 2025-10-04T06:46:38.226041
---

# 新出现的TgToxic恶意软件的自动化框架专门针对东南亚Android用户

![cover_image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/iaz5iaQYxGogucGxHiarZB8tTB7ib3seJFajv0KzANtePN5SNic5lD7MIIpB9QvqsicpLg91xUbD17ta7RcYkgibOjvcA/0?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvr2UQucgRLfbgxJHTu9TXMbmdYHTAhQaUOcwRPNibv55sEIXMBjnmPWlQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrYgZYMMfnKBZw9UeCvYWicZia4Qktc0eAfQkRicCzCOpca9VFo6Sq8r4Jw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

虚假应用程序在下载后立即启动注册页面以诱导用户，恶意软件TgToxic开始在后台运行

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvr5DByH16T3Tf7xxCGxGm36LOqJzjD0993GEodAOkHWicTMOYlkoQLmFQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvryVH39q5DCYvKAPQkRo5ptxJlFrVld66n2WwahuVD2SwOl2vhx2o2DA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrtRN6fEhsITxfHeVMBwpv5mapk5wJLLKg8M84VRNedjYhmiaVLXyO51w/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

APK结构和有效负载

解密有效负载并滥用辅助功能服务劫持设备UI

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrRHfaj2amWvmSua66K3Ck3tsbkCJdKhFylw7Z6VOMAT5OiaDcL8RqVdQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrpb7cBQOqT3KvXOSpick6tdsT8VbJA5ys4zoV8sT8JSPUPeHQ8Q4EOlQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

Zip密码解码功能

解压缩后，研究人员发现所有文件都是二进制文件，所有文件的前四个字节都是“0x00092383”，这是专门加密的文件。通过反向分析，研究人员找到了解密函数。为了隐藏解密细节，使用反射调用密钥类和密钥方法，并加密相关的符号名称。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvr8ibsOGz73tBmTMCYoDjpB2P4ib22bb7jic9ftAxzWpKp7wIP0t53eeubA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

特殊加密文件

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrebFPeicjDj0ylT4HSLeSuHVcVibsxibp3crEMMzrzq9SD5cuZ349bWDJQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

加密文件解密功能

通过分析解密函数，研究人员得到了加密文件的格式。加密文件对密码进行了编码，并将其保存在文件的开头（紧跟魔术数字），同时将加密数据保存在文件末尾。密码的解码方式与zip密码的解码方法相同。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrTsZG9IZP9iaQdl77BjOsFyNticWS0icy4Qtt2sPiaFxNKOplRBqkdjQZTQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvr54pSh2ibBaLqGwBibicicvhJMKf5EpVZQNicXiaBSpiaZnpeEOY5TUq6jkcoA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrLdnibx5puicmDsD8J1AcR74aC04NKuib87eGegusmwwWA4ayGlg2kb7cw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrufMjtFVMnCib8sbCWnZFF6vrdmLbY3QwYOtVoiaVjGEIliaUnwsVxzenA/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrzWuibdZtxqibTdKv3Eq8IQKkbS7EiaJdRUSJVmn5zA2oRaD6AbeNxYQ8A/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

根据设备区域获取C&C主机前缀

数据通过C&C通道泄露。以短信窃取为例，恶意软件首先调用“getSmsInPhone”从邮件收件箱中提取所有短信，然后通过WebSocket C&C通道将窃取的数据上传到服务器。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrsEe0kyhNg3kvEUiaNMIibmVziczmx0VNrrDs3Xz7PsrCLCtCyy1icA58kA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrNgW6YGLxT5OLibFPPRBGVZ8AFsib9iceMtibEvLMSMibk6VcE6EetN3MTww/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrVj8hQUj98wcuQoia3WlRiaptejdtC5x79RkuibH7tDk1uzMOXb5IfOYBQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

检查链类型并输入钱包详细信息

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvroZymuYWnhk5c8rExasmichibZTxjnQmd4nrESEPP945TFrfzfsxeib24w/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

输入被盗的地址信息和收件人的地址

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrQhZuniaB8iaWB0Z2IUOHFlMiaO8tPR66ibAsrxfMJgYV5ONjo1rjlPZxIA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)

输入钱包密码并确认交易

目标应用程序

以下是恶意软件从中窃取受害者信息的应用程序列表，列表来自针对泰国的最新样本：

Android设备被攻击后，恶意软件从中获取信息的应用程序列表：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/wpkib3J60o2ibI6UBcGqkFz6hNOdgF6cvrT1GhS6gkguM3d62wInRWRaYYR2lqM53yAIGtt3DTJzMfjNvUHpAA9Q/640?wx_fmt=png&wxfrom=5&wx_lazy...