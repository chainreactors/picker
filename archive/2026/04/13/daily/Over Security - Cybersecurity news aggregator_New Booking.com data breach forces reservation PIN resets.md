...
date: 2026-04-13
fetch_date: 2026-04-14T04:45:47.791445
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CPUID hacked to deliver malware via CPU-Z, HWMonitor downloads](data:image/gif;base64...)
  ...
  + [![Google Chrome adds infostealer protection against session cookie theft](data:image/gif;base64...)
  ...
  + [![New VENOM phishing attacks steal senior executives' Microsoft logins](data:image/gif;base64...)
  ...
  + [![Google rolls out Gmail end-to-end encryption on mobile devices](data:image/gif;base64...)
  ...
  + [![European Gym giant Basic-Fit data breach affects 1 million members](data:image/gif;base64...)
  ...
  + [![Critical flaw in wolfSSL library enables forged certificate use](data:image/gif;base64...)
  ...
  + [![FBI takedown of W3LL phishing service leads to developer arrest](data:image/gif;base64...)
...
![New Booking.com data breach forces reservation PIN resets](https://www.bleepstatic.com/content/hl-images/2026/04/13/Booking.jpg)

Booking.com has confirmed in a statement to BleepingComput...