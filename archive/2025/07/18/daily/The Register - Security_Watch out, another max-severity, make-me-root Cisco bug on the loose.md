...
url: https://go.theregister.com/feed/www.theregister.com/2025/07/17/critical_cisco_bug/
source: The Register - Security
date: 2025-07-18
fetch_date: 2025-10-07T00:06:31.456030
---
...
ISE is a network access control and security policy management platform, and ISE-PIC centralizes identity management across security tools. And this vulnerability, tracked as [CVE-2025-20337](https://nvd.nist.gov/vuln/detail/CVE-2025-20337), is about the worst of the worst, allowing miscreants to take total control of compromised computers easily. In other words - patch now.

The vendor disclosed CVE-2025-20337 on Wednesday in an update to a June security advisory about [two other max-severity flaws](https://www.theregister.com/2025/06/26/patch_up_cisco_fixes_two/) in the same products. The new bug is related to [CVE-2025-20281](https://nvd.nist.gov/vuln/detail/CVE-2025-20281), one of the two disclosed in June, which also received a 10 CVSS rating and affects ISE and ISE-PIC releases 3.3 and 3.4, regardless of device configuration.

[![](https://pubads.g.doubleclick.net/gampad/ad?co=1&iu=/6978/reg...