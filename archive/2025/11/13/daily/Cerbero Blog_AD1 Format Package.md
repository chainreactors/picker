---
title: AD1 Format Package
url: https://blog.cerbero.io/ad1-format-package/
source: Cerbero Blog
date: 2025-11-13
fetch_date: 2025-11-14T03:12:34.851871
---
...
We released the [AD1 Format package](https://cerbero.io/packages/ad1format/), which adds basic support for AccessData Custom Content Image files. AD1 images are logical evidence containers created by FTK Imager and other AccessData tools, used to store selected files or folders from a system rather than a full physical disk image.

![](/wp-content/uploads/2025/11/ad1.png)

![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [November 13, 2025](https://blog.cerbero.io/ad1-format-package/)Categories [Forensics](https://blog.cerbero.io/category/forensics/), [Package](https://blog.cerbero.io/category/package/)Tags [AccessData](https://blog.cerbero.io/tag/accessdata/), [Evidence](https://blog.cerbero.io/tag/evidence/), [IR](https://blog.cerbero.io/tag/ir/)

## Leave a Reply [Cancel reply](/ad1-format-package/#respond)
...
[Previous Previous post: Memory Challenge 7: DeepDive](https://blog.cerbero.io/memory-challenge-7-deepdive/)
