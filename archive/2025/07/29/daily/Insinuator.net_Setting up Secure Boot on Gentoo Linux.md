---
title: Setting up Secure Boot on Gentoo Linux
url: https://insinuator.net/2025/07/setting-up-secure-boot-on-gentoo-linux/
source: Insinuator.net
date: 2025-07-29
fetch_date: 2025-10-06T23:51:08.669920
---
...
[Back](https://insinuator.net/#post-15412)

[Building](https://insinuator.net/category/building/)

[July 28, 2025](https://insinuator.net/2025/07/setting-up-secure-boot-on-gentoo-linux/) by [Alexander Moch](https://insinuator.net/author/amoch/)

# Setting up Secure Boot on Gentoo Linux

[Alexander Moch](https://insinuator.net/author/amoch/ "Alexander Moch")
...
On a hardened system, Secure Boot should be deployed along with full disk encryption[1](#fn1).
...
Good resources for reading up on UEFI Secure Boot can be found in the UEFI Specification[2](#fn2), Oracle’s explanation of UEFI Secure Boot[3](#fn3), James Bottomley’s blog post on “The Meaning of all the UEFI Keys”[4](#fn4) or @depletionsmode’s blog post about “Understanding modern UEFI-based platform boot”[5](#fn5).

Unlike most other guides, we’ll explain this hierarchy *from the bottom up*.

* **Signature Database (db)**: The signature database contains public keys, digital signatures, or hashes of executables. When an EFI binary is loaded, it is checked against the en...