...
date: 2025-06-07
fetch_date: 2025-10-06T22:53:58.064529
---
...
Filed under: [My Software](https://blog.didierstevens.com/category/my-software/) — Didier Stevens @ 0:00
...
But if you want another hash, you can change this (for some of my tools) by setting environment variable DSS\_DEFAULT\_HASH\_ALGORITHMS.

Like for pdf-parser.py, on Windows, you can set DSS\_DEFAULT\_HASH\_ALGORITHMS=sha256 and then the hashes of the streams will be SHA256 in stead of MD5.

### Share this:

* [Click to share on Facebook (Opens in new window)
  Facebook](https://blog.didierstevens.com/2025/06/06/dss_default_hash_algorithms/?share=facebook)
* [Click to share on X (Opens in new window)
  X](https://blog.didierstevens.com/2025/06/06/dss_default_hash_algorithms/?share=x)

### *Related*

[Leave a Comment](https://blog.didierstevens.com/2025/06/06/dss_default_hash_algorithms/#respond)

## Leave a Comment [»](#postcomment "Leave a comment")

No comments yet.

[RSS feed for comments on this post.](https://blog.didierstevens.com/2025/06/06/dss_default_hash_algorithms/feed/) [TrackBack URI](https://blog.didierstevens.com/2025/06/06/dss_default_hash_algorithms/trackback/)
