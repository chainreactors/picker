---
title: An interview with cyber threat hunter Hiep Hinh
url: https://www.malwarebytes.com/blog/business/2022/10/an-interview-with-cyber-threat-hunter-hiep-hinh
source: Over Security - Cybersecurity news aggregator
date: 2022-10-27
fetch_date: 2025-10-03T21:02:45.956228
---
...
![A cyber threat hunter talks about what he’s learned in his 16+ year cybersecurity career](https://www.threatdown.com/wp-content/uploads/2022/10/asset_upload_file2999_241491.jpg?w=736)
...
*![](http://www.threatdown.com/wp-content/uploads/2024/06/easset_upload_file1689_241491_e.png)*

*Hiep Hinh is a Principal MDR Analyst at Malwarebytes, where he supports [24/7/365 Managed Detection and Response (MDR) efforts.](https://www.threatdown.com/products/managed-detection-and-response/) Hiep has over 16 years of experience in the cybersecurity and intelligence fields, including for the US Army as an intelligence analyst and for the Airforce Computer Emergency Response Team (AFCERT/33NWS). Hiep is an expert user of Endpoint Detection and Response (EDR) platforms and is highly-skilled in incident response, DLP (data loss prevention), data mining, and threat hunting, among other things. In this post, Hiep breaks down his threat hunting career and shares tips and best practices for those looking to become a cyber threat hunter (or who are just interested to listen!).*
...
**Threat hunting is all about nipping stealthy attackers (and malware) in the bud**. It’s plain to see why this is such important work—just consider that the median number of days between [system compromise and detection is 21](https://www.csoonline.com/article/3657571/attack-dwell-times-drop-ransomware-ttps-evolve-china-ramps-up-espionage-activity.html). The earlier cyber threat hunters can find threats, the earlier they can send them off to the remediation team.
...
“Threat hunting is used to find threats that aren’t caught by antivirus or your other defenses. It’s literally looking for things that are unfound, advanced, and hidden, right? So the only way to do that is by knowing what’s normal, and tryin...