---
title: 【人工智能】从零构建一个文本分类器：用Python和TF-IDF实现
url: https://blog.csdn.net/nokiaguy/article/details/144062419
source: 一个被知识诅咒的人
date: 2024-11-27
fetch_date: 2025-10-06T19:16:21.897138
---
...
本文链接：<https://blog.csdn.net/nokiaguy/article/details/144062419>
...
词频衡量某个词在文档中出现的频率：
  T F ( t , d ) = f t 总词数 TF(t, d) = \frac{f\_t}{\text{总词数}} TF(t,d)=总词数ft​​
 其中：

* (f\_t) 是词 (t) 在文档 (d) 中的出现次数。

##### 逆文档频率 (IDF)

逆文档频率用于降低高频常用词（如“的”、“是”）的权重：
  I D F ( t ) = log ⁡ N 1 + n t IDF(t) = \log{\frac{N}{1 + n\_t}} IDF(t)=log1+
...
[在2025年，人工智能技术迅猛发展，具身智能（Embodied Intelligence）与AI代理（AI Agents）的结合正悄然重塑人类生活和工作方式。这种融合将抽象的AI...