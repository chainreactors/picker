---
title: 安天AVL SDK反病毒引擎升级通告（20260725）
url: https://mp.weixin.qq.com/s/gfKaq7ESW0Om0PVVRWyfSA
source: Doonsec's feed
date: 2026-07-25
fetch_date: 2026-07-26T05:23:13.781131
---

# 安天AVL SDK反病毒引擎升级通告（20260725）
...
| 5 | Trojan/Win32.FakeSkill | 该家族是一种木马病毒，主要通过伪造AI Skill和MCP Server诱导AI Agent及用户安装恶意组件，投递信息窃取载荷，窃取浏览器凭据、会话令牌、开发环境敏感信息及其他用户隐私数据。 |
...
本周持续警惕AI供应链投毒安全风险。近期监测以“FakeGit” 为标识的大规模 AI 供应链攻击活动，攻击者通过创建大量伪造的AI Skills和MCP服务器仓库，诱导用户和AI Agent下载恶意组件。监测发现攻击者共创建约7600个恶意GitHub仓库，其中超过800个伪装成AI工具、插件或服务，并利用仿冒项目、虚假开发者账号和可信README文档提升可信度。恶意家族Trojan/Win32.FakeSkill通过采用“AgentBaiting”技术，使AI Agent在自主搜索工具时未发现恶意仓库，并进一步推荐安装流程。攻击链最终通过恶意压缩包投递SmartLoader加载器，并部署StealC信息窃取木马，窃取浏览器凭据、会话令牌及开发环境敏感信息。
