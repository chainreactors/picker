...
url: https://buaq.net/go-132645.html
source: unSafe.sh - 不安全
date: 2022-10-26
fetch_date: 2025-10-03T20:52:33.399671
---
...
![](https://8aqnet.cdn.bcebos.com/efc06d03650102c2eb1afe37dd47fe87.jpg)

Eat What You Kill :: Pre-authenticated Remote Code Execution in VMWare NSX Manager

This blog post was authored by Sina Kheirkhah. Sina is a past student of
*2022-10-25 22:0:0
Author: [srcincite.io(查看原文)](/jump-132645.htm)
阅读量:36
收藏*

---

![](https://srcincite.io/assets/images/eat-what-you-kill-pre-authenticated-remote-code-execution-in-vmware-nsx-manager/logo.png "NSX Manager")

> This blog post was authored by [Sina Kheirkhah](https://twitter.com/SinSinology). Sina is a past student of the [Full Stack Web Attack](https://srcincite.io/training/) class.
...
![](https://srcincite.io/assets/images/eat-what-you-kill-pre-authenticated-remote-code-execution-in-vmware-nsx-manager/xstream.png "XStream")
...
We know that arbitrary code can be executed by invoking the `start` method on a `ProcessBuilder` instance. Now that we can use `EventHandler` to redirect any receiving method invocation request to arbitrary m...