---
title: 【人工智能】探索自然语言生成（NLG）：用GPT生成文本
url: https://blog.csdn.net/nokiaguy/article/details/144153717
source: 一个被知识诅咒的人
date: 2024-12-01
fetch_date: 2025-10-06T19:33:59.557048
---
...
对于输入序列 ( X )，通过多头注意力计算其输出：
  Attention ( Q , K , V ) = softmax ( Q K ⊤ d k ) V \text{Attention}(Q, K, V) = \text{softmax}\left(\frac{QK^\top}{\sqrt{d\_k}}\right)V Attention(Q,K,V)=softmax(dk​
