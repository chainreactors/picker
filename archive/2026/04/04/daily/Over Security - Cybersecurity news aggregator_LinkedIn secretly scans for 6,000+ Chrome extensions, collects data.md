...
date: 2026-04-04
fetch_date: 2026-04-05T04:38:51.519375
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CERT-EU: European Commission hack exposes data of 30 EU entities](data:image/gif;base64...)
  ...
  + [![Claude Code leak used to push infostealer malware on GitHub](data:image/gif;base64...)
  ...
  + [![Microsoft now force upgrades unmanaged Windows 11 24H2 PCs](data:image/gif;base64...)
  ...
  + [![FBI warns against using Chinese mobile apps due to privacy risks](data:image/gif;base64...)
  ...
  + [![This $20 training bundle helps prepare you for the CISSP certification](data:image/gif;base64...)

    This $20 training bundle helps prepare you for the CISSP certification](https://www.bleepingcomputer.com/offer/deals/this-20-training-bundle-helps-prepare-you-for-the-cissp-certification/)
  + [![LinkedIn secretly scans for 6,000+ Chrome extensions, collects data](data:image/gif;base64...)
...
![LinkedIn](https://www.bleepstatic.com/content/hl-images/2022/07/20/linkedin.jpg)

A new report dubbed "BrowserGate" warns that Microsoft's LinkedIn is using h...