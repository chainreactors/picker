...
url: https://www.bleepingcomputer.com/news/security/6-okta-security-settings-you-might-have-overlooked/
source: Over Security - Cybersecurity news aggregator
date: 2026-01-26
fetch_date: 2026-01-27T03:39:06.339644
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![CISA says critical VMware RCE flaw now actively exploited](data:image/gif;base64...)
  ...
  + [![ShinyHunters claim hacks of Okta, Microsoft SSO accounts for data theft](data:image/gif;base64...)
  ...
  + [![Microsoft releases emergency OOB update to fix Outlook freezes](data:image/gif;base64...)
  ...
  + [![New malware service guarantees phishing extensions on Chrome web store](data:image/gif;base64...)
  ...
  + [![New ClickFix attacks abuse Windows App-V scripts to push malware](data:image/gif;base64...)
  ...
  + [![Microsoft patches actively exploited Office zero-day vulnerability](data:image/gif;base64...)
  ...
  + [![Cloudflare misconfiguration behind recent BGP route leak](data:image/gif;base64...)
...
###### [Nudge Security](https://www.nudgesecurity.com/product)

* January 26, 2026
* 10:01 AM
* [0](#comment_form)

![Nudge okta security](https://www.bleepstatic.com/images/news/security/n/nudge/okta-security/nudge-person-key.jpg)
...
Recent high-profile breaches targeting identity infrastructure have demonstrated that even sophisticated organizati...