---
title: Update Fri Nov 22 14:23:46 UTC 2024
url: https://github.com/trickest/cve/commit/29a1e56a735bbded3704dd43fbaf7d328a8f6e47
source: Recent Commits to cve:main
date: 2024-11-23
fetch_date: 2025-10-06T19:17:09.240406
---
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Ftrickest%2Fcve%2Fcommit%2F29a1e56a735bbded3704dd43fbaf7d328a8f6e47)
...
[Browse files](/trickest/cve/tree/29a1e56a735bbded3704dd43fbaf7d328a8f6e47)Browse files
...
```
1 parent 058638f commit 29a1e56

Copy full SHA for 29a1e56
```
...
* 2021
  ...
  + [CVE-2021-45100.md](#diff-95a91588d2aa8f0ccbf42b5375eb6e36cf6eca8ccbdfb488cff2613f92b2f938)
...
Collapse file: 2021/CVE-2021-45100.md

### [`‎2021/CVE-2021-45100.md‎`](#diff-95a91588d2aa8f0ccbf42b5375eb6e36cf6eca8ccbdfb488cff2613f92b2f938)
...
| --- | --- | --- |
| `@@ -0,0 +1,17 @@` | | | |
|  | `1` | `+ ### [CVE-2021-45100](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-45100)` |
...
|  | `6` | `+ ### Description` |
|  | `7` | `+` |
|  | `8` | `+ The ksmbd server through 3.4.2, as used in the Linux kernel through 5.15.8, sometimes communicates in cleartext even though encryption has been enabled. This occurs because it sets the SMB2_GLOBAL_CAP_ENCRYPTION flag when using the SMB 3.1.1 protocol, which is a violation of the SMB protocol specification. When Windows 10 detects this protocol violation, it disables encryption.` |
|  | `9` | `+` |
|  | `10` | `+ ### POC` |
|  | `11` | `+` |
|  | `12` | `+ #### Reference` |
|  | `13` | `+ - https://github.com/cifsd-team/ksmbd/issues/550` |
|  | `14` | `+` |
|  | `15` | `+ #### Github` |
