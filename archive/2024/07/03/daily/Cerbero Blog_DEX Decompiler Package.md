---
title: DEX Decompiler Package
url: https://blog.cerbero.io/dex-decompiler-package/
source: Cerbero Blog
date: 2024-07-03
fetch_date: 2025-10-06T17:41:46.660205
---
...
We’re excited to release the [DEX Decompiler package](https://cerbero.io/packages/dexdecompiler/) for all licenses of Cerbero Suite: this package is capable of decompiling Android DEX files from their bytecode back to Java.

Once you have installed the package, you can access the decompiler from the bytecode view.

![](/wp-content/uploads/2024/07/dexdec/dex.png)

The interface provides a quick filter to show only matching namespaces, classes, and methods.

![](/wp-content/uploads/2024/07/dexdec/filter.png)

To switch between the bytecode and the decompiler, you can use the combo box at the top.

![](/wp-content/uploads/2024/07/dexdec/combo.png)
...
![](/wp-content/uploads/2024/07/dexdec/toggle.png)
...
![](/wp-content/uploads/2024/07/dexdec/navigation.png)
...
![](/wp-content/uploads/2024/07/dexdec/strings.png)

Additionally, the strings view features a filter to quickly find strings of interest.

![](/wp-content/uploads/2024/07/dexdec/strings_filter.png)
...
![](https://secure.gravatar.com/avatar/7a86aa69922858b8d41989621fc1ea364aae1e027546f88a54d94ab1ec2187fc?s=49&d=mm&r=g)Author [Erik Pistelli](https://blog.cerbero.io/author/cerbero/)Posted on [July 2, 2024July 8, 2024](https://blog.cerbero.io/dex-decompiler-package/)Categories [Package](https://blog.cerbero.io/category/package/)Tags [Android](https://blog.cerbero.io/tag/android/), [decompiler](https://blog.cerbero.io/tag/decompiler/), [DEX](https://blog.cerbero.io/tag/dex/)

## Leave a Reply [Cancel reply](/dex-decompiler-package/#respond)
...
[Previous Previous post: Java Decompiler Package](https://blog.cerbero.io/java-decompiler-package/)

[Next Next post: .NET Decompiler Package](https://blog.cerbero.io/net-decompiler-package/)
