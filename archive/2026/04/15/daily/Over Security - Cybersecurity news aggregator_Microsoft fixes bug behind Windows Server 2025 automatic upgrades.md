...
date: 2026-04-15
fetch_date: 2026-04-16T04:54:16.042557
---
...
* [News](https://www.bleepingcomputer.com/)
  ...
  + [![Microsoft April 2026 Patch Tuesday fixes 167 flaws, 2 zero-days](data:image/gif;base64...)
  ...
  + [![Adobe rolls out emergency fix for Acrobat, Reader zero-day flaw](data:image/gif;base64...)
  ...
  + [![Stolen Rockstar Games analytics data leaked by extortion gang](data:image/gif;base64...)
  ...
  + [![New Booking.com data breach forces reservation PIN resets](data:image/gif;base64...)
  ...
  + [![Critical Nginx UI auth bypass flaw now actively exploited in the wild](data:image/gif;base64...)
  ...
  + [![New AgingFly malware used in attacks on Ukraine govt, hospitals](data:image/gif;base64...)
  ...
  + [![WordPress plugin suite hacked to push malware to thousands of sites](data:image/gif;base64...)
  ...
  + [![Access GPT, Gemini, and Claude in one $30 app to get tasks done faster](data:image/gif;base64...)

    Access GPT, Gemini, and Claude in one $30 app to get tasks done faster](https://www.bleepingcomputer.com/offer/deals/access-gpt-gemini-and-claude-in-one-30-app-to-get-tasks-done-faster/)
...
![Windows Server](https://www.bleepstatic.com/content/hl-images/2026/04/15/Windows_Server.jpg)

Microsoft has finally fixed a known issue that was causing systems running Windows Server...